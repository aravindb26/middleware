...
public class JSONActivator implements BundleActivator {
    ...
    private ServiceRegistration<JSONService> jsonServiceRegistration;
    ...
    public synchronized void start(final BundleContext context) throws Exception {
        ...
        jsonServiceRegistration = context.registerService(JSONService.class, JSONServiceImpl.getInstance(), null);
    }

    @Override
    public synchronized void stop(BundleContext context) throws Exception {
        ServiceRegistration<JSONService> jsonServiceRegistration = this.jsonServiceRegistration;
        if (jsonServiceRegistration != null) {
            this.jsonServiceRegistration = null;
            jsonServiceRegistration.unregister();
        }
