...
public interface JSONValue extends Serializable {
     ...
     * @see #getStream(boolean, boolean)
     */
    default InputStream getStream(boolean asciiOnly) throws JSONException {
        return getStream(asciiOnly, false);
    }
     ...
     *
     * @param asciiOnly <code>true</code> to only write ASCII characters; otherwise <code>false</code>
     * @param async Whether to yield returned stream asynchronously or not
     * @return The stream
     * @throws JSONException If serializing the JSON object fails (e.g. I/O error)
     */
    InputStream getStream(boolean asciiOnly, boolean async) throws JSONException;

    /**
     * Gets the byte array containing this JSON value's raw data.
     *
     * @param asciiOnly <code>true</code> to only write ASCII characters; otherwise <code>false</code>
     * @return The byte array
     * @throws JSONException If serializing the JSON object fails
     */
    byte[] getByteArray(boolean asciiOnly) throws JSONException;
