...
public abstract class CreateCore extends ContextAbstraction {
    ...
    protected void setOptions(final AdminParser parser, final boolean contextIdNeeded) {
        setCsvImport(parser);
        setDefaultCommandLineOptions(parser, contextIdNeeded);
        ...
        parser.allowDynamicOptions(dynamicAttrDesc, Optional.empty());
    }
    ...
    protected final void commonfunctions(final AdminParser parser, final String[] args) {
        try {
            ...
            setOptions(parser, oxctx.hasAutoContextIdPlugin() == false);
            ...
            if (null != csvFile) {
                ...
                ctxid = maincall(parser, ctx, usr, auth, schemaSelectStrategy, oxctx).getId();
            }
        } catch (Exception e) {
