...
public abstract class ListCore extends ResourceAbstraction {
    ...
    protected final void sysoutOutput(final ArrayList<Resource> resources) throws InvalidDataException {
        ...
        doOutput(new String[] { "r", "l", "l", "l", "l", "l" },
                 new String[] { "Id", "Name", "Displayname", "Email", "Available", "Permissions" }, data);
    }
    ...
    private ArrayList<String> makeStandardData(final Resource my_res) {
        ...
        List<ResourcePermission> permissions = my_res.getPermissions();
        if (null != permissions && false == permissions.isEmpty()) {
            // @formatter:off
            res_data.add(permissions.stream().map(r -> new StringBuilder()
                                                        .append(r.group().booleanValue() ? "Group " : "User ")
                                                        .append(r.entity())
                                                        .append(": ")
                                                        .append(r.privilege())
                                                        .toString()
