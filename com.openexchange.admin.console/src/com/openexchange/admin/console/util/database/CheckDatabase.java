...
public final class CheckDatabase extends DatabaseAbstraction {
     ...
     */
    private static ArrayList<String> makeCSVData(final Database db, String status) throws URISyntaxException{
        return makeStandardData(db, true, status);
    }

    private static ArrayList<String> makeStandardData(Database db, boolean csv, String status) throws URISyntaxException {
