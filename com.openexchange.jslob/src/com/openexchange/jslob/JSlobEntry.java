...
public interface JSlobEntry {
    ...
    /**
     * Returns if the entry needs to be stored or not
     *
     * @param newValue The new value to apply
     * @param session The session providing user data
     * @return <code>true</code> if the entry needs an update; otherwise <code>false</code>
     * @throws OXException In case an error occurred
     */
    default boolean needsUpdate(Object newValue, Session session) throws OXException {
