...
public class MessagingGenericActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] {
            ...
            CacheService.class, CryptoService.class, SecretService.class, ThreadPoolService.class };
    }
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            registerService(DeleteListener.class, new MessagingGenericDeleteListener());
