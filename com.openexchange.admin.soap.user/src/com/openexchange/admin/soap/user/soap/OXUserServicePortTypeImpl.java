...
@WebService(serviceName = "OXUserService", portName = "OXUserServiceHttpsEndpoint", targetNamespace = "http://soap.admin.openexchange.com",
// wsdlLocation = "null",
...
public class OXUserServicePortTypeImpl implements OXUserServicePortType {
    ...
    @Override
    public java.util.List<User> list(com.openexchange.admin.soap.user.dataobjects.Context ctx, java.lang.String searchPattern, com.openexchange.admin.soap.user.dataobjects.Credentials auth, java.lang.Boolean includeGuests, java.lang.Boolean excludeUsers, java.lang.Integer length, java.lang.Integer offset) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, NoSuchContextException_Exception, RemoteException_Exception, DatabaseUpdateException_Exception {
        final OXUserInterface userInterface = getUserInterface();
        try {
            final com.openexchange.admin.rmi.dataobjects.User[] users = userInterface.list(
                ...
                soap2Credentials(auth),
                (includeGuests == null ? Boolean.FALSE : includeGuests).booleanValue(),
                (excludeUsers == null ? Boolean.FALSE : excludeUsers).booleanValue(),
                length,
                offset);
            if (null == users) {
                return Collections.emptyList();
    ...
    @Override
    public java.util.List<User> listCaseInsensitive(com.openexchange.admin.soap.user.dataobjects.Context ctx, java.lang.String searchPattern, com.openexchange.admin.soap.user.dataobjects.Credentials auth, java.lang.Integer length, java.lang.Integer offset) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, NoSuchContextException_Exception, RemoteException_Exception, DatabaseUpdateException_Exception {
        final OXUserInterface userInterface = getUserInterface();
        try {
    ...
    @Override
    public List<User> listByAliasDomain(com.openexchange.admin.soap.user.dataobjects.Context ctx, java.lang.String aliasDomain, com.openexchange.admin.soap.user.dataobjects.Credentials auth, java.lang.Integer length, java.lang.Integer offset) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, NoSuchContextException_Exception, RemoteException_Exception {
        final OXUserInterface userInterface = getUserInterface();
        try {
