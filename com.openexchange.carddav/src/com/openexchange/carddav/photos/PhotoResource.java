...
public class PhotoResource extends DAVResource {
        ...
        if (null == photoData && null != contact.getImage1()) {
            ...
            try {
                ...
                if (transformedImage.isPresent()) {
                    photoData = transformedImage.get().getImageData();
                }
            } catch (OXException e) {
     ...
     */
    private Optional<TransformedImage> scaleImageIfNeeded(byte[] imageBytes, String formatName, Dimension targetDimension) {
