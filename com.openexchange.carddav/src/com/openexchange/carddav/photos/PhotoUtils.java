...
public class PhotoUtils {
    ...
    private static final String NAME_PREFIX = "photo";
    ...
    public static String encodeName(Contact contact) {
        ...
        String folderId = contact.getFolderId(true);
        String objectId = contact.getId(true);
        String name = IDMangler.mangle(NAME_PREFIX, folderId, objectId, String.valueOf(lastModified));
    ...
    public static Contact decodeName(String name) throws IllegalArgumentException {
        ...
        try {
            /*
             * attempt to decode mangled identifiers
             */
            List<String> unmangled = IDMangler.unmangle(decodedName);
            if (null != unmangled && 4 == unmangled.size() && NAME_PREFIX.equals(unmangled.get(0))) {
                folderId = unmangled.get(1);
                objectId = unmangled.get(2);
                lastModified = Long.parseLong(unmangled.get(3));
            } else {
                /*
                ...
                folderId = String.valueOf(Integer.parseInt(splitted[0]));
                objectId = String.valueOf(Integer.parseInt(splitted[1]));
