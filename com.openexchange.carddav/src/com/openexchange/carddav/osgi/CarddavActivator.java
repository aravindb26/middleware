...
public class CarddavActivator extends HousekeepingActivator {
    ...
    private static final String WELL_KNOWN_CARDDAV = "/.well-known/carddav";

    public static final String PHOTOS_SERVLET_PATH = "/photos";

    public static final String SERVLET_PATH = "/carddav";
    ...
    protected Class<?>[] getNeededServices() {
        return new Class[] {
            HttpService.class, FolderService.class, ConfigViewFactory.class, UserService.class, IDBasedContactsAccessFactory.class,
    ...
    protected synchronized void startBundle() throws Exception {
        try {
            ...
            httpAliasCardDAV = getInternalPath(configViewFactory, SERVLET_PATH);
            getService(HttpService.class).registerServlet(httpAliasCardDAV, new CardDAV(performer), null, null);
            registerService(DAVServletPathProvider.class, new PrefixBasedDAVServletPathProvider(httpAliasCardDAV));
            getService(HttpService.class).registerServlet(WELL_KNOWN_CARDDAV, new WellKnownServlet(getExternalPath(configViewFactory, SERVLET_PATH), Interface.CARDDAV), null, null);
            registerService(DAVServletPathProvider.class, (path) -> WELL_KNOWN_CARDDAV.equals(path));
             ...
             */
            httpAliasPhotos = getInternalPath(configViewFactory, PHOTOS_SERVLET_PATH);
            ...
            registerService(DAVServletPathProvider.class, new PrefixBasedDAVServletPathProvider(httpAliasPhotos));
            /*
