...
public class SAMLFeature extends DependentServiceStarter {
    ...
    private final static Class<?>[] OPTIONAL_SERVICES = new Class[] {
        HostnameService.class, DatabaseService.class
    };
    ...
    private final Stack<ServiceRegistration<?>> serviceRegistrations = new Stack<>();

    private final Stack<String> servlets = new Stack<>();
     ...
     */
    private void initSamlBackend(ServiceLookup services) throws BundleException {
