...
public class GrizzlyWebSocketActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { ConfigurationService.class, WebApplicationService.class, SessiondService.class, TimerService.class, ThreadPoolService.class,
            ContextService.class, UserService.class, ConfigViewFactory.class, ClientIPUtil.class };
    }
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        ClientIPUtil ipUtils = getServiceSafe(ClientIPUtil.class);
        ...
        if (null == app) {
            ...
            app = DefaultGrizzlyWebSocketApplication.initializeGrizzlyWebSocketApplication(listenerTracker, remoteDistributor, grizzlyConfig, ipUtils, this);
        ...
        registerService(ForcedReloadable.class, configService -> DefaultGrizzlyWebSocketApplication.invalidateEnabledCache());

        registerService(CustomPortableFactory.class, new PortableMessageDistributorFactory());
