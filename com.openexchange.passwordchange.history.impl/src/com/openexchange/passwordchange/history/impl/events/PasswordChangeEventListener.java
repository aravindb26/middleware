...
/**
 * {@link PasswordChangeEventListener} Listens to password change event created in {@link com.openexchange.passwordchange.PasswordChangeRegistry#perform(com.openexchange.passwordchange.PasswordChangeEvent)}
 *
...
public class PasswordChangeEventListener implements EventHandler {
    ...
    public void handleEvent(Event event) {
        ...
        String clientId = (String) event.getProperty("com.openexchange.passwordchange.clientId");

        PasswordChangeHelper.recordChangeSafe(contextId, userId, ipAddress, clientId, registry);
    }
}
