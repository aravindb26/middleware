...
import com.openexchange.authentication.application.impl.AppAuthenticatorServiceWrapper;
...
public class ApplicationPasswordActivator extends AJAXModuleActivator {
            ...
            public boolean isEnabled(String capability, Session session, CapabilitySet capabilities) throws OXException {
                if (sCapability.equals(capability)) {
                    ...
                    if (null != appPasswordService) {
                        List<AppPasswordApplication> applications = appPasswordService.getApplications(session, capabilities);
    ...
    private AppPasswordServiceImpl loadServices() throws OXException {
        ...
        registerService(AuthenticationService.class, new AppAuthenticatorServiceWrapper(appPasswordService));
