...
public abstract class AbstractInfostoreFolderAccess implements FileStorageFolderAccess, PermissionAware, FolderStatsAware, FileStorageCaseInsensitiveAccess, SearchableFolderNameFolderAccess {
    ...
    protected FolderServiceDecorator initDecorator() {
        ...
        String parameterName = "com.openexchange.folderstorage.altNames" + '@' + Thread.currentThread().getId();
        Object altNamesSessionParameter = session.getParameter(parameterName);
        decorator.put("altNames", String.valueOf(null != altNamesSessionParameter ? altNamesSessionParameter : Boolean.TRUE));
