...
/**
 * {@link UpdateDeputyAction} - Performs the "update" action of the deputy permission module.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.6
 */
public class UpdateDeputyAction extends AbstractDeputyAction {

    /**
     * Initializes a new {@link UpdateDeputyAction}.
     *
     * @param services The service look-up
     */
    public UpdateDeputyAction(ServiceLookup services) {
        super(services);
    }
    ...
    protected AJAXRequestResult doPerform(DeputyService deputyService, AJAXRequestData requestData, ServerSession session) throws OXException, JSONException {
        String deputyId = requestData.requireParameter("deputyId");
        ...
        deputyService.updateDeputyPermission(deputyId, deputyPermission, session);
