...
/**
 * {@link DeleteDeputyAction} - Performs the "delete" action of the deputy permission module.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.6
 */
public class DeleteDeputyAction extends AbstractDeputyAction {

    private final JSONObject statusSuccess;

    /**
     * Initializes a new {@link DeleteDeputyAction}.
     *
     * @param services The service look-up
     */
    public DeleteDeputyAction(ServiceLookup services) {
        super(services);
    ...
    protected AJAXRequestResult doPerform(DeputyService deputyService, AJAXRequestData requestData, ServerSession session) throws OXException, JSONException {
        deputyService.revokeDeputyPermission(requestData.requireParameter("deputyId"), session);
