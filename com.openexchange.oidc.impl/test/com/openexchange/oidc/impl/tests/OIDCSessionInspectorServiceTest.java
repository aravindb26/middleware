...
public class OIDCSessionInspectorServiceTest {
    ...
    public void setUp() {
        ...
        this.inspector = PowerMockito.spy(new OIDCSessionInspectorService(this.mockedOidcBackends, this.tokenService, mockedStateManagement));
    }
    ...
    public void onSessionHit_NoBackendTrackedTest() {
        ...
        SessionInspectorService emptyInspector = new OIDCSessionInspectorService(this.mockedOidcBackends, this.tokenService, mockedStateManagement);
    ...
    public void onSessionHit_IgnoreUnmanagedSession() throws Exception {
        PowerMockito.doReturn(Optional.of(mockedBackend)).when(this.inspector, PowerMockito.method(OIDCSessionInspectorService.class, "loadBackendForSession", Session.class)).withArguments(ArgumentMatchers.any(Session.class));
