...
public class OIDCBackendTest {
    ...
    public void setUp() throws IOException {
        ...
        this.testLoginHandler = new OIDCLoginRequestHandler(testBackend, mockedStateManagement);
    ...
    public void performLogin_CookieALNoSSOCookieLoginTest() throws Exception {
        ...
        setUpForLogin(true);
        OIDCLoginRequestHandler.OIDCHandler oidcHandler = PowerMockito.spy(new OIDCLoginRequestHandler.OIDCHandler(abstractBackend, mockedStateManagement));
