...
public class TestBackendConfig implements OIDCBackendConfig {
    ...
    public boolean isBackchannelLogoutEnabled() {
        return b(Boolean.class.cast(getOrDefault(OIDCBackendProperty.backchannelLogoutEnabled)));
    }

    @Override
    public boolean isFrontchannelLogoutEnabled() {
        return b(Boolean.class.cast(getOrDefault(OIDCBackendProperty.frontchannelLogoutEnabled)));
    }
