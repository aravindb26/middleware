...
package com.openexchange.oidc.request.analyzer;
...
/**
 * {@link OIDCRequestAnalyzer} is a {@link RequestAnalyzer} which uses the session reservation token
 * of a oidcLogin request to determine the marker for the request
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 */
public class OIDCRequestAnalyzer implements RequestAnalyzer {
     ...
     */
    public OIDCRequestAnalyzer(ServiceLookup services, String loginActionName) throws OXException {
        super();
    ...
    public Optional<AnalyzeResult> analyze(RequestData data) throws OXException {
         ...
         */
        Optional<String> sessionTokenParameter = data.getParsedURL().optParameter(OIDCTools.SESSION_TOKEN);
