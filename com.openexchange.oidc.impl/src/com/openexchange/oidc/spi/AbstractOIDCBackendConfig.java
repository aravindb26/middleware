...
public abstract class AbstractOIDCBackendConfig implements OIDCBackendConfig {
    ...
    public List<String> getHosts() {
        String[] hosts = Strings.splitByComma(this.loadStringProperty(OIDCBackendProperty.hosts));
    ...
    public boolean isBackchannelLogoutEnabled() {
        return this.loadBooleanProperty(OIDCBackendProperty.backchannelLogoutEnabled);
    }

    @Override
    public boolean isFrontchannelLogoutEnabled() {
        return this.loadBooleanProperty(OIDCBackendProperty.frontchannelLogoutEnabled);
    }
