...
public class OIDCActivator extends HousekeepingActivator{
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        if (config.isEnabled()) {
            ...
            StateManagement stateManagement = new CoreStateManagement(getService(HazelcastInstance.class));
            ...
            registerService(CustomPortableFactory.class, new PortableAuthenticationRequestFactory());
            registerService(CustomPortableFactory.class, new PortableLogoutRequestFactory());
