...
public class InitService extends OIDCServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (e.getExceptionCode() == OIDCExceptionCode.INVALID_LOGOUT_REQUEST || e.getExceptionCode() == OIDCExceptionCode.INVALID_THIRDPARTY_LOGIN_REQUEST || e.getExceptionCode() == OIDCExceptionCode.INVALD_TARGET_LINK_URI) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(e.getExceptionCode() == OIDCExceptionCode.INVALD_TARGET_LINK_URI) {
                LOG.error(e.getLocalizedMessage(), e);
                response.sendError(HttpServletResponse.SC_BAD_REQUEST);
            } else {
                exceptionHandler.handleResponseException(request, response, e);
