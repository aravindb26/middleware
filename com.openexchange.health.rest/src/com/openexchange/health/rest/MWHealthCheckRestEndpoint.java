...
public class MWHealthCheckRestEndpoint extends AbstractMWHealthEndpoint {
    ...
    public Response getHealth() {
        ...
        try {
            ...
            for (MWHealthCheckResponse response : checkResponses) {
                ...
                if (null != data && data.isEmpty() == false) {
    ...
    private JSONObject getServerInfo() throws JSONException, OXException {
        ...
        serverInfo.put("version", version.getVersion().toString());
