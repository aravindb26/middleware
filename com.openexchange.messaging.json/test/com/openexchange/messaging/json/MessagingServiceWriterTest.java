...
public class MessagingServiceWriterTest {
     ...
     public void testSimpleWrite() throws JSONException {
        ...
        messagingService.setId("com.openexchange.messaging.google");
        messagingService.setDisplayName("google");
        ...
        final JSONAssertion assertion = new JSONAssertion().isObject()
            .hasKey("id").withValue("com.openexchange.messaging.google")
            .hasKey("displayName").withValue("google")
