...
/**
 * {@link RotatableCopyOnWriteArrayListV2} - An implementation of <code>CopyOnWriteArrayList</code> supporting {@link #rotate(Object)} method.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v8.0.0
 */
public class RotatableCopyOnWriteArrayListV2<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
     ...
     */
    public RotatableCopyOnWriteArrayListV2() {
     ...
     */
    public RotatableCopyOnWriteArrayListV2(Collection<? extends E> c) {
        Object[] es;
        if (c.getClass() == RotatableCopyOnWriteArrayListV2.class) {
            es = ((RotatableCopyOnWriteArrayListV2<?>) c).getArray();
        } else {
            es = c.toArray();
     ...
     */
    public RotatableCopyOnWriteArrayListV2(E[] toCopyIn) {
    ...
    public Object clone() {
        try {
            @SuppressWarnings("unchecked") RotatableCopyOnWriteArrayListV2<E> clone = (RotatableCopyOnWriteArrayListV2<E>) super.clone();
            clone.resetLock();
    ...
    /**
     * Gets the lock internally used by this instance.
     *
     * @return The lock
     */
    ...
    public boolean addAll(Collection<? extends E> c) {
        Object[] cs = (c.getClass() == RotatableCopyOnWriteArrayListV2.class) ? ((RotatableCopyOnWriteArrayListV2<?>) c).getArray() : c.toArray();
        if (cs.length == 0) {
            return false;
        }
        synchronized (lock) {
            ...
            int len = es.length;
            Object[] newElements;
            if (len == 0 && (c.getClass() == RotatableCopyOnWriteArrayListV2.class || c.getClass() == ArrayList.class)) {
                newElements = cs;
            } else {
    ...
    private class COWSubList implements List<E>, RandomAccess {
        ...
        public E set(int index, E element) {
            synchronized (lock) {
                ...
                E x = RotatableCopyOnWriteArrayListV2.this.set(offset + index, element);
        ...
        public E get(int index) {
            synchronized (lock) {
                rangeCheck(index);
                checkForComodification();
                return RotatableCopyOnWriteArrayListV2.this.get(offset + index);
            }
        }
        ...
        public boolean add(E element) {
            synchronized (lock) {
                checkForComodification();
                RotatableCopyOnWriteArrayListV2.this.add(offset + size, element);
                expectedArray = getArray();
                size++;
            }
            return true;
        ...
        public void add(int index, E element) {
            synchronized (lock) {
                ...
                RotatableCopyOnWriteArrayListV2.this.add(offset + index, element);
                expectedArray = getArray();
                size++;
            }
        }
        ...
        public boolean addAll(Collection<? extends E> c) {
            synchronized (lock) {
                ...
                boolean modified = RotatableCopyOnWriteArrayListV2.this.addAll(offset + size, c);
        ...
        public boolean addAll(int index, Collection<? extends E> c) {
            synchronized (lock) {
                rangeCheckForAdd(index);
                final Object[] oldArray = getArrayChecked();
                boolean modified = RotatableCopyOnWriteArrayListV2.this.addAll(offset + index, c);
                size += (expectedArray = getArray()).length - oldArray.length;
                return modified;
            }
        }
        ...
        public E remove(int index) {
            synchronized (lock) {
                rangeCheck(index);
                checkForComodification();
                E result = RotatableCopyOnWriteArrayListV2.this.remove(offset + index);
                expectedArray = getArray();
                size--;
                return result;
            }
        ...
        public ListIterator<E> listIterator(int index) {
            synchronized (lock) {
                checkForComodification();
                rangeCheckForAdd(index);
                return new COWSubListIterator<E>(RotatableCopyOnWriteArrayListV2.this, index, offset, size);
            }
        }
        ...
        private boolean bulkRemove(Predicate<? super E> filter) {
            synchronized (lock) {
                final Object[] oldArray = getArrayChecked();
                boolean modified = RotatableCopyOnWriteArrayListV2.this.bulkRemove(filter, offset, offset + size);
                size += (expectedArray = getArray()).length - oldArray.length;
                return modified;
            }
        }
    ...
    private void resetLock() {
        @SuppressWarnings("removal") Field lockField = java.security.AccessController.doPrivileged((java.security.PrivilegedAction<Field>) () -> {
            try {
                Field f = RotatableCopyOnWriteArrayListV2.class.getDeclaredField("lock");
