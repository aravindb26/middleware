...
public class Bug22838Test {
    ...
    @Mock
    private SessiondConfigInterface sessiondConfig;
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(sessiondConfig.getObfuscationKey()).thenReturn(RandomStringUtils.randomAlphabetic(32));
        SessionHandler.init(sessiondConfig, registry);
    }
