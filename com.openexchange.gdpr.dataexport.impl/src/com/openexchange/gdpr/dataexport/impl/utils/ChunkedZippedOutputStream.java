...
public class ChunkedZippedOutputStream {
     ...
     */
    public ChunkedZippedOutputStream(DataExportTask task, FileStorage fileStorage, DataExportStorageService storageService, boolean useZip64, ServiceLookup services) {
        super();
        this.task = task;
    ...
    private void constructNewStream() {
        zipOutputStream = ZippedFileStorageOutputStream.createDefaultZippedFileStorageOutputStream(fileStorage, Deflater.DEFAULT_COMPRESSION, useZip64);
        currentSize = 0;
    }
