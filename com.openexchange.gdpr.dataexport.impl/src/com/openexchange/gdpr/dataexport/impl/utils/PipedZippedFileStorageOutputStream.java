...
public class PipedZippedFileStorageOutputStream extends ZippedFileStorageOutputStream {
     ...
     */
    PipedZippedFileStorageOutputStream(FileStorage fileStorage, int compressionLevel, boolean useZip64, ServiceLookup services) throws IOException {
        super();
        this.fileStorage = fileStorage;
        this.services = services;
        fileStorageLocationReference = new BlockingAtomicReference<String>();
        out = initOutputStream();
        zipOut = initZipArchiveOutputStream(out, compressionLevel, useZip64);
