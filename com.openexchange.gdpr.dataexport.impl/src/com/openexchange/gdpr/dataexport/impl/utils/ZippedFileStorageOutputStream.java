...
public abstract class ZippedFileStorageOutputStream extends OutputStream {
     ...
     */
    public static ZippedFileStorageOutputStream createDefaultZippedFileStorageOutputStream(FileStorage fileStorage, int compressionLevel, boolean useZip64) {
        return new AppendingZippedFileStorageOutputStream(fileStorage, compressionLevel, AppendingFileStorageOutputStream.DEFAULT_IN_MEMORY_THRESHOLD, useZip64);
    }
     ...
     */
    public static ZippedFileStorageOutputStream createZippedFileStorageOutputStream(boolean piped, FileStorage fileStorage, int compressionLevel, int bufferSize, boolean useZip64, ServiceLookup services) throws IOException {
        return piped ? new PipedZippedFileStorageOutputStream(fileStorage, compressionLevel, useZip64, services) : new AppendingZippedFileStorageOutputStream(fileStorage, compressionLevel, bufferSize, useZip64);
    }
     ...
     * @return
     */
    protected ZipArchiveOutputStream initZipArchiveOutputStream(OutputStream out, int compressionLevel, boolean useZip64) {
