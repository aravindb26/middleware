 ...
 * @since v7.10.3
 */
public class DataExportRMIServiceImpl extends AbstractAuthenticatorRMIService implements DataExportRMIService {
    ...
    public DataExportRMIServiceImpl(DataExportService service) throws OXException {
        ...
        this.contexts = Services.requireService(ContextService.class);
    }

    @Override
    public boolean cancelDataExportTask(int userId, int contextId, Credentials auth) throws RemoteException {
        Authenticator authenticator = Services.optService(Authenticator.class);
        authenticateCascaded(authenticator, auth, contextId);
    ...
    @Override
    public List<String> cancelDataExportTasks(int contextId, Credentials auth) throws RemoteException {
        Authenticator authenticator = Services.optService(Authenticator.class);
        authenticateCascaded(authenticator, auth, contextId);
    ...
    @Override
    public int fixOrphanedEntries(List<Integer> filestoreIds, Credentials auth) throws RemoteException {
        Authenticator authenticator = Services.optService(Authenticator.class);
