...
public class AppSuiteWebSocketToClientResolver implements WebSocketToClientResolver {
    ...
    private static final String PATH_FILTER_APPSUITE_UI = "/socket.io/appsuite/*"; // NOSONARLINT

    private final Map<String, WebSocketClient> supportedClients;
    ...
    public AppSuiteWebSocketToClientResolver() {
        super();
        String clientId = Client.APPSUITE_UI.getClientId();
        supportedClients = Collections.singletonMap(clientId, new WebSocketClient(clientId, PATH_FILTER_APPSUITE_UI, Interest.interestsFor("ox:mail:*", "ox:calendar:*")));
    }
