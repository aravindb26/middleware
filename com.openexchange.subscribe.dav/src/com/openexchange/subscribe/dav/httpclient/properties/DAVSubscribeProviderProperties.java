...
/**
 * {@link DAVSubscribeProviderProperties}
 *
 * @author <a href="mailto:martin.schneider@open-xchange.com">Martin Schneider</a>
 */
public enum DAVSubscribeProviderProperties implements Property {

    /**
     * Defines the maximum possible number of connections used
     */
    maxConnections(I(10), DAVSubscribeProviderProperties.PREFIX),
    /**
     * Defines the maximum possible number of connections per host used
     */
    maxConnectionsPerRoute(I(5), DAVSubscribeProviderProperties.PREFIX),
    /**
     * Defines the connection timeout
     */
    connectionTimeout(I(5000), DAVSubscribeProviderProperties.PREFIX),
    /**
     * Defines the timeout on waiting to read data
     */
    socketReadTimeout(I(10000), DAVSubscribeProviderProperties.PREFIX),
    /**
     * Defines the hard connection timeout
     */
    hardConnectTimeout(I(30000), DAVSubscribeProviderProperties.PREFIX),
    /**
     * Defines the hard timeout when reading data
     */
    hardReadTimeout(I(120000), DAVSubscribeProviderProperties.PREFIX),
    ;
    ...
    /**
     * Initializes a new {@link DAVSubscribeProviderProperties}.
     */
    private DAVSubscribeProviderProperties() {
        this(EMPTY);
    }
     ...
     */
    private DAVSubscribeProviderProperties(Object defaultValue) {
     ...
     */
    private DAVSubscribeProviderProperties(Object defaultValue, String fqn) {
