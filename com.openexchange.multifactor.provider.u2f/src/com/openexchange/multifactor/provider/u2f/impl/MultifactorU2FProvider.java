        ...
        try {
            ...
            return new Challenge() {
                ...
                public Map<String, Object> getChallenge() throws OXException {
                    ...
                    try {
                        result.put(U2FMultifactorDevice.SIGN_REQUESTS_PARAMETER, JSONServices.parseObject(startSignatureData.toJson()).getJSONArray(U2FMultifactorDevice.SIGN_REQUESTS_PARAMETER));
