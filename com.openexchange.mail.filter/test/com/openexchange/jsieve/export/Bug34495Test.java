...
public class Bug34495Test extends SieveHandler {
    ...
    public Bug34495Test() {
        super(null, null, null, "localhost", 0, null, null, Optional.empty(), -1, -1, null, null);
    }
    ...
    @Test
    public void testParseMessageWithQuotes() throws IOException {
        testParseMessage(ERROR_MSG_1);
    }

    @Test
    public void testParseMessageWithLineBreaks() throws IOException {
        testParseMessage(ERROR_MSG_2);
    }

    private void testParseMessage(String msg) throws IOException {
