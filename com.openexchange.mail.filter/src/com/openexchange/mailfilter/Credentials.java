...
public class Credentials {
    ...
    public Credentials(Session session) {
        ...
        sessionIp = session.getLocalIp();
        sessionInfo = ClientParameterUtility.generateSessionInformation(session);
    ...
    public Credentials(String authname, String password, int userid, int contextid, String username, Subject kerberosSubject, String oauthToken) {
        this(authname, password, userid, contextid, username, kerberosSubject, oauthToken, null, null);
    }
    ...
    */
   public Credentials(String authname, String password, int userid, int contextid, String username, Subject kerberosSubject, String oauthToken, String sessionIp, String sessionInfo) {
       super();
    ...
    /**
     * Gets the session users IP address
     *
     * @return The IP address <code>null</code> if absent
     */
