...
public enum MailFilterExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * It's not allowed to apply a filter rule with the '%s' action.
     */
    ILLEGAL_APPLY_ACTION("It's not allowed to apply a filter rule with the '%s' action.", MailFilterExceptionMessages.ILLEGAL_APPLY_ACTION_MSG, CATEGORY_USER_INPUT, 36),
    ;
