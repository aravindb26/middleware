...
public enum MailFilterProperty implements Property {
     ...
     */
    protocols("", true, "com.openexchange.mail.filter.tls."),
    ...
    /**
     * Whether XCLIENT extension should be used
     *
     * @return <code>true</code> if XCLIENT is allowed; otherwise <code>false</code>
     */
    allowXCLIENT(Boolean.FALSE, true);
