...
public final class Capabilities {
    ...
    public void setSasl(ArrayList<String> sasl) {
        this.sasl = sasl;
    }

    public void addSasl(String saslcapa) {
        if (null != sasl) {
            sasl.add(saslcapa);
        } else {
            sasl = new ArrayList<>();
    ...
    public void setSieve(ArrayList<String> sieve) {
        this.sieve = sieve;
    }
    ...
    public boolean getXClient() {
        return xclient;
    }

    public void setXClient(boolean xclient) {
