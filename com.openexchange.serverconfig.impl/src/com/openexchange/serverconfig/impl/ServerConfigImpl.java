...
public class ServerConfigImpl implements ServerConfig {
    ...
    public boolean isForceHttps() {
        Boolean bForceHttps = (Boolean) mappings.get("forceHTTPS");
        return bForceHttps == null ? false : bForceHttps.booleanValue();
    }
    ...
    public List<SimpleEntry<String, String>> getLanguages() {
        List<SimpleEntry<String,String>> retVal = null;
        Object foundLanguages = mappings.get("languages");
        try {
            List<SimpleEntry<String, String>> languagesList = (List<SimpleEntry<String, String>>) foundLanguages;
            if (languagesList != null) {
                retVal = languagesList;
            }
        } catch (ClassCastException cce) {
            LOG.warn("Invalid language mapping found in ServerConfig. Expected List but got {}", foundLanguages == null ? "null" : foundLanguages.getClass(), cce);
        }
