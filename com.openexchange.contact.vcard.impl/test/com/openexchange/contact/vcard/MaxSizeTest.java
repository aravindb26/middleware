...
public class MaxSizeTest extends VCardTest {
    ...
    public void testImportTooLargeVCard() {
        ...
        try {
            VCardImport importVCard = getService().importVCard(Streams.newByteArrayInputStream(vCardBytes), null, parameters);
            expectedException = importVCard.getWarnings() != null ? importVCard.getWarnings().get(0) : null;
        } catch (OXException e) {
            expectedException = e;
        }
