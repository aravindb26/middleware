...
import com.openexchange.contact.provider.extensions.PermissionAware;
...
public enum ContactsAccessCapability {
    ...
    /**
     * Permissions for contact folders.
     *
     * @see PermissionAware
     */
    ...
    /**
     * Support for retrieving the CTag (Collection Entity Tag) for a folder.
     *
     * @see CTagAware
     */
    ...
    /**
     * Support for (un)subscribing address books.
     *
     * @see SubscribeAware
     */
    SUBSCRIBE("subscribe", SubscribeAware.class),
    /**
     * Built-in support for ordering by use {@link ContactField#USE_COUNT}.
     * 
     * @see UseCountAware
     */
    USE_COUNT("use_count", UseCountAware.class),
    /**
     * General read/write support.
     *
     * @see ReadWriteAware
     */
    READ_WRITE("read_write", ReadWriteAware.class),
    ;
    ...
    /**
     * Gets the names of all capabilities implemented by a specific contacts access interface.
     *
     * @param accessInterface The contacts access interface to derive the capabilities from
     * @return The supported contacts capability names, or an empty set if no extended functionality is available
     */
    public static Set<String> getCapabilityNames(Class<? extends ContactsAccess> accessInterface) {
