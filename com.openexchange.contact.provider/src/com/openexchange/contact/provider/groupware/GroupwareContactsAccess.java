 ...
 * @since v7.10.5
 */
public interface GroupwareContactsAccess extends FolderContactsAccess, PermissionAware {

    /**
     * Default implementation delegating to {@link #getVisibleFolders(GroupwareFolderType)} for all types. Override if applicable.
     */
    @Override
    default List<GroupwareContactsFolder> getVisibleFolders() throws OXException {
        List<GroupwareContactsFolder> folders = new ArrayList<GroupwareContactsFolder>();
