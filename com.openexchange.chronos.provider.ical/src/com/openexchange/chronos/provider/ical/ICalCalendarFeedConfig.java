...
public class ICalCalendarFeedConfig {
    ...
    ICalCalendarFeedConfig(String feedUrl, String etag, long lastUpdated, AuthInfo authInfo) {
        super();
    ...
    public static class Builder {
        ...
        Builder(JSONObject userConfiguration, JSONObject icalConfig) throws OXException {
            ...
            this.authInfo = ICalAuthParser.getInstance().getAuthInfo(userConfiguration);
        }
