...
import com.openexchange.rss.httpclient.properties.RssFeedHttpProperties;
...
/**
 * Activator for <code>"com.openexchange.rss"</code> bundle.
 */
public class RssActivator extends AJAXModuleActivator {

    /**
     * Initializes a new {@link RssActivator}.
     */
    public RssActivator() {
        super();
    }
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { HtmlService.class, CapabilityService.class, ConfigViewFactory.class, ConfigurationService.class,
            SSLSocketFactoryProvider.class, UserAwareSSLConfigurationService.class, RssProperties.class, HttpClientService.class, LeanConfigurationService.class };
    }
    ...
    protected void startBundle() {
        ...
        registerService(SpecificHttpClientConfigProvider.class, new RssFeedHttpProperties(this));
    }
