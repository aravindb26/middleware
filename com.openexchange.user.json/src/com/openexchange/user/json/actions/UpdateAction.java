...
public final class UpdateAction extends AbstractUserAction {
    ...
    public AJAXRequestResult perform(final AJAXRequestData request, final ServerSession session) throws OXException {
        try {
            ...
            final JSONObject jData = containsImage ? JSONServices.parseObject(request.getUploadEvent().getFormField("json")) : (JSONObject) request.requireData();
             ...
             */
            return new AJAXRequestResult(JSONObject.EMPTY_OBJECT, parsedUserContact.getLastModified());
