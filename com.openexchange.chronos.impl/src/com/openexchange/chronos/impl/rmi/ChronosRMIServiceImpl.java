 ...
 * @since v7.10.2
 */
public class ChronosRMIServiceImpl extends AbstractAuthenticatorRMIService implements ChronosRMIService {

    Logger LOG = LoggerFactory.getLogger(ChronosRMIServiceImpl.class);

    private final DefaultCalendarUtilities calendarUtilities;
    ...
    @Override
    public void setEventOrganizer(int contextId, int eventId, int userId, Credentials auth) throws RemoteException {
    ...
    private Attendee modifyEventObject(Event event, int newOrganizer, EntityResolver entityResolver, String defFolder) throws OXException {
        ...
        event.setDtStamp(System.currentTimeMillis());
