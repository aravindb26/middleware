...
import com.openexchange.chronos.impl.SchedulingServicesImpl;
...
public class DefaultCalendarSession implements CalendarSession {
    ...
    private final SchedulingServicesImpl schedulingServices;
    ...
    public DefaultCalendarSession(Session session, CalendarService calendarService, CalendarParameters parameters) throws OXException {
        ...
        this.schedulingServices = new SchedulingServicesImpl(Services.getServiceLookup());
        this.serverUid = Services.getServiceLookup().getServiceSafe(DatabaseService.class).getServerUid();
    }
    ...
    @Override
    public SchedulingServices getSchedulingService() {
