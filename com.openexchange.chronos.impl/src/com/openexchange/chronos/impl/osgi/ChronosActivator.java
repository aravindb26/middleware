...
public class ChronosActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { ConfigurationService.class, ConfigViewFactory.class, CalendarStorageFactory.class, /*CalendarAvailabilityStorageFactory.class,*/
            ...
            ThreadPoolService.class, QuotaService.class, LeanConfigurationService.class, AdministrativeCalendarAccountService.class, ConversionService.class, UserPermissionService.class };
    }
    //@formatter:on
    ...
    protected Class<?>[] getOptionalServices() {
        return new Class<?>[] { FreeBusyService.class, ContactCollectorService.class, ObjectUseCountService.class, CalendarAvailabilityService.class,
            ...
            RegionalSettingsService.class, FolderSubscriptionHelper.class, MimeTypeMap.class, MailResolverService.class, IncomingSchedulingMailFactory.class,
            ITipProcessorService.class, Authenticator.class };
    }
