...
public class CalendarFolder {
    ...
    /**
     * Initializes a new {@link CalendarFolder} for the session's user, taking over the passed properties as-is.
     * 
     * @param session The session
     * @param id The identifier of the calendar folder
     * @param createdBy The entity of the user that created the folder, who is treated as <i>owner</i> of the folder
     * @param type The folder type
     * @param permissions The folder's permissions.
     * @param ownPermission The folder's permissions of the current session user.
     */
    CalendarFolder(Session session, String id, int createdBy, Type type, Permission[] permissions, Permission ownPermission) {
        super();
        this.id = id;
