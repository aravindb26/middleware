...
public class SequenceNumberPerformer extends AbstractQueryPerformer {
     ...
     */
    public SequenceResult perform(String folderId) throws OXException {
        ...
        long count = Arrays.contains(ignore, "count") ? -1L : storage.getEventStorage().countEvents(searchTerm);
