...
public final class PropsFactory {
     ...
     */
    public static Attendee createAttendee(String mail) {
     ...
     */
    public static FreeBusyTime createFreeBusyTime(FbType fbType, Date from, Date until) {
     ...
     */
    public static Available createCalendarAvailable(String summary, DateTime from, DateTime until) {
     ...
     */
    public static Available createRecurringCalendarFreeSlot(String summary, DateTime from, DateTime until, String recurrenceRule) {
     ...
     */
    public static Availability createCalendarAvailability(BusyType busyType, List<Available> freeSlots) {
     ...
     * @return The {@link Availability}
     */
    public static Availability createCalendarAvailability(BusyType busyType, List<Available> freeSlots, DateTime from, DateTime until) {
     ...
     */
    public static Availability createCalendarAvailability(BusyType busyType, List<Available> freeSlots, DateTime from, DateTime until, int priority) {
