...
public class UpdatesPerformerTest extends AbstractCombineTest {
    ...
    public void testLimitedResults1() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 0), 100, 100, 100);
    }

    @Test
    public void testLimitedResults2() {
        assertUpdatesResult(getResult(newAndModifiedEvents, null, -1, 0), 100, -1, 100);
    }

    @Test
    public void testLimitedResults3() {
        assertUpdatesResult(getResult(null, deletedEvents, -1, 0), -1, 100, 100);
    }

    @Test
    public void testLimitedResults4() {
        assertUpdatesResult(getResult(null, null, -1, 0), -1, -1, 0);
    }

    @Test
    public void testLimitedResults5() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 200), 100, 100, 100);
    }

    @Test
    public void testLimitedResults6() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 100), 99, 99, 99);
    }

    @Test
    public void testLimitedResults7() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 25), 25, 25, 25);
    }

    @Test
    public void testLimitedResults8() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 1), 1, 1, 1);
    }

    @Test
    public void testLimitedResults9() {
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 400), 100, 100, 100);
    }
    ...
    public void testLimitedResults10() {
        ...
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 3), 3, 3, 16L);
    }
    ...
    public void testLimitedResults11() {
        ...
        deletedEvents.add(event(7, 30, UUID.randomUUID().toString(), 16L));
        deletedEvents.add(event(8, 30, UUID.randomUUID().toString(), 19L));
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 3), 2, 2, 12L);
    }
    ...
    public void testLimitedResults12() {
        ...
        deletedEvents.add(event(8, 30, UUID.randomUUID().toString(), 19L));
        assertUpdatesResult(getResult(newAndModifiedEvents, deletedEvents, -1, 3), 2, 3, 12L);
    }
