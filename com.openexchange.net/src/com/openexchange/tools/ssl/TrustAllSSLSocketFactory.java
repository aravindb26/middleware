...
public final class TrustAllSSLSocketFactory extends SSLSocketFactory {
    ...
    private static SSLContext getSSLContext() throws IllegalStateException {
        try {
            ...
            context.init(null, new TrustManager[] { new TrustAllManager() }, CryptoUtil.getSecureRandom());
            return context;
    ...
    private static final Provider PROVIDER = new Provider("", "0.0", "") {
        private static final long serialVersionUID = -3780540247105807895L;
    };

    private static final TrustManagerFactory TRUST_ALL_FACTORY = new TrustManagerFactory(new TrustAllManagerFactory(), PROVIDER, "") {
        // Nothing
    };

    /**
     * Gets the trust-all trust manager factory.
     *
     * @return The trust-all trust manager factory
     */
