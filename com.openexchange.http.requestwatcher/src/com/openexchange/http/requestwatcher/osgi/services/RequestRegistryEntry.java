...
public class RequestRegistryEntry implements Comparable<RequestRegistryEntry> {
    ...
    private final AtomicInteger exceededCounter;
    private final AtomicInteger expiredCounter;
    ...
    public RequestRegistryEntry(long number, HttpServletRequest request, Thread thread, Map<String, String> propertyMap) {
        ...
        this.exceededCounter = new AtomicInteger(1);
        this.expiredCounter = new AtomicInteger(0);
        this.interruptedFlag = new AtomicBoolean(false);
    ...
    /**
     * Marks this entry that associated thread has been interrupted.
     */
    public void markInterrupted() {
        interruptedFlag.compareAndSet(false, true);
    }

    /**
     * Checks if associated thread has been interrupted.
     *
    ...
    /**
     * Gets the current exceeded counter and increments it.
     *
     * @return The current exceeded counter
     */
    public int getAndIncrementExceededCounter() {
        return exceededCounter.getAndIncrement();
    }

    /**
     * Increments and gets the current expired counter.
     *
     * @return The incremented expired counter
     */
    public int incrementAndGetExpiredCounter() {
        return expiredCounter.incrementAndGet();
    }
    ...
    public String getRequestParameters() {
        ...
        final String[] parameterNames = parameterMap.keySet().toArray(Strings.getEmptyStrings());
