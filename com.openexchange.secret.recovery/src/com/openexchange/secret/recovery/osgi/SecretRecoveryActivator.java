...
public class SecretRecoveryActivator extends HousekeepingActivator {
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        FastSecretInconsistencyDetector detector;
        {
            ...
            SecretService secretService = getService(SecretService.class);
            detector = new FastSecretInconsistencyDetector(secretEncryptionFactory, cryptoService, userService, whiteboardEncryptedItemDetector, configViewFactory, secretService);
        }
