 ...
 * @since v7.10.1
 */
public class PushRMIServiceImpl extends AbstractAuthenticatorRMIService implements PushRMIService {
    ...
    @Override
    public boolean unregisterPermanentListenerFor(int userId, int contextId, String clientId, Credentials auth) throws RemoteException {
