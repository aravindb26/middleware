...
abstract class AbstractRemoteAppenderMBeanRegisterer implements ServiceTrackerCustomizer<ManagementService, ManagementService> {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(AbstractRemoteAppenderMBeanRegisterer.class);
     ...
     */
    protected AbstractRemoteAppenderMBeanRegisterer(BundleContext context, String appenderName) {
        super();
