...
public class Activator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerService(DeleteListener.class, new ClearGenConfTables());
        registerService(CreateTableService.class, new CreateGenConfTables());
        registerService(GenericConfigurationStorageService.class, mySQLGenericConfigurationStorage);
