...
public class InsertIterator implements MapIterator<String, Object> {
    ...
    /**
     * Initializes a new {@link InsertIterator}.
     */
    public InsertIterator() {
        super();
    }

    public <R> void prepareStatements(TX<R> tx) throws SQLException {
        PreparedStatement insertString = tx.prepare("INSERT INTO genconf_attributes_strings (id, cid, name, value, uuid) VALUES (?,?,?,?,?)");
        PreparedStatement insertBool = tx.prepare("INSERT INTO genconf_attributes_bools (id, cid, name, value, uuid) VALUES (?,?,?,?,?)");
