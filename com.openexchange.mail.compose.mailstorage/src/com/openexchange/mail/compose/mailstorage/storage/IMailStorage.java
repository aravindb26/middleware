...
public interface IMailStorage {
    ...
    /**
     * Gets the number of composition spaces for session-associated user.
     *
     * @param session The session providing user data
     * @return The number of composition spaces
     * @throws OXException If the number of composition spaces cannot be returned
     */
    int getNumberOfCompositionSpaces(Session session) throws OXException;
     ...
     * Looks-up the draft mail associated with given composition space.
     *
     * @param draftPath The path to the draft message
     * @param session The session providing user data
     * @return The mail storage identifier or empty
     * @throws OXException If there is no such association available
     */
    MailStorageResult<Optional<MailStorageId>> lookUp(MailPath draftPath, Session session) throws OXException;
