...
public class MailStorageCompositionSpaceConfig implements ForcedReloadable {
    ...
    public static final String PROPERTY_DEFAULT_READ_RESPONSE_TIMEOUT = "com.openexchange.mail.compose.mailstorage.readResponseTimeout";

    public static final String PROPERTY_LONG_READ_RESPONSE_TIMEOUT = "com.openexchange.mail.compose.mailstorage.longReadResponseTimeout";

    public static final String PROPERTY_OPERATION_WAIT_TIME = "com.openexchange.mail.compose.mailstorage.operationWaitTime";
    ...
    public long getDefaultReadResponseTimeout() throws OXException {
        ConfigurationService config = services.getServiceSafe(ConfigurationService.class);
        return config.getLongProperty(PROPERTY_DEFAULT_READ_RESPONSE_TIMEOUT, 60_000L);
    }
    ...
    public long getLongReadResponseTimeout() throws OXException {
        ConfigurationService config = services.getServiceSafe(ConfigurationService.class);
        return config.getLongProperty(PROPERTY_LONG_READ_RESPONSE_TIMEOUT, 300_000L);
    }
    ...
    public long getOperationWaitTime() throws OXException {
        ConfigurationService config = services.getServiceSafe(ConfigurationService.class);
        return config.getLongProperty(PROPERTY_OPERATION_WAIT_TIME, 10_000L);
    }
