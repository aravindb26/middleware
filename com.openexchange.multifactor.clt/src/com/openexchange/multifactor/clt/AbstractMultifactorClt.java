...
import com.openexchange.cli.RestAuthenticatorClient;
...
public abstract class AbstractMultifactorClt extends AbstractRestCLI<Void> {
    ...
    protected boolean isAuthEnabled(RestAuthenticatorClient authenticator) throws Exception {
        // Multi-factor command-line tools work in scope of a context
        return authenticator.isContextAuthenticationEnabled() || (authenticator.isMasterAuthenticationEnabled() && authenticator.isMasterAccountOverride());
    }
