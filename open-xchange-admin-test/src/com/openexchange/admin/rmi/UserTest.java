...
public class UserTest extends AbstractRMITest {
    ...
    public void testCreateUserLoadRemoteMailContentByDefault() throws Exception {
        ...
        User srv_loaded = getUserManager().getData(context, id(createduser), contextAdminCredentials);
        assertThat("Loading remote content should be allowed!", srv_loaded.isLoadRemoteMailContentByDefault(), is(Boolean.TRUE));
    }
    ...
    public void testChangeUserLoadRemoteMailContentByDefault() throws Exception {
        ...
        // Check value
        User srv_loaded = getUserManager().getData(context, id(createduser), contextAdminCredentials);
        assertThat("Loading remote content should be disabled!", srv_loaded.isLoadRemoteMailContentByDefault(), is(Boolean.FALSE));
    }
    ...
    public void testChangeUserWithoutLoadRemoteMailContentByDefault() throws Exception {
        ...
        User srv_loaded = getUserManager().getData(context, id(createduser), contextAdminCredentials);
        assertThat("Loading remote content should still be enabled!", srv_loaded.isLoadRemoteMailContentByDefault(), is(Boolean.TRUE));
    }
    ...
    public void testListUsersWithOwnFilestore() throws Exception {
        ...
        if (fs == null) {
            ...
            fs = new Filestore();
            fs.setMaxContexts(Integer.valueOf(1000));
            fs.setSize(Long.valueOf(1024));
            fs.setUrl("file:///");
