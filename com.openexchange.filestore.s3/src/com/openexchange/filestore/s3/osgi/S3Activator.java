...
public class S3Activator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { LeanConfigurationService.class, SSLSocketFactoryProvider.class, SSLConfigurationService.class, KeyStoreService.class };
    }
    ...
    protected void startBundle() throws Exception {
        ...
        KeyStoreHelper keyStoreHelper = new KeyStoreHelper(getServiceSafe(LeanConfigurationService.class), getServiceSafe(KeyStoreService.class));
        registerService(ForcedReloadable.class, keyStoreHelper);
        S3ClientRegistry registry = new S3ClientRegistry(this, keyStoreHelper);
