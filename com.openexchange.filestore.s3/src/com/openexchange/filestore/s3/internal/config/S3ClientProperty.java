...
public enum S3ClientProperty implements Property {
    ...
    /**
     * "com.openexchange.filestore.s3client.[clientID].encryption.rsa.keyStoreId"
     */
    RSA_KEYSTORE_ID("encryption.rsa.keyStoreId", null),
    /**
    ...
    /**
     * "com.openexchange.filestore.s3client.[clientID].uploadPartCopy"
     *
     * This property specifies whether to use "uploadPartCopy".
     *
     * The S3 API offers "UploadPartCopy" which uploads a part by copying data from an existing object as data source during a multipart upload.
     * This, for example, improves appending or copy operations but might not be available an all S3 implementations.
     */
    UPLOAD_PART_COPY("uploadPartCopy", Boolean.TRUE),
    /**
     * "com.openexchange.filestore.s3client.[clientID].numOfRetriesOnConnectionPoolTimeout"
     * <p>
     * Sets the number of retry attempts if a timeout happens while waiting for an available connection from a connection manager.
     * <p>
     * E.g. an instance of <code>"org.apache.http.conn.ConnectionPoolTimeoutException"</code> is thrown.
     */
    NUM_OF_RETRIES_ON_CONNECTION_POOL_TIMEOUT("numOfRetriesOnConnectionPoolTimeout", "0"),
    ;
