...
public class S3FileStorageClient {
    ...
    private final boolean useUploadPartCopy;
    private final int numOfRetryAttemptyOnConnectionPoolTimeout;
     ...
     * @param numOfRetryAttemptyOnConnectionPoolTimeout The number of retry attempts if a timeout happens while waiting for an available connection from a connection manager
     */
    S3FileStorageClient(String key, AmazonS3Client client, S3EncryptionConfig encryptionConfig, long chunkSize, S3ClientScope scope, int configFingerprint, boolean useUploadPartCopy, int numOfRetryAttemptyOnConnectionPoolTimeout) {
        super();
        this.key = key;
        this.client = client;
        ...
        this.useUploadPartCopy = useUploadPartCopy;
        this.numOfRetryAttemptyOnConnectionPoolTimeout = numOfRetryAttemptyOnConnectionPoolTimeout;
    }

    /**
     * Gets the number of retry attempts if a timeout happens while waiting for an available connection from a connection manager.
     *
     * @return The number of retry attempts
     */
    public int getNumOfRetryAttemptyOnConnectionPoolTimeout() {
        return numOfRetryAttemptyOnConnectionPoolTimeout;
    }
    ...
    /**
     * Returns whether to use "UploadPartCopy" requests
     *
     * @return <code>True</code> to  use "UploadPartCopy", <code>false</code> otherwise
     */
    public boolean useUploadPartCopy() {
        return useUploadPartCopy;
    }
