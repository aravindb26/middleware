...
public final class PasswordChangeEvent {
     ...
     */
    public PasswordChangeEvent(Session session, Context ctx, String newPassword, String oldPassword) {
     ...
     * @param ip The IP address of the events origin
     */
    ...
    public String toString() {
        return "PasswordChangeEvent [sessionId=" + session.getSessionID() + ", context=" + ctx.getContextId() + ", user=" + session.getUserId() + "]";
    }
}
