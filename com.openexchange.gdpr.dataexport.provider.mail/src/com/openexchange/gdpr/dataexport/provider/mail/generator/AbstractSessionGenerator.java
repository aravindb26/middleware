...
import static com.openexchange.mail.api.MailConfig.getConfiguredAuthTypeForMailAccess;
...
public abstract class AbstractSessionGenerator implements SessionGenerator {
    ...
    public boolean isApplicable(Session session) throws OXException {
        AuthType configuredAuthType = getConfiguredAuthTypeForMailAccess(AccountNature.PRIMARY, session);
