...
import com.openexchange.chronos.ical.ical4j.extensions.LenientDtStamp;
import com.openexchange.chronos.ical.ical4j.extensions.OverridablePropertyFactoryRegistry;
...
public class ICalUtils {
    ...
    static ImportedAlarm importAlarm(int index, VAlarm vAlarm, ICalMapper mapper, ICalParameters parameters) {
        ...
        return new ImportedAlarm(index, mapper.importVAlarm(vAlarm, parameters, warnings), warnings);
    }
    ...
    private static PropertyFactoryRegistry initPropertyFactory() {
        OverridablePropertyFactoryRegistry factory = new OverridablePropertyFactoryRegistry();
        /*
         * register extensions
         */
        ...
        /*
         * re-register customizations
         */
        factory.overrideDefaultFactory(LenientDtStamp.PROPERTY_NAME, LenientDtStamp.FACTORY);
        return factory;
    }
