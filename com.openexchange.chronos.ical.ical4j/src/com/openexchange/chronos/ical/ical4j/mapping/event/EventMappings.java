...
public class EventMappings {
	...
	public static List<ICalMapping<VEvent, Event>> ALL = Collections.<ICalMapping<VEvent, Event>>unmodifiableList(Arrays.asList(
        ...
        new XMicrosoftIntendedStatusMapping(), // intentionally after XMicrosoftAllDayEventMapping 
        ...
        new ExtendedPropertiesMapping(
            ...
            BusyStatus.PROPERTY_NAME, XMicrosoftCdoIntendedStatus.PROPERTY_NAME, Conference.PROPERTY_NAME)
	));
