...
public class TestXProperties extends ICalTest {
    ...
    public void testImportXProperties() throws Exception {
        ...
        assertNotNull("Missing X-MICROSOFT-CDO-APPT-SEQUENCE property", event.getExtendedProperties().get("X-MICROSOFT-CDO-APPT-SEQUENCE"));
        assertEquals("1", event.getExtendedProperties().get("X-MICROSOFT-CDO-APPT-SEQUENCE").getValue());
        assertNotNull("Missing X-MICROSOFT-CDO-OWNERAPPTID property", event.getExtendedProperties().get("X-MICROSOFT-CDO-OWNERAPPTID"));
        assertEquals("1016563675", event.getExtendedProperties().get("X-MICROSOFT-CDO-OWNERAPPTID").getValue());
        // X-MICROSOFT-CDO-BUSYSTATUS is explicitly not added to extended properties of the event
        assertNull("X-MICROSOFT-CDO-BUSYSTATUS is available", event.getExtendedProperties().get("X-MICROSOFT-CDO-BUSYSTATUS"));
        // X-MICROSOFT-CDO-INTENDEDSTATUS is explicitly not added to extended properties of the event
        assertNull("X-MICROSOFT-CDO-INTENDEDSTATUS is available", event.getExtendedProperties().get("X-MICROSOFT-CDO-INTENDEDSTATUS"));
        // X-MICROSOFT-CDO-ALLDAYEVENT is explicitly not added to extended properties of the event
        assertNull("Missing X-MICROSOFT-CDO-ALLDAYEVENT property", event.getExtendedProperties().get("X-MICROSOFT-CDO-ALLDAYEVENT"));
        assertNotNull("Missing X-MICROSOFT-CDO-IMPORTANCE property", event.getExtendedProperties().get("X-MICROSOFT-CDO-IMPORTANCE"));
        assertEquals("1", event.getExtendedProperties().get("X-MICROSOFT-CDO-IMPORTANCE").getValue());
        assertNotNull("Missing X-MICROSOFT-CDO-INSTTYPE property", event.getExtendedProperties().get("X-MICROSOFT-CDO-INSTTYPE"));
        ...
        assertTrue(exportedICal.contains("X-MICROSOFT-CDO-BUSYSTATUS:BUSY"));
        assertTrue(exportedICal.contains("X-MICROSOFT-CDO-INTENDEDSTATUS:BUSY"));
        assertFalse(exportedICal.contains("X-MICROSOFT-CDO-ALLDAYEVENT:FALSE"));
