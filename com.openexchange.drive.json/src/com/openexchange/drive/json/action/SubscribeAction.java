...
public class SubscribeAction extends AbstractDriveWriteAction {
    ...
    public AJAXRequestResult doPerform(AJAXRequestData requestData, DefaultDriveSession session) throws OXException {
        ...
        /*
         * extract root folder identifier(s), either directly, or based on representative domains
         */
        List<String> rootFolderIDs = extractPushRootFolderIDs(requestData);
        if (null == rootFolderIDs || rootFolderIDs.isEmpty()) {
            throw AjaxExceptionCodes.MISSING_PARAMETER.create("root / domain");
        }
        /*
