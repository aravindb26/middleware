...
/**
 * {@link MailExportConverter} - A converter that converts a mail part
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public interface MailExportConverter {

    /**
     * Converts the specified mail part
     *
     * @param mailPart The mail part to convert
     * @param options The conversion options
     * @return The conversion result
     */
    MailExportConversionResult convert(MailExportMailPartContainer mailPart, MailExportConverterOptions options) throws OXException;
