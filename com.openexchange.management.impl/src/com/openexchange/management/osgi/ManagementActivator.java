...
public final class ManagementActivator extends HousekeepingActivator {
    ...
    void startInternal() throws OXException {
        ...
        if (ManagementInit.getInstance().isStarted()) {
             ...
             */
            registerService(ManagementService.class, ManagementAgentImpl.getInstance());
            registerService(ThreadMXBean.class, ManagementAgentImpl.getInstance().getThreadMXBean());
        }
    }
