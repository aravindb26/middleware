...
public class EntityHelper extends XctxEntityHelper {
    ...
    public UpdatesResult mangleRemoteUpdatesResult(UpdatesResult updatesResult) {
        ...
        return new UpdatesResult() {
            ...
            public long getTotalCount() {
                return updatesResult.getTotalCount();
            }
    ...
    public RecurrenceInfo mangleRemoteRecurrenceInfo(RecurrenceInfo recurrenceInfo) {
        return new RecurrenceInfo() {

            @Override
            public boolean isRescheduled() {
                return recurrenceInfo.isRescheduled();
            }

            @Override
            public boolean isOverridden() {
                return recurrenceInfo.isOverridden();
            }

            @Override
            public Event getSeriesMaster() {
                return mangleRemoteEvent(recurrenceInfo.getSeriesMaster());
            }

            @Override
            public Event getRecurrence() {
                return mangleRemoteEvent(recurrenceInfo.getRecurrence());
            }
        };
    }
