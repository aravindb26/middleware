...
public class XctxCalendarAccess implements SubscribeAware, GroupwareCalendarAccess, FolderSyncAware, FolderSearchAware, QuotaAware, WarningsAware {
    ...
    public RecurrenceInfo getRecurrenceInfo(EventID eventID) throws OXException {
        RecurrenceInfo recurrenceInfo = getCalendarService().getUtilities().getRecurrenceInfo(guestSession, eventID);
        return entityHelper.mangleRemoteRecurrenceInfo(recurrenceInfo);
    }
