 ...
 *
 */
public class ParallelsOXAuthentication extends AbstractConfigurationAwareAuthenticationService {

    private static final Logger LOG = org.slf4j.LoggerFactory.getLogger(ParallelsOXAuthentication.class);
    private static final String AUTH_IDENTIFIER = "parallels";
    ...
    public AuthenticationResult handleLoginRequest(AuthenticationRequest authenticationRequest) throws OXException {
        ...
        try {
            ...
            gui_loginstring = authenticationRequest.getLogin();
            gui_password = authenticationRequest.getPassword();
            ...
            return AuthenticationResult.success(new Authenticated() {
                @Override
    ...
    public AuthenticationResult handleAutoLoginRequest(AuthenticationRequest authenticationRequest) throws OXException {
        return AuthenticationResult.failed(LoginExceptionCodes.NOT_SUPPORTED.create(ParallelsOXAuthentication.class.getName()));
    }
