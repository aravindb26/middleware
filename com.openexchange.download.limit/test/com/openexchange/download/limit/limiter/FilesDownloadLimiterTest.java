...
public class FilesDownloadLimiterTest {
    ...
    public void testGetLimit_configCascadeValueSet_ReturnConfigCascadeValues() throws OXException {
        Long sizeLimit = L(LimitConfig.getInstance().sizeLimitLinks());
        Mockito.when(configView.opt(LimitConfig.SIZE_LIMIT_LINKS, Long.class, sizeLimit)).thenReturn(Long.valueOf(22222222222L));
        Integer countLimit = I(LimitConfig.getInstance().countLimitLinks());
        Mockito.when(configView.opt(LimitConfig.COUNT_LIMIT_LINKS, Integer.class, countLimit)).thenReturn(Integer.valueOf(111111));
        Integer timeFrame = I(LimitConfig.getInstance().timeFrameLinks());
        Mockito.when(configView.opt(LimitConfig.TIME_FRAME_LINKS, Integer.class, timeFrame)).thenReturn(Integer.valueOf(7));
    ...
    public void testGetLimit_configCascadeValueSetForGuest_ReturnConfigCascadeValues() throws OXException {
        Long sizeLimit = L(LimitConfig.getInstance().sizeLimitGuests());
        Mockito.when(configView.opt(LimitConfig.SIZE_LIMIT_GUESTS, Long.class, sizeLimit)).thenReturn(Long.valueOf(22222222222L));
        Integer countLimit = I(LimitConfig.getInstance().countLimitGuests());
        Mockito.when(configView.opt(LimitConfig.COUNT_LIMIT_GUESTS, Integer.class, countLimit)).thenReturn(Integer.valueOf(111111));
        Integer timeFrame = I(LimitConfig.getInstance().timeFrameGuests());
        Mockito.when(configView.opt(LimitConfig.TIME_FRAME_GUESTS, Integer.class, timeFrame)).thenReturn(Integer.valueOf(7));
