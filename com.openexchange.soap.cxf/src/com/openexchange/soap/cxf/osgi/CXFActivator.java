    ...
    protected void startBundle() throws Exception {
        ...
        try {
            ...
            final ServiceTrackerCustomizer<HttpService, HttpService> trackerCustomizer = new ServiceTrackerCustomizer<HttpService, HttpService>() {
                    ...
                    private CXFOsgiServlet registerCxfServlet(String alias, HttpService httpService, Dictionary<String, Object> config) throws ServletException, NamespaceException {
                    ...
                    public synchronized HttpService addingService(final ServiceReference<HttpService> reference) {
                        ...
                        try {
                            ...
                            CXFOsgiServlet servlet = registerCxfServlet(alias, httpService, config);
                            if (null != baseAddress) {
                                try {
                                    ...
                                    if (!alias.equals(servletAlias)) {
                                        alias2 = servletAlias;
                                        httpService.registerServlet(alias2, servlet, config, null);
                                    }
