...
import com.openexchange.oauth.impl.proxy.OAuthProxyHttpHelperImpl;
...
public final class OAuthActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        ...
        return new Class<?>[] { DatabaseService.class, SessiondService.class, EventAdmin.class, SecretEncryptionFactoryService.class,
            ...
            UserService.class, SSLSocketFactoryProvider.class, ThreadPoolService.class, SecretService.class };
        //@formatter:on
    }
    ...
    public synchronized void startBundle() throws Exception {
        ...
        try {
            ...
            registerService(CustomPortableFactory.class, new PortableCallbackRegistryFetchFactory());
            ...
            registerService(OAuthProxyHttpHelper.class, new OAuthProxyHttpHelperImpl());
        } catch (Exception e) {
