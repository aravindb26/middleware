...
import com.openexchange.oauth.impl.internal.groupware.RemoveTwitterAccountsUpdateTask;
...
public class LowLevelServicesActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerService(UpdateTaskProviderService.class, () -> 
            Arrays.asList(((UpdateTaskV2) 
                new OAuthCreateTableTask()), new OAuthCreateTableTask2(),
                ...
                new RemoveTwitterAccountsUpdateTask()));
    }
