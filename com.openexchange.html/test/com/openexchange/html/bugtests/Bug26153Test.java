...
public class Bug26153Test extends AbstractSanitizing {
     ...
     public void testDocumentize() {
        ...
        expectedBuilder.append("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">").append(ls);
        expectedBuilder.append("<html xmlns=\"http://www.w3.org/1999/xhtml\">").append(ls);
        expectedBuilder.append("<head>").append(ls);
        expectedBuilder.append("    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />").append(ls);
        expectedBuilder.append("</head>").append(ls);
        expectedBuilder.append("<body>").append(ls);
        expectedBuilder.append("<p>my html document without html, or body tags</p></body>").append(ls);
        expectedBuilder.append("</html>").append(ls);
