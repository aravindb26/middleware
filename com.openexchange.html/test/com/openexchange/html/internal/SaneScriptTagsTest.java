...
public class SaneScriptTagsTest {
    ...
    public SaneScriptTagsTest() {
     ...
     @Test
     public void testMWB1219() {
        String str = "<![CDATA[  <script\\t>alert(\"XSS\");</script\\t>  ]]>";

        String result = SaneScriptTags.saneScriptTags(str, new boolean[1]);
        Assert.assertTrue("Script tags not orderly removed", result.indexOf("<script") < 0);

        str = "<![CDATA[  <script\t>alert(\"XSS\");</script\t>  ]]>";

        result = SaneScriptTags.saneScriptTags(str, new boolean[1]);
        Assert.assertTrue("Script tags not orderly removed", result.indexOf("<script") < 0);
    }
