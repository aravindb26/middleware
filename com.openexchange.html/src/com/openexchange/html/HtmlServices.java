...
public final class HtmlServices {
    ...
    public static boolean isNonJavaScriptURL(String val, String tagName) {
        return isNonJavaScriptURL(val, tagName, Strings.getEmptyStrings());
    }
     ...
     */
    public static List<String> getGlobalEventHandlerIdentifiers() {
        return GlobalEventHandler.getInstance().getGlobalEventHandlerIdentifiers();
    }
