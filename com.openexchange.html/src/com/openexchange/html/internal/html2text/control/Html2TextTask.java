...
public class Html2TextTask extends AbstractTask<String> implements Delayed {
    ...
    public static final Html2TextTask POISON = new Html2TextTask(null, false, true, 0, null) {
    ...
    private final boolean preferJericho;
     ...
     */
    public Html2TextTask(String html, boolean appendHref, boolean preferJericho, int timeoutSec, HtmlServiceImpl htmlService) {
        super();
        this.html = html;
        this.appendHref = appendHref;
        this.preferJericho = preferJericho;
    ...
    public String call() {
        ...
        control.add(this);
        try {
            return htmlService.doHtml2Text(html, appendHref, preferJericho);
        } finally {
            control.remove(this);
        }
    }
