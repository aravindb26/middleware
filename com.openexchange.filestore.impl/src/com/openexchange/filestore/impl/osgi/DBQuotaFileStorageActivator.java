...
public class DBQuotaFileStorageActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerService(DeleteListener.class, new UnifiedQuotaDeleteListener(unifiedQuotaServices));
        registerService(FilestoreDataMoveListener.class, new UnifiedQuotaFilestoreDataMoveListener());
