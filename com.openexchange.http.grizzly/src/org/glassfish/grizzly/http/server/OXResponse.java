...
import com.openexchange.http.grizzly.SameSiteValue;
...
public class OXResponse extends Response {
    ...
    public void addCookie(Cookie cookie) {
        ...
        SameSiteValue sameSiteValue = grizzlyConfig.getSameSiteValue();
        if (SameSiteValue.NONE.equals(sameSiteValue) && cookie.isSecure() == false) {
        ...
        // Append the SameSite attribute (if set)
        if (sameSiteValue != null) {
            sb.append("; SameSite=").append(sameSiteValue.getValue());
        }
