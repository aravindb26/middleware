 ...
 * @since v7.10.4
 */
public final class UserAwareRoutePlanner extends DefaultRoutePlanner {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserAwareRoutePlanner.class);

    private static final UserAwareRoutePlanner INSTANCE = new UserAwareRoutePlanner();
     ...
     * @return The instance
     */
    public static UserAwareRoutePlanner getInstance() {
        return INSTANCE;
    }
