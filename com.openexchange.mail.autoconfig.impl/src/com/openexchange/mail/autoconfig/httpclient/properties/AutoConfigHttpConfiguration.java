...
public class AutoConfigHttpConfiguration extends DefaultHttpClientConfigProvider {
     ...
     *
     */
    public AutoConfigHttpConfiguration(ServiceLookup serviceLookup) {
    ...
    public void modify(HttpClientBuilder builder) {
        ...
        builder.setRoutePlanner(UserAwareRoutePlanner.getInstance()).setRedirectStrategy(TargetAwareRedirectStrategy.getInstance());
