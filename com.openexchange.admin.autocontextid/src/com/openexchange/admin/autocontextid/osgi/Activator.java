...
import com.openexchange.database.ConfigDBMigrationServiceTracker;
...
public class Activator extends HousekeepingActivator {
    ...
    private static final String CHANGE_SET_LOCATION = "/liquibase/autocidConfigdbChangeLog.xml";
    ...
    public void startBundle() throws Exception {
        try {
            ...
            track(DBMigrationExecutorService.class, new ConfigDBMigrationServiceTracker(this, context, CHANGE_SET_LOCATION));
            openTrackers();
        ...
        } catch (SQLException | OXGenericException e) {
            LOG.error("", e);
            throw e;
        }
    }
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { ConfigurationService.class, LeanConfigurationService.class, AdminDaemonService.class, DatabaseService.class, DBMigrationExecutorService.class, ConfigDBMigrationService.class};
    }
}
