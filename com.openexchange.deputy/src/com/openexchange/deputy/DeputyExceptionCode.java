...
/**
 * The deputy error codes.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.6
 */
public enum DeputyExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * Cannot grant self deputy permission
     */
    NO_SELF_DEPUTY("Cannot grant self deputy permission", CATEGORY_PERMISSION_DENIED),
    /**
     * Failed to revoke deputy permission with identifier "%1$s".
     */
    REVOKE_FAILED("Failed to revoke deputy permission with identifier \"%1$s\".", CATEGORY_ERROR),
    ;

    private static final String PREFIX = "DEPUTY";
    ...
    /**
     * Initializes a new {@link DeputyExceptionCode}.
     *
     * @param message
     * @param category
     */
    private DeputyExceptionCode(final String message, final Category category) {
     ...
     */
    private DeputyExceptionCode(final String message, final Category category, final String displayMessage) {
