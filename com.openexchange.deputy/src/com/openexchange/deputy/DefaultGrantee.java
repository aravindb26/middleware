 ...
 * @since v7.10.6
 */
public class DefaultGrantee implements Grantee {
    ...
    /** The builder for an instance of <code>DefaultGrantee</code> */
    public static class Builder {
        ...
        /**
         * Creates the instance of <code>DefaultGrantee</code> from this builder's arguments.
         *
         * @return The instance of <code>DefaultGrantee</code>
         * @throws IllegalArgumentException If this builder has missing or invalid arguments
         */
        public DefaultGrantee build() {
            if (userId <= 0) {
            ...
            return new DefaultGrantee(userId, ImmutableSet.copyOf(aliases));
        }
    }
    ...
    /**
     * Initializes a new {@link DefaultGrantee}.
     *
     * @param userId The user identifier
     * @param aliases The mail aliases
     */
    DefaultGrantee(int userId, Set<String> aliases) {
        super();
        this.userId = userId;
        this.aliases = aliases;
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultGrantee other = (DefaultGrantee) obj;
