...
public interface CryptoService {
    ...
    /**
     * Encrypts specified data with given password, a random generated salt and a random generated IV.
     *
     * @param data The data to be encrypted
     * @param password The password
     * @return The encrypted data as Base64 encoded string with the IV and the salt as a prefixes with a separator decided by the implementation
     ...
     *
     * @param encryptedPayload The Base64 encoded encrypted data with the IV and salt as a prefixes
     * @param password The password
     ...
     * @param data The data to be encrypted
     * @param password The password
     * @param useSalt Uses generated salt for encryption and stores the salt in the return value, if true uses internal salt constant otherwise.
     ...
     * @throws OXException If decryption fails
     * @deprecated Use {@link #decrypt(String, String)} instead.
     */
    @Deprecated
