...
public enum CryptoErrorMessage implements DisplayableOXExceptionCode {
     ...
     * I/O Error.
     */
    IOError(CATEGORY_ERROR, 6, "I/O Error"),
    /**
     * Malformed encrypted data, cannot decrypt
     */
    MalformedEncryptedData(CATEGORY_ERROR, 7, "Malformed encrypted data, cannot decrypt"),
    /**
     * Legacy encryption used
     */
    LegacyEncryption(CATEGORY_TRY_AGAIN, 8, "Legacy encryption used"),
