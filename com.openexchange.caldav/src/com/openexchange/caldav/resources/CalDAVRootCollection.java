...
public class CalDAVRootCollection extends DAVRootCollection {
    ...
    public DAVCollection getChild(String name) throws WebdavProtocolException {
        ...
        try {
            ...
            WebdavPath url = constructPathForChildResource(Tools.checkPlaceholderCollectionName(name));
            return new CalDAVPlaceholderCollection<>(factory, url, CalendarContentType.getInstance(), getTreeID());
        } catch (OXException e) {
