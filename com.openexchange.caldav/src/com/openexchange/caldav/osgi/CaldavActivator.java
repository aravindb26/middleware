...
public class CaldavActivator extends HousekeepingActivator {
    ...
    private static final String WELL_KNOWN_CALDAV = "/.well-known/caldav";

    public static final String SERVLET_PATH = "/caldav";
    ...
    protected synchronized void startBundle() throws Exception {
        try {
            ...
            registerService(DAVServletPathProvider.class, new PrefixBasedDAVServletPathProvider(httpAliasCalDAV));
            httpService.registerServlet(WELL_KNOWN_CALDAV, new WellKnownServlet(getExternalPath(configViewFactory, SERVLET_PATH), Interface.CALDAV), null, null);
            registerService(DAVServletPathProvider.class, (path) -> WELL_KNOWN_CALDAV.equals(path));
