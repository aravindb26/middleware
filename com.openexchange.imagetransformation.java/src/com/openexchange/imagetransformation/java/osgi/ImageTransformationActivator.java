...
import com.openexchange.imagetransformation.java.settings.AbstractImageTransformationSetting;
import com.openexchange.imagetransformation.java.settings.ImageTransformationMaxHeight;
import com.openexchange.imagetransformation.java.settings.ImageTransformationMaxResolution;
import com.openexchange.imagetransformation.java.settings.ImageTransformationMaxSize;
import com.openexchange.imagetransformation.java.settings.ImageTransformationMaxWidth;
...
public class ImageTransformationActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        for (AbstractImageTransformationSetting<?> setting : new AbstractImageTransformationSetting<?>[] {
                                                                        new ImageTransformationMaxHeight(),
                                                                        new ImageTransformationMaxWidth(),
                                                                        new ImageTransformationMaxSize(),
                                                                        new ImageTransformationMaxResolution() }) {
