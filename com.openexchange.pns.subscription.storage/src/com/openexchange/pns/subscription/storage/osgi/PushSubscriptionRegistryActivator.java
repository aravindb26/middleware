...
import com.openexchange.pns.subscription.storage.groupware.PnsSubscriptionsAddMetaColumTask;
...
public class PushSubscriptionRegistryActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { DatabaseService.class, ContextService.class, CacheService.class, CacheEventService.class, ThreadPoolService.class, TimerService.class };
    }
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        RdbPushSubscriptionRegistry persistentRegistry = new RdbPushSubscriptionRegistry(getService(DatabaseService.class), getService(ContextService.class), getService(TimerService.class));
        ...
        if (registerGroupwareStuff) {
            registerService(UpdateTaskProviderService.class, new DefaultUpdateTaskProviderService(
                ...
                new PnsSubscriptionsAddMetaColumTask()
            ));
