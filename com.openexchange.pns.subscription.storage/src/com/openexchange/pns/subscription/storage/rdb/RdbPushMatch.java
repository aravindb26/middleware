...
public class RdbPushMatch implements PushMatch {
     ...
     *
     * @param id The unique identifier of the corresponding subscription
     ...
     */
    public RdbPushMatch(UUID id, int userId, int contextId, String client, String transportId, Token token, String topic, Date lastModified, Date expires) {
        super();
        this.id = id;
        this.userId = userId;
     ...
     * 
     * @return The unique identifier of the corresponding subscription
     */
    public UUID getId() {
        return id;
    }
