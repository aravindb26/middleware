...
public class CharsetServiceUtility {
    ...
    /**
     * Gets the internal standard provider from the field <code>java.nio.charset.Charset.standardProvider</code>.
     *
     ...
     * @return The standard charset provider
     */
    public static CharsetProvider getStandardProvider() throws NoSuchFieldException, IllegalAccessException {
        Field standardProviderField = java.nio.charset.Charset.class.getDeclaredField("standardProvider");
        standardProviderField.setAccessible(true);
        return (CharsetProvider) standardProviderField.get(null);
    }
