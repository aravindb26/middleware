...
public class AdminActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { ConfigurationService.class, ThreadPoolService.class, PasswordMechRegistry.class, VersionService.class, JdbcProperties.class, LeanConfigurationService.class };
    }
    ...
    public synchronized void startBundle() throws Exception {
        ...
        track(ObfuscatorService.class, new RegistryServiceTrackerCustomizer<ObfuscatorService>(context, AdminServiceRegistry.getInstance(), ObfuscatorService.class));
        ...
        track(GroupService.class, new RegistryServiceTrackerCustomizer<GroupService>(context, AdminServiceRegistry.getInstance(), GroupService.class));
        ...
        // Plugin interfaces
        {
            ...
            final RankingAwareNearRegistryServiceTracker<OXSecondaryAccountPluginInterface> satracker = new RankingAwareNearRegistryServiceTracker<OXSecondaryAccountPluginInterface>(context, OXSecondaryAccountPluginInterface.class, defaultRanking);
            rememberTracker(satracker);

            final PluginInterfaces.Builder builder = new PluginInterfaces.Builder().basicAuthenticatorPlugins(batracker).contextPlugins(ctracker).groupPlugins(gtracker).resourcePlugins(rtracker).userPlugins(utracker).secondaryAccountPlugins(satracker);
        ...
        log.info("Build: {}", getServiceSafe(VersionService.class).getVersion());
