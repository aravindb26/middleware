    ...
    public boolean authenticate(final Credentials authdata) {
        ...
        if (master != null && authdata != null &&
           ...
           master.getLogin().equals(authdata.getLogin())) {
            try {
                PasswordMechRegistry registry = AdminServiceRegistry.getInstance().getService(PasswordMechRegistry.class);
                if (registry != null) {
                    PasswordMech passwordMech = registry.get(master.getPasswordMech());
