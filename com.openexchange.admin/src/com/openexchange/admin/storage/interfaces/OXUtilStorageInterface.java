...
public abstract class OXUtilStorageInterface {
    ...
    private static final AtomicReference<OXUtilStorageInterface> INSTANCE_REFERENCE = new AtomicReference<>();
    ...
    public static OXUtilStorageInterface getInstance() throws StorageException {
        OXUtilStorageInterface inst = INSTANCE_REFERENCE.get();
        if (null == inst) {
            synchronized (OXUtilStorageInterface.class) {
                inst = INSTANCE_REFERENCE.get();
                if (null == inst) {
                    ...
                    try {
                        cons = implementingClass.getConstructor();
                        inst = cons.newInstance();
                        INSTANCE_REFERENCE.set(inst);
                    } catch (Exception e) {
                        throw new StorageException(e);
                    }
                }
     ...
     * @throws StorageException
     */
    public abstract void unregisterFilestore(final int storeId) throws StorageException;
     ...
     * <p>
     * See method {@link #hasSpaceForAnotherUser(Filestore, boolean)} to control whether only usage or also entity count shall be checked.
     *
     * @param filestore The file storage to which a further user is supposed to be assigned
     * @return <code>true</code> if enough space is available; otherwise <code>false</code>
     * @throws StorageException If check for enough space fails
     * @see #hasSpaceForAnotherUser(Filestore, boolean)
     */
    public boolean hasSpaceForAnotherUser(Filestore filestore) throws StorageException {
        return hasSpaceForAnotherUser(filestore, true);
    }
     ...
     *
     * @param filestore The file storage to which a further user is supposed to be assigned
     * @param checkEntityCount <code>true</code> to also consider entity count; otherwise <code>false</code> to only check by space usage
     *                         and leave out entity count (since no assignment takes place)
     * @return <code>true</code> if enough space is available; otherwise <code>false</code>
     * @throws StorageException If check for enough space fails
     */
    public abstract boolean hasSpaceForAnotherUser(Filestore filestore, boolean checkEntityCount) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract void deleteMaintenanceReason(final int[] reasonIds) throws StorageException;

    /**
     * @param reasonId
     *            the id of a MaintenanceReason
     * @return MaintenanceReason from configdb identified by the <code>reasonId</code>
     * @throws StorageException
     */
    public abstract MaintenanceReason[] getMaintenanceReasons(final int[] reasonId) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract MaintenanceReason[] listMaintenanceReasons(final String searchPattern) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract void unregisterDatabase(final int dbId, final boolean isMaster) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract void unregisterServer(final int serverId) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract Database[] searchForDatabase(final String searchPattern) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract Database[] searchForDatabaseSchema(final String searchPattern, boolean onlyEmptySchemas) throws StorageException;

    /**
     * Counts schemas per database host matching search_pattern
     *
     * @param searchPattern A pattern to search for
     ...
     * @throws StorageException
     */
    public abstract Map<Database, Integer> countDatabaseSchema(final String searchPattern, boolean onlyEmptySchemas) throws StorageException;
     ...
     * @throws StorageException
     */
    public abstract Server[] searchForServer(final String searchPattern) throws StorageException;
