...
/**
 * This interface defines the methods of the secondary account plugin management.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since 7.10.6
 */
public interface OXSecondaryAccountPluginInterface extends Remote {
     ...
     */
    void create(AccountData accountData, Context context, User[] users, Group[] groups, Credentials auth) throws RemoteException, StorageException, InvalidCredentialsException, NoSuchContextException, NoSuchUserException, InvalidDataException, DatabaseUpdateException;
 ...
 // -------------------------------------------------------------------------------------------------------------------------------------
     ...
     * @throws DatabaseUpdateException If database is currently updating
     */
    void update(String primaryAddress, AccountData accountData, Context context, User[] users, Group[] groups, Credentials auth) throws RemoteException, StorageException, InvalidCredentialsException, NoSuchContextException, NoSuchUserException, InvalidDataException, DatabaseUpdateException;
     ...
     * @throws DatabaseUpdateException If database is currently updating
     */
    void delete(String primaryAddress, Context context, User[] users, Group[] groups, Credentials auth) throws RemoteException, StorageException, InvalidCredentialsException, NoSuchContextException, NoSuchUserException, InvalidDataException, DatabaseUpdateException;
     ...
     *
     * @param context The context to which the user belong
     * @param accounts The listed accounts
     ...
     * @throws DatabaseUpdateException If database is currently updating
     */
    Account[] list(Context context, Account[] accounts, User[] users, Group[] groups, Credentials auth) throws RemoteException, StorageException, InvalidCredentialsException, NoSuchContextException, NoSuchUserException, InvalidDataException, DatabaseUpdateException;
