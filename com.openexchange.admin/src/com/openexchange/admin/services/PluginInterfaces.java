...
public final class PluginInterfaces {
    ...
    public static final class Builder {
        ...
        ServiceListing<OXSecondaryAccountPluginInterface> secondaryAccountPlugins;
        ...
        public Builder secondaryAccountPlugins(ServiceListing<OXSecondaryAccountPluginInterface> serviceListing) {
            this.secondaryAccountPlugins = serviceListing;
            return this;
        }
    ...
    private final ServiceListing<OXSecondaryAccountPluginInterface> secondaryAccountPlugins;
    ...
    PluginInterfaces(final Builder builder) {
        ...
        this.secondaryAccountPlugins = null == builder.secondaryAccountPlugins ? ServiceListings.<OXSecondaryAccountPluginInterface> emptyList() : builder.secondaryAccountPlugins;
    }
    ...
    /**
     * Gets the rank-wise sorted secondary account plugins.
     *
     * @return The secondary account plugins
     */
    public ServiceListing<OXSecondaryAccountPluginInterface> getSecondaryaccountPlugins() {
        return secondaryAccountPlugins;
    }
}
