...
public class AdminDaemon implements AdminDaemonService {
    ...
    public void initRMI(BundleContext context) {
        try {
            ...
            final com.openexchange.admin.rmi.impl.OXSecondaryAccount oxaccount_v2 = new com.openexchange.admin.rmi.impl.OXSecondaryAccount();
            ...
            addPort(configurationService, properties, RMIProperties.USER_PORT);
            ...
            addPort(configurationService, properties, RMIProperties.GROUP_PORT);
            ...
            addPort(configurationService, properties, RMIProperties.RESOURCE_PORT);
            ...
            properties = new Hashtable<String, Object>(2);
            properties.put("RMIName", com.openexchange.admin.rmi.OXSecondaryAccountInterface.RMI_NAME);
            services.add(context.registerService(Remote.class, oxaccount_v2, properties));
    ...
    /**
     * Add the configured port to the properties
     *
     * @param configService The config service
     * @param properties The properties to add the port to
     * @param portProp The property containing the port
     */
    private void addPort(LeanConfigurationService configService, Dictionary<String, Object> properties, Property portProp) {
        try {
            int port = configService.getIntProperty(portProp);
            if (port > 0) {
                properties.put("RMIPort", I(port));
            }
        } catch (@SuppressWarnings("unused") IllegalArgumentException e) {
            LOG.warn("Unable to parse RMI port value for property: ''{}''. Using default value.", portProp.getFQPropertyName());
        }
    }
