...
import static com.openexchange.share.ShareExceptionMessages.DENIED_GUEST_MAIL_ADDRESS_MSG;
...
public enum ShareExceptionCodes implements DisplayableOXExceptionCode {
    ...
    /** Sharing to a guest with email address \"%1$s\" is not allowed. */
    DENIED_GUEST_MAIL_ADDRESS(DENIED_GUEST_MAIL_ADDRESS_MSG, DENIED_GUEST_MAIL_ADDRESS_MSG, Category.CATEGORY_USER_INPUT, 30),
