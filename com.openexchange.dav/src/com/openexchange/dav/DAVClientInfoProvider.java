...
public class DAVClientInfoProvider implements ClientInfoProvider {
     ...
     * 
     * @param userAgentParser The {@link UserAgentParser}
     * @param davParser The {@link DAVUserAgentParser}
     */
    public DAVClientInfoProvider(UserAgentParser userAgentParser, DAVUserAgentParser davParser) {
        super();
        CacheLoader<String, DAVClientInfo> loader = new CacheLoader<String, DAVClientInfo>() {
            ...
            public DAVClientInfo load(String sUserAgent) throws Exception {
                DAVUserAgent userAgent = davParser.parse(sUserAgent);
