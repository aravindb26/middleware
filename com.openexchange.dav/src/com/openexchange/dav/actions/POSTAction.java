...
public class POSTAction extends DAVAction {
    ...
    protected boolean handle(WebdavRequest request, WebdavResponse response) throws WebdavProtocolException {
        ...
        if (null != resource) {
            ...
            if (Strings.isNotEmpty(action) && (resource instanceof DAVObjectResource)) {
                /*
            ...
            if (("application/davsharing+xml".equals(contentType)) && (resource instanceof FolderCollection)) {
            ...
            if ("text/xml".equals(contentType) && (resource instanceof FolderCollection)) {
                request = new ReplayWebdavRequest(request);
