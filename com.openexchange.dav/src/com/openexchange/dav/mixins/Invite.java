...
public class Invite extends SingleXMLPropertyMixin {
    ...
    protected String getValue() {
        ...
        if (PublicType.getInstance().equals(collection.getFolder().getType()) == false) {
    ...
    private String getEntityElements(Permission permission) throws OXException {
        ...
        if (permission.isGroup()) {
            ...
            Group group = factory.requireService(GroupService.class).getGroup(factory.getSession(), permission.getEntity());
