...
public class GroupPrincipalCollection extends DAVCollection {
    ...
    public List<WebdavResource> getChildren() throws WebdavProtocolException {
        try {
            Group[] groups = factory.getServiceSafe(GroupService.class).getGroups(factory.getSession(), false);
    ...
    public GroupPrincipalResource getChild(String name) throws WebdavProtocolException {
        ...
        try {
            ...
            return createGroupResource(factory.getServiceSafe(GroupService.class).getGroup(factory.getSession(), id));
