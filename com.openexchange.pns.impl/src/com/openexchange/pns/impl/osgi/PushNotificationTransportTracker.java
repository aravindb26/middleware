...
public final class PushNotificationTransportTracker implements ServiceTrackerCustomizer<PushNotificationTransport, PushNotificationTransport>, PushNotificationTransportRegistry {
    ...
    /** The logger constant */
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(PushNotificationTransportTracker.class);
    ...
    public PushNotificationTransport getTransportFor(String client, String transportId) throws OXException {
        ...
        if (null == transport) {
            LOGGER.debug("No such transport for identifier: {}", transportId);
            return null;
        }

        if (transport.servesClient(client) == false) {
            LOGGER.debug("Transport {} does not serve client: {}", transportId, client);
            return null;
        }
