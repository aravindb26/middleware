...
import com.openexchange.pns.impl.GenericSocketIoMessageGenerator;
...
public class PushNotificationServiceImplActivator extends HousekeepingActivator implements Reloadable {
    ...
    public Interests getInterests() {
        return DefaultInterests.builder()
            .propertiesOfInterest(
                ...
                "com.openexchange.pns.numMaxProcessorThreads",
    ...
    private synchronized void reinit(boolean hardShutDown, ConfigurationService configService) throws OXException {
        ...
        // Register generic JSON-style Socket.IO message generator
        registrations.add(context.registerService(PushMessageGenerator.class, new GenericSocketIoMessageGenerator(this), null));
