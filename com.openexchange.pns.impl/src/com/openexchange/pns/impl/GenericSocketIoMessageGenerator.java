...
/**
 * {@link GenericSocketIoMessageGenerator} - The generic JSON-style Socket.IO message generator for e.g. Webhooks.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class GenericSocketIoMessageGenerator implements PushMessageGenerator {

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(GenericSocketIoMessageGenerator.class);
    ...
    /**
     * Initializes a new {@link GenericSocketIoMessageGenerator}.
     *
     * @param services The service look-up
     */
    public GenericSocketIoMessageGenerator(ServiceLookup services) {
        super();
    ...
    public String getClient() {
        return PushMessageGenerator.ID_GENERIC_SOCKET_IO;
    }
    ...
    public boolean servesClient(String client, String transportId) {
        ...
        if (TRANSPORT_ID_WEBHOOK.equals(transportId) && getClient().equals(client)) {
            return true;
        }
        return false;
    }
    ...
    private JsonMessage generateWebhookCompatibleMessage(PushNotification notification) throws OXException {
        try {
             ...
             *     "user" : 3,
             *     "context" : 1,
             *     "sourceToken" : "16921070345781422853389",
