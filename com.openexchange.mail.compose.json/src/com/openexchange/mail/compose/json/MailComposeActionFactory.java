...
import com.openexchange.mail.compose.json.action.ReferencedAttachmentMailComposeAction;
...
public class MailComposeActionFactory implements AJAXActionServiceFactory {
    ...
    public MailComposeActionFactory(ServiceLookup services) {
        ...
        actions.put("referencedAttachment", new ReferencedAttachmentMailComposeAction(services));
