...
public final class PostMethodHandler extends AbstractMailComposeMethodHandler {
    ...
    private static final Set<String> ACTIONS_WITH_LENGTH_2 = ImmutableSet.of("addAttachment", "referencedAttachment", "send", "save");
            ...
            if (actionId != null) {
                switch (actionId) {
                    ...
                    case "referencedAttachment":
                        /*-
                         *  POST /mail/compose/123/referencedAttachment
                         */
