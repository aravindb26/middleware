...
/**
 * {@link DeleteCompositionSpaceAction} - Deletes a composition space.
 *
...
public class DeleteCompositionSpaceAction extends AbstractMailComposeAction {
    ...
    protected AJAXRequestResult doPerform(AJAXRequestData requestData, ServerSession session) throws OXException, JSONException {
        ...
        boolean hardDelete = AJAXRequestDataTools.parseBoolParameter("harddelete", requestData);

        boolean closed = compositionSpaceService.closeCompositionSpace(compositionSpaceId.getId(), hardDelete, getClientToken(requestData));
