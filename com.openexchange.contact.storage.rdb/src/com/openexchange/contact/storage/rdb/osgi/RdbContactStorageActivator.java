...
public class RdbContactStorageActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { DatabaseService.class, ContextService.class, ConfigViewFactory.class, ImageTransformationService.class,
            ConfigurationService.class };
    }

    @Override
    protected Class<?>[] getOptionalServices() {
        return new Class<?>[] { CacheService.class, Authenticator.class };
    }
