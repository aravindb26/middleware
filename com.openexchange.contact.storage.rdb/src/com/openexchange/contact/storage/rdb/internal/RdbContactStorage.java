...
public class RdbContactStorage extends DefaultContactStorage implements ContactUserStorage, ContactTombstoneStorage {
    ...
    public void create(final Session session, final String folderId, final Contact contact) throws OXException {
        ...
        try {
            RetryingTransactionClosure.execute(con -> {
                create(con, session, folderId, contact);
     ...
     *
     * This method should only be used in a {@link SQLClosure}
     *
     ...
     * @throws SQLException
     */
    private void create(Connection connection, final Session session, final String folderId, final Contact contact) throws OXException, SQLException {
        final int contextID = session.getContextId();
