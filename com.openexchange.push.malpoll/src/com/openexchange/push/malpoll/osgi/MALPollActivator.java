...
import com.openexchange.push.malpoll.MalPollProperty;
...
public final class MALPollActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { MailService.class, EventAdmin.class, TimerService.class, LeanConfigurationService.class, DatabaseService.class, ContextService.class, ConfigViewFactory.class };
    }
    ...
    protected synchronized void startBundle() throws Exception {
        try {
            ...
            period = configurationService.getLongProperty(MalPollProperty.period);
            folder = configurationService.getProperty(MalPollProperty.folder);
            global = configurationService.getBooleanProperty(MalPollProperty.global);
            concurrentGlobal = configurationService.getBooleanProperty(MalPollProperty.concurrentGlobal);
            /*
             * Start-up
             */
             ...
             */
            registerService(CreateTableService.class, new MALPollCreateTableTask());
            registerService(UpdateTaskProviderService.class, new UpdateTaskPublisher());
            registerService(PushManagerService.class, new MALPollPushManagerService());
            registerService(MailAccountDeleteListener.class, new MALPollMailAccountDeleteListener());
            registerService(DeleteListener.class, new MALPollDeleteListener());
        } catch (Exception e) {
            LOG.error("", e);
            throw e;
        }
