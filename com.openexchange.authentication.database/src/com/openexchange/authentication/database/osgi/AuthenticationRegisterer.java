...
public final class AuthenticationRegisterer implements ServiceTrackerCustomizer<AuthenticationDriver,AuthenticationDriver> {
     ...
     */
    public AuthenticationRegisterer(BundleContext context, ServiceLookup services) {
        super();
    ...
    public synchronized AuthenticationDriver addingService(ServiceReference<AuthenticationDriver> reference) {
        ...
        DatabaseAuthentication authenticationService = new DatabaseAuthentication(databaseAuthenticationDriver, services);
        registration = context.registerService(AuthenticationService.class, authenticationService, null);
