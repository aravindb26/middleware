...
public interface PacketProcessorHandler {
    ...
    /**
     * Handles a chunk data right before writing them back to the message.
     *
     * @param packet the {@link PGPPacket} owning the packetData
     * @param packetData The chunk of raw packet data
     * @return The chunk of data which will be written back to the message.
     */
