...
public class PGPDecryptionResult {
     ...
     */
    public PGPDecryptionResult(List<SignatureVerificationResult> signatureVerificationResults,
        MDCVerificationResult mdcVerificationResult) {
    ...
    public void setSignatureVerificationResults(List<SignatureVerificationResult> signatureVerificationResults) {
        this.signatureVerificationResults = signatureVerificationResults;
    }
