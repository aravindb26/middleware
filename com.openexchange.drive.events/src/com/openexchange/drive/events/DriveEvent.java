...
public interface DriveEvent {
     ...
     *
     * @param userIds The identifier of the user to generate the actions for
     ...
     */
    List<DriveAction<? extends DriveVersion>> getActions(int userId, List<String> rootFolderIDs, boolean useContentChanges);
    ...
    /**
     * Gets the identifiers of all users that are directly or indirectly affected by a change that occurred within a specific folder.
     *
     * @return The identifiers of the affected users
     */
    int[] getUserIDs();

    /**
     * Gets a map holding the identifiers of all folders that are directly or indirectly affected by a change that occurred within a
     * specific folder, associated to the corresponding user identifier.
     *
     * @return The identifiers of the affected folders for each user
     */
    Map<Integer, Set<String>> getAffectedFoldersPerUser();

    /**
     * Gets the IDs of all affected folders, from the perspective of a specific user.
     *
     * @param userId The identifier of the user to get the affected folders for
     * @return The folder IDs, or an empty set if there are none
     */
    Set<String> getFolderIDs(int userId);
