...
/**
 * {@link MessageAlarmConfig} - Configuration options for message alarm delivery.
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.10.1
 */
public final class MessageAlarmConfig {

    /**
     * Initializes a new {@link MessageAlarmConfig}.
     */
    private MessageAlarmConfig() {
        super();
    }
