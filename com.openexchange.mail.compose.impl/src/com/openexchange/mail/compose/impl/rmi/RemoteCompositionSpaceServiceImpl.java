 ...
 * @since v7.10.3
 */
public class RemoteCompositionSpaceServiceImpl extends AbstractAuthenticatorRMIService implements RemoteCompositionSpaceService {
    ...
    @Override
    public void deleteOrphanedReferences(List<Integer> fileStorageIds, Credentials auth) throws RemoteCompositionSpaceServiceException, RemoteException {
    ...
    private static RemoteCompositionSpaceServiceException convertException(Exception e, String exceptionId) {
    ...
    private static Collection<FileStorageAndContexts> determineFileStorageUsingContexts(int fileStorageId, Set<Integer> consideredContextIds) throws OXException {
    ...
    private static SchemaInfo getSchemaInfoSafe(DatabaseService databaseService, Integer representativeContextId) {
        try {
