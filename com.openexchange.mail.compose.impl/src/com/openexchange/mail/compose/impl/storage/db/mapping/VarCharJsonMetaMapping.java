...
public abstract class VarCharJsonMetaMapping<O> extends AbstractVarCharJsonObjectMapping<Meta, O> {
    ...
    public int set(PreparedStatement statement, int parameterIndex, O object) throws SQLException {
        ...
        if (value == null) {
            ...
            try {
                jsonMeta.put("date", null == value.getDate() ? JSONObject.NULL : Long.valueOf(value.getDate().getTime()));
                jsonMeta.put("timeZoneId", null == value.getTimeZoneId() ? JSONObject.NULL : value.getTimeZoneId());
    ...
    public Meta get(ResultSet resultSet, String columnLabel) throws SQLException {
        ...
        Meta retval = null;
        try {
            JSONObject jsonMeta = JSONServices.parseObject(value);
            ...
            retval = Meta.builder()
                ...
                .withTimeZoneId(jsonMeta.optString("timeZoneId", null))
