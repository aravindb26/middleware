...
public abstract class VarCharJsonAttachmentsArrayMapping<O> extends AbstractVarCharJsonObjectMapping<List<Attachment>, O> {
    ...
    /**
     * Initializes a new {@link VarCharJsonAttachmentsArrayMapping}.
     *
     * @param columnLabel The label of the column
     * @param readableName The human-readable name of the column
     */
    protected VarCharJsonAttachmentsArrayMapping(String columnLabel, String readableName) {
    ...
    public List<Attachment> get(ResultSet resultSet, String columnLabel) throws SQLException {
        ...
        try {
            JSONArray jsonAttachments = JSONServices.parseArray(value);
