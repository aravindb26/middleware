...
public abstract class VarCharJsonCustomHeadersMapping<O> extends AbstractVarCharJsonObjectMapping<Map<String, String>, O> {
    ...
    /**
     * Initializes a new {@link VarCharJsonCustomHeadersMapping}.
     *
     * @param columnLabel The label of the column
     * @param readableName The human-readable name of the column
     */
    protected VarCharJsonCustomHeadersMapping(String columnLabel, String readableName) {
    ...
    public Map<String, String> get(ResultSet resultSet, String columnLabel) throws SQLException {
        ...
        try {
            JSONObject jsonCustomHeaders = JSONServices.parseObject(value);
