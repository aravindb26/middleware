 ...
 * @since v7.10.2
 */
public final class MessageMapper extends DefaultDbMapper<MessageDescription, MessageField> {
    ...
    protected EnumMap<MessageField, DbMapping<? extends Object, MessageDescription>> createMappings() {
        ...
        mappings.put(MessageField.REPLY_TO, new VarCharJsonAddressArrayMapping<MessageDescription>("replyToAddr", "Reply-To") {
