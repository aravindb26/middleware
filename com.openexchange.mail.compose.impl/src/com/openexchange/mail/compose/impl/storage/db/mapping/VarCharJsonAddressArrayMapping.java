...
public abstract class VarCharJsonAddressArrayMapping<O> extends AbstractVarCharJsonObjectMapping<List<Address>, O> {
    ...
    /**
     * Initializes a new {@link VarCharJsonAddressArrayMapping}.
     *
     * @param columnLabel The label of the column
     * @param readableName The human-readable name of the column
     */
    protected VarCharJsonAddressArrayMapping(String columnLabel, String readableName) {
    ...
    public List<Address> get(ResultSet resultSet, String columnLabel) throws SQLException {
        ...
        try {
            JSONArray jsonAddresses = JSONServices.parseArray(value);
