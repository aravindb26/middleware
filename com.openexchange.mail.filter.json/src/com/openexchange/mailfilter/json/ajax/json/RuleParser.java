...
import com.openexchange.mailfilter.json.ajax.json.mapper.LastUpdateRuleFieldMapper;
...
public class RuleParser {
    ...
    public RuleParser() {
        ...
        // Order of processing
        List<RuleFieldMapper> list = new ArrayList<>(10);
        ...
        list.add(new LastUpdateRuleFieldMapper());
