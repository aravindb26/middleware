...
public class WebClientInfoProvider implements ClientInfoProvider {
    ...
    public ClientInfo getClientInfo(Session session) {
        if (null != session && Origin.HTTP_JSON.equals(session.getOrigin())) {
            ...
            webClientInfo = new WebClientInfo(client, osReadableName.toString(), os, browser, browserVersion, browserFamily);
    ...
    public ClientInfo getClientInfo(String clientId) {
        ...
        return new WebClientInfo(client, null, null, null, null, BROWSER_UNKNOWN);
    }
