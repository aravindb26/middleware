...
public class SessionManagementServiceImpl implements SessionManagementService {
    ...
    public Collection<ManagedSession> getSessionsForUser(Session session) throws OXException {
        ...
        Collection<PortableSession> remoteSessions = sessiondService.isCentral() ? Collections.emptyList() : getRemoteSessionsForUser(session);
    ...
    public void removeSession(Session session, String sessionIdToRemove) throws OXException {
        ...
        if (sessiondService.isCentral()) {
            sessiondService.removeSession(sessionIdToRemove);
        } else {
            ...
            sb.append(")");
            sessiondService.removeSessionsGlobally(SessionFilter.create(sb.toString(), UserAndContext.newInstance(session), null));
        }
    }
