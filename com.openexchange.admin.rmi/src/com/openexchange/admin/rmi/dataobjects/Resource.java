...
public class Resource extends ExtendableDataObject implements NameAndIdObject {
    ...
    public static final ResourcePermission DELETE_PERMISSIONS = new ResourcePermission(null, null, null);
    ...
    public void setPermissions(List<ResourcePermission> permissions) {
        if (1 == permissions.size() && permissions.contains(DELETE_PERMISSIONS)) {
            // permissionsSet with empty list to delete all managed permissions for this resource
            this.permissions = Collections.emptyList();
            this.permissionsSet = true;
        } else {
            this.permissions = permissions;
            this.permissionsSet = false == permissions.isEmpty();
        }
    }

    /**
    * Used to check if the permissions of this object has been changed
    *
    ...
    */
    ...
    public int hashCode() {
        ...
        result = prime * result + (null != permissions && 0 < permissions.size() ? permissions.hashCode() : 0);
        result = prime * result + (permissionsSet ? 1231 : 1237);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (null == permissions) {
            if (null != other.permissions) {
                return false;
            }
        } else if (false == permissions.equals(other.permissions)) {
            return false;
        }
        if (permissionsSet != other.permissionsSet) {
            return false;
        }
        return true;
    }
