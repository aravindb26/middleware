...
public class Credentials implements Serializable {
    ...
    /**
     * Special credentials class. Instances are always accepted.
     */
    private static class AlwayAcceptCredentials extends Credentials implements AlwaysAccept {

        private static final long serialVersionUID = -4874806642725048885L;

        /**
         * Initializes a new {@link AlwayAcceptCredentials}.
         *
         * @param login
         * @param password
         */
        public AlwayAcceptCredentials(String login) {
            super(login, "");
        }
    }

    /**
     * Generates always-accepted credentials having given login.
     *
     * @param login The login
     * @return The always-accepted credentials
     */
    public static Credentials alwaysAcceptFor(String login) {
        return new AlwayAcceptCredentials(login);
    }
