...
public abstract class HousekeepingActivator extends DeferredActivator {
     ...
     * Registers specified service with the specified properties under the specified class.
     * <p>
     * Subject for being removed once ambiguities of the following are resolved:
     * <pre>
     *  Hashtable props = new Hashtable();
     *   ...
     *  registerService("com.openexchange.MyService", serviceInstance, props);
     *                                                                ^^^^^^^
     *  // Yields a compile error since Hashtable implements both - Dictionary and Map
     * </pre>
     *
     * @param clazz The service's class
     * @param service The service reference
     * @param properties The service's properties
     * @deprecated Explicitly use {@link #registerService(Class, Object, Dictionary)} or {@link #registerService(Class, Object, Map)}
     */
    @Deprecated
    protected <S> void registerService(final Class<S> clazz, final S service, final Hashtable<String, ?> properties) {
        registerService(clazz, service, (Dictionary<String, ?>) properties);
    }
     ...
     * @param properties The service's properties
     */
    protected <S> void registerService(final Class<S> clazz, final S service, final Map<String, ?> properties) {
        registerService(clazz, service, properties == null ? null : org.osgi.framework.FrameworkUtil.asDictionary(properties));
    }
    ...
    protected <S> void registerService(final Class<S> clazz, final S service) {
        registerService(clazz, service, (Dictionary<String, ?>) null);
    }
    ...
    /**
     * Registers specified Service or {@link org.osgi.framework.ServiceFactory} with the specified properties under the specified class name.
     *
    ...
    protected void registerService(final String className, final Object service, final Dictionary<String, ?> properties) {
        LOG.debug("Registering service {} with class {}", service, className);
     ...
     * @param service The service reference
     * @param properties The service's properties
     * @deprecated Explicitly use {@link #registerService(String, Object, Dictionary)} or {@link #registerService(String, Object, Map)}
     */
    @Deprecated
    protected <S> void registerService(final String className, final S service, final Hashtable<String, ?> properties) {
        registerService(className, service, (Dictionary<String, ?>) properties);
    }
     ...
     * @param properties The service's properties
     */
    protected void registerService(final String className, final Object service, final Map<String, ?> properties) {
        registerService(className, service, properties == null ? null : org.osgi.framework.FrameworkUtil.asDictionary(properties));
    }
    ...
    protected void registerService(final String className, final Object service) {
        registerService(className, service, (Dictionary<String, ?>) null);
    }
