...
public final class AttachAction extends SnippetAction {
    ...
    private record InputStreamProviderImpl(UploadFile fileItem) implements InputStreamProvider {
    ...
    protected AJAXRequestResult perform(final SnippetRequest snippetRequest) throws OXException, JSONException {
        ...
        mayAccessSnippet(id, session, management);
        
        DefaultSnippet snippet = new DefaultSnippet().setId(id); 
        
        AJAXRequestData requestData = snippetRequest.getRequestData();
        ...
        List<Attachment> attachments = new ArrayList<Attachment>(uploadFiles.size());
         ...
         * Update
         */
        String newId = management.updateSnippet(id, snippet, ImmutableSet.of(), attachments, ImmutableList.of());
