...
public class TransparencyDescriptionTest extends AbstractDescriptionTest {
    ...
    @Test
    public void testTransp_SetOPAQUE_NoDescriptionAvailable() {
        setTransp(null, TimeTransparency.OPAQUE);

        Description description = describer.describe(eventUpdate);
        assertNotNull(description);
        testDescription(description);
        assertTrue("no sentence expected", null == description.getSentences() || description.getSentences().isEmpty());
    }

    @Test
    public void testTransp_SetNull_NoDescriptionAvailable() {
        setTransp(TimeTransparency.OPAQUE, null);
