...
import com.openexchange.chronos.scheduling.changes.impl.SentenceFactoryImpl;
...
public class SchedulingChangesActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getOptionalServices() {
        return new Class[] { ConfigurationService.class, TemplateService.class, HtmlService.class, UserService.class, HostnameService.class, RecurrenceService.class, I18nServiceRegistry.class };
    }
    ...
    protected void startBundle() throws Exception {
        ...
        registerService(SentenceFactory.class, new SentenceFactoryImpl());
