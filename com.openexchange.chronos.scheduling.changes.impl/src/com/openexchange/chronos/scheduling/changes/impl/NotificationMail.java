 ...
 * <p>
 * Getters are used in templates. Don't remove
 *
...
public class NotificationMail {
     ...
     *
     * @param event The event to display in the mail
     * @param participants The participants to display in the mail
     * @param resources The resources to display inn the mail
     * @param conferences The conferences to display in the mail
     */
    ...
    /**
     * The participants to display in the mail
     *
    ...
    /**
     * The resources to display inn the mail *
     * 
     * @return The resource
     */
    ...
    /**
     * The conferences to display in the mail
     *
