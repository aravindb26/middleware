...
public class Activator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        final AdvertisementPackageServiceImpl packageService = new AdvertisementPackageServiceImpl(() -> getServiceSafe(ResellerService.class), getServiceSafe(ConfigurationService.class));
