...
public class SimpleDateFormatter implements DateFormatter {
    ...
    public static SimpleDateFormatter newInstance(String pattern, Locale locale, TimeZone timeZone) {
        FastDateFormat sdf = FastDateFormat.getInstance(pattern, null == timeZone ? TIMEZONE_GMT : timeZone, null == locale ? Locale.US : locale);
     ...
     */
    private SimpleDateFormatter(FastDateFormat sdf) {
        super();
        this.sdf = sdf;
    }
