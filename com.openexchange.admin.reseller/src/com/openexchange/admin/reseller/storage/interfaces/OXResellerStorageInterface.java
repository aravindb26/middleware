...
public abstract class OXResellerStorageInterface {
    ...
    /**
     * Checks if an subadmin with the given credentials exist and if he own the given context.
     * If <code>true</code> it also adds the subadmin id to the context.
     *
     * @param ctx The context
     * @param creds The subadmin credentials
     * @return <code>true</code> if he exists and and own the given context, <code>false</code> otherwise
     * @throws StorageException
     */
    public abstract boolean checkOwnsContextAndSetSid(final Context ctx, final Credentials creds) throws StorageException;

    /**
     * Adds the subadmin id to the context.
     *
     * @param ctx The context
     * @throws StorageException
     */
    public abstract void addSid(final Context ctx) throws StorageException;

    /**
     * Checks whether the subadmin with the given id owns the given context
     *
     * @param ctx The context
     * @param adm The subadmin id
     * @return <code>true</code> if the subadmin own the context, <code>false</code> otherwise
     * @throws StorageException
     */
    public abstract boolean ownsContext(final Context ctx, final int admid) throws StorageException;

    /**
     * Checks whether the the admin with the given id is either the owner or the parent of the owner of the given context.
     *
     * @param ctx The context
     * @param admid The id of the admin to check
     * @return <code>true</code> if the admin is either the owner or the parent of the owner, <code>false</code> otherwise
     * @throws StorageException
     */
    public abstract boolean ownsContextOrIsPidOfOwner(final Context ctx, final int admid) throws StorageException;

    /**
     * Checks whether the the admin with the given id is either the owner or the parent of the owner of the given contexts.
     *
     ...
     * @throws StorageException
     */
    public abstract boolean ownsContextOrIsPidOfOwner(final List<Context> ctxList, final int admid) throws StorageException;
