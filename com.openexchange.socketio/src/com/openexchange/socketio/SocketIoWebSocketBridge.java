...
public class SocketIoWebSocketBridge implements IndividualWebSocketListener {
    ...
    public SocketIoWebSocketBridge() {
        ...
        this.socketIoServer = new SocketIoServer(engineIoServer);
    }

    @Override
    public void onWebSocketConnect(WebSocket socket) {
        throw new IllegalAccessError("SocketIoWebSocketBridge.onWebSocketConnect()");
    }

    @Override
    public void onWebSocketClose(WebSocket socket) {
        throw new IllegalAccessError("SocketIoWebSocketBridge.onWebSocketClose()");

    }

    @Override
    public void onMessage(WebSocket socket, String text) {
        throw new IllegalAccessError("SocketIoWebSocketBridge.onMessage()");
    }
