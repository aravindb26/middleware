...
public class DovecotPushActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { DatabaseService.class, TimerService.class, MailService.class, LeanConfigurationService.class, ConfigViewFactory.class,
    ...
    protected void startBundle() throws Exception {
        ...
        DovecotPushConfiguration config = new DovecotPushConfiguration(getService(LeanConfigurationService.class));
