...
public enum CassandraServiceExceptionCodes implements DisplayableOXExceptionCode {
     ...
     */
    private CassandraServiceExceptionCodes(String message, Category category, int number) {
     ...
     * Initialises a new {@link CassandraServiceExceptionCodes}.
     */
    private CassandraServiceExceptionCodes(String message, String displayMessage, Category category, int number) {
