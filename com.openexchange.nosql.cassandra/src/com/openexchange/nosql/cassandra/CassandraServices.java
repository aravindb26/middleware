...
public class CassandraServices {
    ...
    public static ResultSet executeQuery(String query, Session session) throws OXException {
        ...
        try {
            ...
            throw CassandraServiceExceptionCodes.CONTACT_POINTS_NOT_REACHABLE_SIMPLE.create(e);
     ...
     * @throws OXException If executing the query fails
     */
    public static ResultSet executeQuery(Statement statement, Session session) throws OXException {
        if (null == statement || null == session) {
            return null;
        }
        ...
        try {
            ...
            throw CassandraServiceExceptionCodes.QUERY_EXECUTION_ERROR.create(e, statement);
        } catch (com.datastax.driver.core.exceptions.QueryValidationException e) {
            throw CassandraServiceExceptionCodes.QUERY_VALIDATION_ERROR.create(e, statement);
        } catch (com.datastax.driver.core.exceptions.DriverException e) {
            throw CassandraServiceExceptionCodes.UNEXPECTED_ERROR.create(e, e.getMessage());
        }
    }
