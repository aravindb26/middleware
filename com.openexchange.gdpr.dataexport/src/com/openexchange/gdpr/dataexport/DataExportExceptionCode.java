...
public enum DataExportExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * Specified file storage %1$s for user %2$s in context %3$s is not accessible.
     */
    FILE_STORAGE_INACCESSIBLE("Specified file storage %1$s for user %2$s in context %3$s is not accessible.", CATEGORY_ERROR),
    /**
     * No result file generated by data export for user %1$s in context %2$s
     */
    NO_RESULT_FILE_GENERATED("No result file generated by data export for user %1$s in context %2$s", CATEGORY_ERROR),
    ;
