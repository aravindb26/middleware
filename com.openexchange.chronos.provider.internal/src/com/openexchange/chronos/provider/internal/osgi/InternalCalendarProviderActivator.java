...
import com.openexchange.chronos.provider.internal.config.AutoProcessIMipEntry;
...
import com.openexchange.chronos.provider.internal.config.FreeBusyVisibilityEntry;
...
public class InternalCalendarProviderActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] {
            ...
            CalendarAccountService.class, CalendarStorageFactory.class, CalendarUtilities.class, ConfigViewFactory.class, LeanConfigurationService.class
        };
    }
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            registerService(JSlobEntry.class, new AutoProcessIMipEntry(this));
            registerService(JSlobEntry.class, new FreeBusyVisibilityEntry(this));
        } catch (Exception e) {
