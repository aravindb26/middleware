...
public class UserConfigHelper {
     ...
     */
    public void checkUserConfig(JSONObject userConfig) throws OXException {
        if (null == userConfig) {
     ...
     *
     * @param userConfig The user configuration to apply the value in
     * @param value The value to set
     * @return The set value
     * @throws OXException In case of error
     */
    public AutoProcessIMip setAutoProcessIMip(JSONObject userConfig, String value) throws OXException {
        if (null == userConfig) {
            throw CalendarExceptionCodes.INVALID_CONFIGURATION.create("null");
        }
        UserConfigWrapper configWrapper = new UserConfigWrapper(requireService(ConversionService.class, services), userConfig);
        for (AutoProcessIMip autoProcessIMip : AutoProcessIMip.values()) {
            if (autoProcessIMip.name().equalsIgnoreCase(value)) {
                configWrapper.setAutoProcessIMip(autoProcessIMip);
                return autoProcessIMip;
            }
        }
        throw CalendarExceptionCodes.INVALID_CONFIGURATION.create("chronos/autoProcessIMip");
    }
