...
public interface TimerService {
     ...
     *
     * @param task The task to execute.
     * @param delayMillis The time in milliseconds from now to delay execution.
     * @return A cancelable scheduled timer task representing pending completion of the task.
     * @throws RejectedExecutionException If task cannot be scheduled for execution.
     * @throws NullPointerException If command is <code>null</code>
     */
    public ScheduledTimerTask schedule(Runnable task, long delayMillis);
     ...
     * @param periodMillis The period in milliseconds between successive executions.
     * @return A cancelable scheduled timer task representing pending completion of the task.
     * @throws RejectedExecutionException If task cannot be scheduled for execution.
     * @throws NullPointerException If command is <code>null</code>
     * @throws IllegalArgumentException If period is less than or equal to zero.
     */
    public ScheduledTimerTask scheduleAtFixedRate(Runnable task, long initialDelayMillis, long periodMillis);
     ...
     * @param task The task to execute.
     * @param initialDelayMillis The time in milliseconds to delay first execution
     * @param delayMillis The delay in milliseconds between the termination of one execution and the commencement of the next.
     * @return A cancelable scheduled timer task representing pending completion of the task.
     * @throws RejectedExecutionException If task cannot be scheduled for execution.
     * @throws NullPointerException If command is <code>null</code>
     * @throws IllegalArgumentException If delay is less than or equal to zero.
     */
    public ScheduledTimerTask scheduleWithFixedDelay(Runnable task, long initialDelayMillis, long delayMillis);
