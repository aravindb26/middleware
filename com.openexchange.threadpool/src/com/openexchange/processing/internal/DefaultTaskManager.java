...
public class DefaultTaskManager implements TaskManager {
    ...
    private final LinkedList<ProcessorTask> tasks;
     ...
     */
    public DefaultTaskManager(ProcessorTask task, TaskKey key) {
        super();
        taskKey = key;
        tasks = new LinkedList<ProcessorTask>();
        tasks.offer(task);
    }
    ...
    @Override
    public TaskKey getExecuterKey() {
        return taskKey;
    }

    @Override
    public ProcessorTask remove() { // Gets only called when holding lock
        return tasks.poll();
    }

    @Override
    public void add(ProcessorTask task) { // Gets only called when holding lock
        tasks.offer(task);
    }
}
