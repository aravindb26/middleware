...
public interface ProcessorService {
     ...
     * @param name The unique processor name or <code>null</code> to auto-generate a unique name; e.g. "ImageProcessor"
     * @param numThreads The number of threads to use
     * @param numMaxThreads The maximum number of threads that are allowed being used prior to queueing tasks
     * @return A new processor
     * @throws OXException If processor cannot be returned
     */
    Processor newProcessor(String name, int numThreads, int numMaxThreads) throws OXException;
     ...
     * @throws OXException If processor cannot be returned
     */
    Processor newBoundedProcessor(String name, int numThreads, int numMaxThreads, int maxTasks) throws OXException;
