...
public final class ThreadPools {
     ...
     */
    public static interface TrackableCallable<V> extends Callable<V>, Trackable {
        // Marker
    }

    /**
     * A <code>java.util.concurrent.Future</code> providing pre-calculated result that is either the result object or an exception.
     *
     * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
    ...
    private static final class GetFuture<V> implements Future<V> {
        ...
        /**
         * Initializes a new {@link GetFuture}.
         *
