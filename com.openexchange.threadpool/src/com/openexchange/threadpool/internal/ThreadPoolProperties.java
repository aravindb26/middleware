...
public final class ThreadPoolProperties {
    ...
    public ThreadPoolProperties init(ConfigurationService configurationService) {
        ...
        LOG.info("Thread Pool Configuration:{}\tcorePoolSize={}{}\tenforceCorePoolSize={}{}\tprestartAllCoreThreads={}{}\tkeepAliveTime={}sec{}\tworkQueue={}{}\trefusedExecutionBehavior={}", ls, I(corePoolSize), ls, B(enforceCorePoolSize), ls, B(prestartAllCoreThreads), ls, L(keepAliveTime), ls, workQueue, ls, refusedExecutionBehavior);
        return this;
    }
