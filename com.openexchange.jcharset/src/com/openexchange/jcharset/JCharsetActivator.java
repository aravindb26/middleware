...
public final class JCharsetActivator implements BundleActivator {
    ...
    public synchronized void start(final BundleContext context) throws Exception {
        ...
        log.info("Starting bundle: com.openexchange.jcharset");
        try {
            /*
            ...
            log.error("Error while starting bundle: com.openexchange.jcharset", e);
        }
    }
    ...
    public synchronized void stop(final BundleContext context) throws Exception {
        ...
        try {
            ...
            log.info("Stopped bundle: com.openexchange.jcharset");
        } catch (Exception e) {
            log.error("Error while stopping bundle: com.openexchange.jcharset", e);
        }
    }
