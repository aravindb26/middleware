...
@WebService(serviceName = "OXResellerService", portName = "OXResellerServiceHttpSoap12Endpoint", targetNamespace = "http://soap.reseller.admin.openexchange.com",
...
public class OXResellerServicePortTypeImpl implements OXResellerServicePortType {
    ...
    public ResellerAdmin getSelfData(SelfData parameters) throws InvalidCredentialsException_Exception, StorageException_Exception, RemoteException_Exception, OXResellerException_Exception, InvalidDataException_Exception {
        final OXResellerInterface resellerInterface = getResellerInterface();
        try {
            return resellerAdmin2Soap(resellerInterface.getSelfData(new com.openexchange.admin.reseller.rmi.dataobjects.ResellerAdmin(parameters.getAdminId(), parameters.getAdminName()), soap2Credentials(parameters.getCreds())));
        } catch (RemoteException e) {
            com.openexchange.admin.soap.reseller.service.reseller.soap.RemoteException faultDetail = new com.openexchange.admin.soap.reseller.service.reseller.soap.RemoteException();
            com.openexchange.admin.soap.reseller.service.rmi.RemoteException value = new com.openexchange.admin.soap.reseller.service.rmi.RemoteException();
            value.setMessage(e.getMessage());
    ...
    private static com.openexchange.admin.reseller.rmi.dataobjects.ResellerAdmin soap2ResellerAdmin(final ResellerAdmin soapResellerAdmin) {
        ...
        if (tmpSet != null) {
            resellerAdmin.setCapabilitiesToDrop(tmpSet);
        }
