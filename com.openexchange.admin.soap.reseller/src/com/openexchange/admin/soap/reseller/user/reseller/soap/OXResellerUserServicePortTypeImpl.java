...
public class OXResellerUserServicePortTypeImpl implements OXResellerUserServicePortType {
    ...
    @Override
    public java.util.List<com.openexchange.admin.soap.reseller.user.soap.dataobjects.User> list(com.openexchange.admin.soap.reseller.user.reseller.soap.dataobjects.ResellerContext ctx, java.lang.String searchPattern, com.openexchange.admin.soap.reseller.user.rmi.dataobjects.Credentials auth, Boolean includeGuests, Boolean excludeUsers, java.lang.Integer length, java.lang.Integer offset) throws DatabaseUpdateException_Exception, InvalidCredentialsException_Exception, DuplicateExtensionException_Exception, NoSuchContextException_Exception, StorageException_Exception, RemoteException_Exception, InvalidDataException_Exception {
        final OXUserInterface iface = getUserInterface();
        try {
            final com.openexchange.admin.rmi.dataobjects.User[] list = iface.list(soap2Context(ctx), com.openexchange.java.Strings.isEmpty(searchPattern) ? "*" : searchPattern, soap2Credentials(auth), (includeGuests == null ? Boolean.FALSE : includeGuests).booleanValue(), (excludeUsers == null ? Boolean.FALSE : excludeUsers).booleanValue(), length, offset);
            if (null == list) {
                return null;
            }
    ...
    @Override
    public List<com.openexchange.admin.soap.reseller.user.soap.dataobjects.User> listByAliasDomain(com.openexchange.admin.soap.reseller.user.reseller.soap.dataobjects.ResellerContext ctx, java.lang.String aliasDomain, com.openexchange.admin.soap.reseller.user.rmi.dataobjects.Credentials auth, java.lang.Integer length, java.lang.Integer offset) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, NoSuchContextException_Exception, RemoteException_Exception {
