...
import com.openexchange.admin.soap.reseller.resource.soap.dataobjects.Permission;
...
public class OXResellerResourceServicePortTypeImpl implements OXResellerResourceServicePortType {
    ...
    private static List<com.openexchange.admin.rmi.dataobjects.ResourcePermission> soap2ResourcePermissions(List<Permission> permissions) {
        ...
        return permissions.stream().map(p -> new ResourcePermission(p.getEntity(), p.isGroup(), p.getPrivilege())).toList();
    }
