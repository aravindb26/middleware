...
public class RESTUtility {
    ...
    private static final FastDateFormat DATE_FORMAT = FastDateFormat.getInstance("EEE, dd MMM yyyy kk:mm:ss ZZZZZ", Locale.US);
    ...
    public static Map<String, String> parseAsQueryString(final HttpResponse response) throws XingException {
        ...
        try {
            ...
            while (scanner.hasNext()) {
                ...
                final String[] parts = Strings.splitBy(nameValue, '=', true);
                if (parts.length != 2) {
