...
public class SproxydFileStorageFactory implements FileStorageProvider, InterestsAware {
    ...
    EndpointPool initEndpointPoolFor(String filestoreID) throws OXException {
        ...
        boolean blacklistEndpoints = PropertyNameBuilder.optBoolProperty(filestoreID, "blockEndpoints", true, nameBuilder, configService);
        ...
        return new EndpointPool(filestoreID, urls, heartbeatInterval, blacklistEndpoints, services);
    }
