...
/**
 * {@link RangeAcceptingResumableInputStream} - Resumes reading an S3 object's content on premature EOF and ensures
 ...
 * @since v7.10.5
 */
public class RangeAcceptingResumableInputStream extends AbstractResumableInputStream {

    private final long rangeEnd;
    private long rangeStart;

    /**
     * Initializes a new {@link RangeAcceptingResumableInputStream}.
     *
     ...
     */
    public RangeAcceptingResumableInputStream(HttpResponseStream objectContent, long[] range, UUID id, SproxydClient sproxydClient) {
