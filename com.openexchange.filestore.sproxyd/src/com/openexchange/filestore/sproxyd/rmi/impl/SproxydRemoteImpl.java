 ...
 * @since v7.8.0
 */
public class SproxydRemoteImpl extends AbstractAuthenticatorRMIService implements SproxydRemoteManagement {
    ...
    public List<String> listAllObjectsURLs(String adminUser, String adminPassword) throws RemoteException {
        ...
        authenticate(authenticator, adminUser, adminPassword);
