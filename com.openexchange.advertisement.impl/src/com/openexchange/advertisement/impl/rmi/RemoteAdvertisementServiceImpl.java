...
public class RemoteAdvertisementServiceImpl implements RemoteAdvertisementService {
    ...
    @Override
    public void removeConfigurations(String reseller, boolean clean, boolean includePreview, Credentials auth) throws OXException {
        Authenticator authenticator = Services.optService(Authenticator.class);
        if (authenticator == null) {
            throw ServiceExceptionCode.SERVICE_UNAVAILABLE.create("Authenticator missing.");
        }
        authenticator.doAuthentication(auth);
