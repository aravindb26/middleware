...
public class MetricsListener implements ApplicationEventListener  {
    ...
    private static class RequestListener implements RequestEventListener {
        ...
        public void onEvent(RequestEvent event) {
            ...
            if (type.equals(Type.FINISHED) || type.equals(Type.ON_EXCEPTION)) {
                ...
                if (templates.isEmpty()) {
                    path = "/" + event.getUriInfo().getPath(); // NOSONARLINT
                } else {
         ...
         * @return The path
         */
        private static String contructPath(List<UriTemplate> templates) {
         ...
         * @return The Timer
         */
        private static Timer getTimer(String path, String method, int status) {
            // @formatter:off
