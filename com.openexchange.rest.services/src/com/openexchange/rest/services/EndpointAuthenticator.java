...
public interface EndpointAuthenticator {
     ...
     * <b>Note</b>: If this method returns <code>true</code>, {@link #authenticate(String, String, Method, ContainerRequestContext) authenticate()} is no more called.
     * </div>
     *
     ...
     * <p/>
     * Only invoked as fallback if {@link #authenticate(String, String, Method, ContainerRequestContext)} is not overridden.
     *
     ...
     * Authenticates specified request context for a certain REST end-point.
     * <p/>
     * The default implementation just delegates to {@link #authenticate(String, String, Method)}, override if applicable.
     *
     * @param login The login to check
     * @param password The password to check
     * @param invokedMethod The method of the REST end-point that is attempted being accessed
     * @param requestContext A reference to the surrounding request context
     * @return <code>true</code> if successfully authenticated; otherwise <code>false</code>
     * @see #permitAll(Method)
     */
    default boolean authenticate(String login, String password, Method invokedMethod, ContainerRequestContext requestContext) {
        return authenticate(login, password, invokedMethod);
    }
