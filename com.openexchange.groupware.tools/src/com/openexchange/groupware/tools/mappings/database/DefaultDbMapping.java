...
public abstract class DefaultDbMapping<T, O> extends DefaultMapping<T, O> implements DbMapping<T, O> {
	 ...
	 */
	protected DefaultDbMapping(final String columnLabel, final int sqlType) {
	 ...
	 * @param sqlType the SQL type
	 */
	protected DefaultDbMapping(final String columnLabel, final String readableName, final int sqlType) {
		super();
