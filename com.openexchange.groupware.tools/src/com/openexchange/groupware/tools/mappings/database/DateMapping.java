...
public abstract class DateMapping<O> extends DefaultDbMapping<Date, O> {
	...
	public Date get(final ResultSet resultSet, String columnLabel) throws SQLException {
	    try {
	        // MySQL Connector/J 8.0.26 applies the connection timezone on type DATETIME / TIMESTAMP only.
	        // So we explicitly need to specify UTC for type DATE. Otherwise the JVM timezone would be used.
