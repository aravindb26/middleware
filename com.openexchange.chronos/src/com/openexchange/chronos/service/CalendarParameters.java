...
public interface CalendarParameters {
     ...
     * {@link String}
     * <p/>
     * A collection of values that should be "ignored" when retrieving results, currently known values are <code>deleted</code>,
     * <code>changed</code> and <code>count</code> when serving the "updates" request.
     */
     ...
     * {@link String}
     * <p/>
     * The unique identifier of an existing event or event series to ignore when calculating free/busy information.
     * <p/>
     ...
     */
    static final String PARAMETER_MASK_UID = "maskUid";
     ...
     * {@link Boolean}
     * <p/>
     * Whether to reject the changes when handling a processed <code>COUNTER</code> proposal or not.
     * <p/>
     * Defaults to <code>false</code>, so that a processed <code>COUNTER</code> will be applied.
     */
    static final String PARAMETER_DECLINE_COUNTER = "decline_counter";
    
    /**
     * Array of {@link EventField}
     * <p/>
     * Allows to define a whitelist of event fields that are considered when applying an update from a counter proposal.
     */
    static final String PARAMETER_COUNTER_FIELDS = "counter_fields";
