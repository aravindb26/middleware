...
public interface UpdatesResult extends TimestampedResult {
    ...
    /**
     * Gets the total number of events in the underlying folder view (independently of the client supplied timestamp), aiding proper
     * detection of removed items during incremental synchronizations.
     * 
     * @return The total number of events, or <code>-1</code> if unknown or not evaluated
     */
    long getTotalCount();
