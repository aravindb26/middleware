...
public interface AdministrativeFreeBusyService {
     ...
     * @throws OXException If retrieving free/busy data fails
     */
    default Map<Attendee, FreeBusyResult> getFreeBusy(int ctxId, List<Attendee> attendees, Date from, Date until, boolean merge) throws OXException {
        return getFreeBusy(ctxId, attendees, from, until, merge, false);
    }
     ...
     * @throws OXException If retrieving free/busy data fails
     */
    Map<Attendee, FreeBusyResult> getFreeBusy(int ctxId, List<Attendee> attendees, Date from, Date until, boolean merge, boolean includeDetails) throws OXException;
