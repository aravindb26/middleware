...
public interface EntityResolver {
    ...
    /**
     * Gets the user identifiers who are privileged to act as <i>booking delegate</i> of a specific internal resource.
     *
     * @param resourceID The identifier of the resource to get the booking delegates for
     * @return The booking delegates, or an empty array if there none
     */
    int[] getBookingDelegates(int resourceID) throws OXException;

    /**
     * Gets the effective scheduling privilege for a resource of a certain user.
     * 
     * @param resourceID The identifier of the resource to evaluate the user's effective privilege for
     * @param userID The identifier of the user to evaluate the effective resource scheduling privilege for
     * @return The effective scheduling privilege
     */
    SchedulingPrivilege getSchedulingPrivilege(int resourceID, int userID) throws OXException;

    /**
     * Gets the identifiers of the resources where a certain user is a <i>booking delegate</i> for, i.e. he, or a group he is member of,
     * has the {@link SchedulingPrivilege#DELEGATE} assigned.
     * 
     * @param userID The identifier of the user to get the resources he can act as delegate for
     * @return The identifiers of the resource, or an empty array if there are none
     */
    int[] getResourcesWithDelegatePrivilege(int userID) throws OXException;
     ...
     */
    default Attendee applyEntityData(Attendee attendee) throws OXException {
        return applyEntityData(attendee, (Connection) null);
    }
     ...
     * @return The passed attendee reference, enriched by the resolved static entity data
     */
    Attendee applyEntityData(Attendee attendee, Connection optConnection) throws OXException;
     ...
     * @return The passed calendar user reference, enriched by the resolved static entity data
     */
    default <T extends CalendarUser> T applyEntityData(T calendarUser, CalendarUserType cuType) throws OXException {
        return applyEntityData(calendarUser, cuType, null);
    }
     ...
     * @return The passed calendar user reference, enriched by the resolved static entity data
     */
    <T extends CalendarUser> T applyEntityData(T calendarUser, CalendarUserType cuType, Connection optConnection) throws OXException;
