...
public interface CalendarService {
     ...
     * permissions (e.g. <i>read own</i>) are not considered. Additionally, the actual item count in each of the folders is
     ...
     * @return The sequence number result
     */
    SequenceResult getSequenceNumber(CalendarSession session, String folderID) throws OXException;
     ...
     */
    Map<Attendee, EventsResult> getEventsNeedingAction(CalendarSession session, boolean includeDelegates) throws OXException;
