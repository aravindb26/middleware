...
public interface CalendarConfig {
    ...
    /**
     * Gets the value for the auto-processing of iMIP mails
     * 
     * @param userId The identifier of the user to get the availability for
     * @return The auto-processing value, or <code>null</code> if not defined
     * @throws OXException in case of error
     */
    @Nullable
    AutoProcessIMip getAutoProcessIMip(int userId) throws OXException;

    /**
     * Gets the value for a specific user's free/busy visibility.
     * 
     * @param userId The identifier of the user to get the free/busy visibility for
     * @return The free busy visibility value, or the configured default if not defined or protected
     * @throws OXException in case of error
     */
    FreeBusyVisibility getFreeBusyVisibility(int userId) throws OXException;
    ...
    /**
     * Gets a valued indicating whether the cross-context free/busy lookup is allowed for the given context or not
     * 
     * @param contextId The context to check for
     * @return <code>true</code> if the cross-context lookup if allowed for the given context, <code>false</code> otherwise
     */
    boolean isCrossContextFreeBusy();

    /**
     * Gets a valued indicating whether the cross-context conflict check is allowed for the given context or not
     * 
     * @param contextId The context to check for
     * @return <code>true</code> if the cross-context check if allowed for the given context, <code>false</code> otherwise
     */
    boolean isCrossContextConflictCheck();
