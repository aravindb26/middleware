...
import static com.openexchange.chronos.exception.CalendarExceptionMessages.FREEBUSY_NOT_AVAILABLE_MSG;
...
import static com.openexchange.chronos.exception.CalendarExceptionMessages.RRULE_MISMATCH_MSG;
...
import static com.openexchange.chronos.exception.CalendarExceptionMessages.UID_CONFLICT_ATTENDEE_MSG;
...
public enum CalendarExceptionCodes implements DisplayableOXExceptionCode {
    ...
    /**
     * <li>The operation could not be completed due to insufficient permissions.</li>
     * <li>Insufficient scheduling privileges for resource [resource %1$d, required %2$s, actual %3$s]</li>
     */
    INSUFFICIENT_SCHEDULING_PRIVILEGES("Insufficient scheduling privileges for resource [resource %1$d, required %2$s, actual %3$s]", NO_PERMISSION_MSG, Category.CATEGORY_PERMISSION_DENIED, 40311),
    /**
     ...
     * <li>UID conflict [uid %1$s, folder %2$s, id %3$s]</li>
     */
    UID_CONFLICT("UID conflict [uid %1$s, folder %2$s, id %3$s]", UID_CONFLICT_MSG, Category.CATEGORY_CONFLICT, 4090),
    /**
    ...
    /**
     * <li>The participant \"%1$s\" cannot be added due to another conflicting appointment with the same unique identifier.</li>
     * <li>UID conflict for attendee [uid %2$s, attendee %3$s, id %4$s]</li>
     */
    UID_CONFLICT_ATTENDEE("UID conflict for attendee [uid %2$s, attendee %3$s, id %4$s]", UID_CONFLICT_ATTENDEE_MSG, Category.CATEGORY_CONFLICT, 4093),
    /**
    ...
    /**
     * <li>No free/busy information available for \"%1$s\".</li>
     * <li>No free/busy data available for attendee [email %1$s]</li>
     */
    FREEBUSY_NOT_AVAILABLE("No free/busy data available for attendee [email %1$s]", FREEBUSY_NOT_AVAILABLE_MSG, Category.CATEGORY_SERVICE_DOWN, 5033),
    /**
     * <li>No free/busy information available for \"%1$s\" (per user configuration).</li>
     * <li>No free/busy data available for attendee [email %1$s] (per user configuration)</li>
     */
    FREEBUSY_NOT_AVAILABLE_PER_CONFIGURATION("No free/busy data available for attendee [email %1$s] (per user configuration).", FREEBUSY_NOT_AVAILABLE_MSG, Category.CATEGORY_PERMISSION_DENIED, 40312),
    /**
    ...
    /**
     * <li>The date of the appointment series was adjusted automatically to match the recurrence rule.</li>
     * <li>Series master dates were synchronized with recurrence rule [start %1$s, rule %2$s]</li>
     */
    RRULE_MISMATCH("Series master dates were synchronized with recurrence rule [start %1$s, rule %2$s]", RRULE_MISMATCH_MSG, Category.CATEGORY_USER_INPUT, 1993),
