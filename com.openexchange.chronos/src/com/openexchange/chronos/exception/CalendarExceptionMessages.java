...
public class CalendarExceptionMessages implements LocalizableStrings {
    ...
    public static final String UID_CONFLICT_ATTENDEE_MSG = "The participant \"%1$s\" cannot be added due to another conflicting appointment with the same unique identifier.";
    ...
    public static final String FREEBUSY_NOT_AVAILABLE_MSG = "No free/busy information available for \"%1$s\".";

    public static final String RRULE_MISMATCH_MSG = "The date of the appointment series was adjusted automatically to match the recurrence rule.";
