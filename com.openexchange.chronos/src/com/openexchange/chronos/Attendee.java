...
public class Attendee extends CalendarUser {
    ...
    /**
     * Gets the sequence number to which the attendee last replied
     *
     * @return The sequence number to which the attendee last replied
     */
    ...
    /**
     * Sets the sequence number to which the attendee last replied
     *
     * @param value The sequence number to which the attendee last replied
     */
    public void setSequence(int value) {
        this.sequence = value;
        setFields.add(AttendeeField.SEQUENCE);
    }

    /**
     * Removes the sequence number to which the attendee last replied
     */
    public void removeSequence() {
        sequence = -1;
        setFields.remove(AttendeeField.SEQUENCE);
    }
    
    /**
     * Gets a value indicating whether the sequence number to which the attendee last replied
     * was set or not
     *
     * @return <code>true</code> if the sequence is set, <code>false</code>, otherwise
     */
    public boolean containsSequence() {
        return isSet(AttendeeField.SEQUENCE);
    }
