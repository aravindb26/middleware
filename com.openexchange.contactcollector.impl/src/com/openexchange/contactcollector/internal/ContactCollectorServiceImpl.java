...
import com.openexchange.contactcollector.Args;
...
public class ContactCollectorServiceImpl implements ContactCollectorService {
    ...
    @Override
    public void memorizeAddresses(Collection<InternetAddress> addresses, Args args) throws OXException {
        memorizeAddresses(addresses, args.isIncrementUseCount(), args.getSession(), args.isAsync());
    }

    public void memorizeAddresses(Collection<InternetAddress> addresses, boolean incrementUseCount, Session session, boolean background) throws OXException {
        ...
        if (!background) {
            ...
            MemorizerWorker.handleTask(memorizerTask, false, services);
            return;
        }
