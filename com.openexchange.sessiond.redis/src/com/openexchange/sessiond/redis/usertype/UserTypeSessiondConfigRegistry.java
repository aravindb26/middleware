...
public class UserTypeSessiondConfigRegistry {
     ...
     */
    public UserTypeSessiondConfigRegistry(ServiceLookup services) throws OXException {
        this(services.getServiceSafe(LeanConfigurationService.class));
    }
     ...
     */
    public UserTypeSessiondConfigRegistry(LeanConfigurationService conf) {
        super();
