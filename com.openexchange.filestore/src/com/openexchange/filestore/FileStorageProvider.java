...
public interface FileStorageProvider {
    ...
    /**
     * Gets an optional listing of all URIs for file storages associated with specified base URI.
     * <p>
     * The base URI is the one assigned to to a file storage on registration; e.g. <code>"s3://mys3store"</code> or <code>"/var/opt/filestore"</code>.
     *
     * @param baseUri The base URI
     * @param optionalFilter The optional filter
     * @return The optional listing of file storage URIs or empty
     * @throws OXException If optional listing of file storage URIs cannot be returned
     */
    default Optional<List<URI>> getFileStorages(URI baseUri, Optional<FileStorageFilter> optionalFilter) throws OXException {
