...
import com.openexchange.preview.internal.PreviewServiceImpl;
...
public class PreviewActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        final PreviewServiceImpl previewServiceImpl = new PreviewServiceImpl();
        registerService(PreviewService.class, previewServiceImpl);
        /*
         * Trackers
         */
        trackService(ManagedFileManagement.class);
        trackService(HtmlService.class);
        track(InternalPreviewService.class, previewServiceImpl);
        openTrackers();
    }
