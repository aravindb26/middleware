...
public class RdbDatabaseCleanUpExecutionManagement implements DatabaseCleanUpExecutionManagement {
    ...
    private static boolean doMarkExecutionDone(CleanUpJob job, Connection writeCon) throws OXException {
    ...
    private static boolean doRefreshTimeStamp(CleanUpJob job, Connection writeCon) throws OXException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
    ...
    private static boolean doCheckExecutionPermission(CleanUpJob job, ConnectionProvider connectionProvider) throws OXException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
