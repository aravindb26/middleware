...
public final class InitAction extends AbstractOAuthTokenAction {
    ...
    private static HostInfo determineHost(AJAXRequestData request, ServerSession session) {
     ...
     * @return The hostname
     */
    private static String determineHostName(AJAXRequestData requestData, ServerSession session) {
