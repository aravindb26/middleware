...
public abstract class ContactExportAction extends AbstractExportAction {
    ...
    /** Whether to sanitize exported content */
    public static final String PARAMETER_SANITIZE = "sanitize";

    /**
     * Initializes a new {@link ContactExportAction}.
     *
     * @param exporter The exporter
     * @param format The format
     */
    protected ContactExportAction(Exporter exporter, Format format) {
    ...
    protected Map<String, Object> getOptionalParams(ExportRequest req) {
        ...
        String sanitizeParam = req.getRequest().getParameter(PARAMETER_SANITIZE);
        if (sanitizeParam != null) {
            params.put(PARAMETER_SANITIZE, sanitizeParam);
        }
