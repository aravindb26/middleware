...
public abstract class AbstractCompositingIDBasedCalendarAccess implements TransactionAware, CalendarParameters {
     ...
     */
    protected AbstractCompositingIDBasedCalendarAccess(Session session, CalendarParameters parameters, CalendarProviderRegistry providerRegistry, ServiceLookup services) throws OXException {
        super();
        this.services = services;
        this.providerRegistry = providerRegistry;
        this.session = ServerSessionAdapter.valueOf(session);
        this.parameters = null == parameters ? new DefaultCalendarParameters() : new DefaultCalendarParameters(parameters);
    ...
    protected boolean isAutoProvisioned(CalendarAccount account) {
        ...
        return null != provider && (provider instanceof AutoProvisioningCalendarProvider);
    }
    ...
    private CalendarAccess initAccess(CalendarAccount account) {
        ...
        try {
            ...
            if (null != provider && (provider instanceof FallbackAwareCalendarProvider)) {
                /*
            ...
            if (null != provider && (provider instanceof AutoProvisioningCalendarProvider)) {
                /*
    ...
    protected boolean isFolderCalendarProvider(int accountId) throws OXException {
        ...
        return (provider instanceof FolderCalendarProvider);
    }
