...
public class CompositingIDBasedCalendarAccessFactory implements IDBasedCalendarAccessFactory {
    ...
    public IDBasedCalendarAccess createAccess(Session session) throws OXException {
        return createAccess(session, null);
    }

    @Override
    public IDBasedCalendarAccess createAccess(Session session, CalendarParameters parameters) throws OXException {
        return new CompositingIDBasedCalendarAccess(session, parameters, providerRegistry, services);
    }
