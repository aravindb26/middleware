...
public class DriveConstants {
     ...
     * 9: userized push notifications (folder path views)
     */
    public static final int SUPPORTED_API_VERSION = 9;
     ...
     *
     * @deprecated Use {@link #LOG_FAST_DATE_FORMAT}
     */
    @Deprecated
    public static final ThreadLocal<SimpleDateFormat> LOG_DATE_FORMAT = ThreadLocal.withInitial(() -> {
    ...
    /**
     * Singleton {@link FastDateFormat} using "yyyy-MM-dd HH:mm:ss.SSS" as pattern.
     */
    public static final FastDateFormat LOG_FAST_DATE_FORMAT = FastDateFormat.getInstance("yyyy-MM-dd HH:mm:ss.SSS", TimeZones.UTC, Locale.US);
