...
public class DefaultSyncResult<T extends DriveVersion> implements SyncResult<T> {
    ...
    private final String localizedPathToRoot;
    ...
    public DefaultSyncResult(List<AbstractAction<T>> actionsForClient, String diagnosticsLog) {
        this(actionsForClient, diagnosticsLog, null, null, null);
    }
     ...
     * @param localizedPathToRoot The localized sync'ed root folder's path to the internal root folder
     */
    public DefaultSyncResult(List<AbstractAction<T>> actionsForClient, String diagnosticsLog, DriveQuota quota, String pathToRoot, String localizedPathToRoot) {
        super();
        ...
        this.localizedPathToRoot = localizedPathToRoot;
    }
    ...
    @Override
    public String getLocalizedPathToRoot() {
        return localizedPathToRoot;
    }
