...
public class SyncSession {
     ...
     * directories are excluded. Missing directory checksums will be calculated on demand, however, the folder won't get created
     * implicitly and an exception is thrown in case it not already exists.
     *
    ...
    public ServerDirectoryVersion getServerDirectory(String path) throws OXException {
        return getStorage().wrapInTransaction(new StorageOperation<ServerDirectoryVersion>() {
            ...
            public ServerDirectoryVersion call() throws OXException {
                FileStorageFolder folder = getStorage().getFolder(path, false);
