...
public class ReportInformationTest {
  ...
  //@formatter:off
    ...
    public void testGetConfiguredThirdPartyAPIsViaOAuth_Filled() {
        List<ThirdPartyAPI> oAuthAPIs = Arrays.asList(ThirdPartyAPI.BOXCOM, ThirdPartyAPI.DROPBOX, ThirdPartyAPI.GOOGLE, ThirdPartyAPI.MICROSOFT, ThirdPartyAPI.XING, ThirdPartyAPI.YAHOO);
