...
public class TrustedSSLSocketFactory extends SSLSocketFactory implements HandshakeCompletedListener {
    ...
    private static final TrustManagerFactorySpi TRUSTED_FACTORY_SPI = new TrustManagerFactorySpi() {
    ...
    private static final Provider PROVIDER = new Provider("", "0.0", "") {
        private static final long serialVersionUID = -4880540247105807895L;
    };

    private static final TrustManagerFactory TRUSTED_FACTORY = new TrustManagerFactory(TRUSTED_FACTORY_SPI, PROVIDER, "") {
        // Nothing
    };

    /**
     * Gets the trusted trust manager factory.
     *
     * @return The trusted trust manager factory
     */
