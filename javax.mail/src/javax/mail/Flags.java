...
public class Flags implements Cloneable, Serializable {
    ...
    private static final int DELETED_BIT 	= 0x02;
    private static final int DRAFT_BIT 		= 0x04;
	...
	user_flags.put(com.openexchange.java.Strings.asciiLowerCase(flag), flag);
    }
	...
	if (user_flags != null)
	    user_flags.remove(com.openexchange.java.Strings.asciiLowerCase(flag));
    }
	...
	if (user_flags == null) 
	    ...
	    return user_flags.containsKey(com.openexchange.java.Strings.asciiLowerCase(flag));
    }
    ...
    if (null == user_flags || (size = user_flags.size()) <= 0) {
        return com.openexchange.java.Strings.getEmptyStrings();
    }
