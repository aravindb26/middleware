...
public class MimeBodyPart extends BodyPart implements MimePart {
   ...
   /**
    ...
    public void saveFile(File file) throws IOException, MessagingException {
        java.nio.file.Files.copy(getInputStream(), file.toPath(), java.nio.file.StandardCopyOption.REPLACE_EXISTING);
    }
	...
	try {
        ...
        try {
            ...
            ContentTypeSanitizer sanitizer = (ContentTypeSanitizer) System.getProperties().get("mail.mime.contentTypeSanitizer");
            if (sanitizer == null) {
                throw e;
            }
            type = sanitizer.sanitizeContentType(type, e);
            cType = new ContentType(type);
