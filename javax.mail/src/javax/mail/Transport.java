...
public abstract class Transport extends Service {
	...
	if (sendFailed || !invalid.isEmpty() || !validUnsent.isEmpty()) { 
    ...
    private final java.util.concurrent.atomic.AtomicReference<Vector<TransportListener>> transportListenersRef = new java.util.concurrent.atomic.AtomicReference<>();
    ...
    Vector<TransportListener> transportListeners = transportListenersRef.get();
	if (transportListeners == null) {
	    transportListeners = new Vector<>();
	    transportListenersRef.set(transportListeners);
	}
