...
public class FilteredResponse extends IMAPResponse {
    ...
    private static final char[] TAG = { 'T', 'A', 'G' };
    private static final char[] FILTER_RESULT_OK = { 'O', 'K' };
    private static final char[] FILTER_RESULT_ERRORS = { 'E', 'R', 'R', 'O', 'R', 'S' };
    private static final char[] FILTER_RESULT_WARNINGS = { 'W', 'A', 'R', 'N', 'I', 'N', 'G', 'S' };
