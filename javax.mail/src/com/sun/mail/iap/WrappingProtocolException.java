...
public class WrappingProtocolException extends ProtocolException {
     ...
     * @throws IllegalArgumentException if passed {@code MessagingException} is <code>null</code>
     */
    public WrappingProtocolException(MessagingException cause) {
        super(cause == null ? null : cause.getMessage(), cause);
        if (cause == null) {
            throw new IllegalArgumentException("MessagingException must not be null");
        }
