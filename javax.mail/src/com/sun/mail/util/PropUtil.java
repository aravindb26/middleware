...
public class PropUtil {
    ...
    /**
     * Gets the typed value of the specified property.
     *
     * @param <T> The type of the value
     * @param props The properties to get from
     * @param name The name of the property
     * @param def The default instance to return if absent
     * @return The typed value or given default instance
     */
    public static <T> T getType(Properties props, String name, T def) {
    if (props == null) {
        return null;
    }

    T val = (T) props.get(name);
     ...
     * @return      the property value
     */
    public static long getLongProperty(Properties props, String name, long def) {
    return getLong(getProp(props, name), def);
    }

    /**
     * Interpret the value object as a long,
     * returning def if unable.
     */
    private static long getLong(Object value, long def) {
    if (value == null)
        return def;
    if (value instanceof String) {
        try {
