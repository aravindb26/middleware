...
public class SMTPAddressSucceededException extends MessagingException {
    protected final InternetAddress addr;	// address that succeeded
    protected final String cmd;		// command issued to server
    protected final int rc;			// return code from SMTP server
