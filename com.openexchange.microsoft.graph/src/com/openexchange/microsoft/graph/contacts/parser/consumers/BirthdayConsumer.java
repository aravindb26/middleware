...
public class BirthdayConsumer implements BiConsumer<JSONObject, Contact> {
     ...
     */
    private static final String DATE_FORMAT_BIRTHDAY = "yyyy-MM-dd'T'HH:mm:ss'Z'";

    /**
     * Date format using <code>"yyyy-MM-ddTHH:mm:ssZ"</code> as pattern.
     */
    private static final FastDateFormat BIRTHDAY_FORMAT = FastDateFormat.getInstance(DATE_FORMAT_BIRTHDAY, TimeZones.UTC);
    ...
    public void accept(JSONObject t, Contact u) {
        ...
        try {
            u.setBirthday(BIRTHDAY_FORMAT.parse(birthday));
