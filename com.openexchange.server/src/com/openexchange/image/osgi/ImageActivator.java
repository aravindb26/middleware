...
public class ImageActivator extends AJAXModuleActivator {
    ...
    protected Class<?>[] getOptionalServices() {
        return new Class<?>[] { CryptographicServiceAuthenticationFactory.class, CryptographicAwareMailAccessFactory.class, EncryptedMailService.class, CryptoMailRecognizerService.class };
    }
