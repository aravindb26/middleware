...
import com.openexchange.ajax.login.RampUpDeprecated;
...
public class LoginServlet extends AJAXServlet {
    ...
    public LoginServlet() {
        super();
        ConcurrentMap<String, LoginRequestHandler> handlerMap = new ConcurrentHashMap<>(16, 0.9f, 1);
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        handlerMap.put(ACTION_RAMPUP, new RampUpDeprecated());
    ...
    private static void recordLoginRequest(String action, String status, long durationMillis) {
        HttpMetricUtil.getInstance().recordRequest("login", action, status, durationMillis);
    }
