...
public abstract class AbstractLoginRequestHandler implements LoginRequestHandler {
    ...
    private static final boolean RAMP_UP_DISABLED_DEPREACTED = true;
     ...
     * @param req The request
     * @return The resulting object or <code>null</code> if ramp-up is disabled/deprecated
     */
    public Future<JSONObject> rampUpAsync(final ServerSession serverSession, final HttpServletRequest req) {
        if (RAMP_UP_DISABLED_DEPREACTED) {
            return null;
        }
