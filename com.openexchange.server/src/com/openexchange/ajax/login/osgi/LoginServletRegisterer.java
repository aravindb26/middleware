...
public class LoginServletRegisterer implements ServiceTrackerCustomizer<Object, Object> {
    ...
    private final Map<String, LoginRequestHandler> handlers = new ConcurrentHashMap<>();
    ...
    public Object addingService(final ServiceReference<Object> reference) {
        ...
        if (obj instanceof LoginRequestHandler) {
            ...
            if (null != tmp && tmp instanceof String action) {
        ...
        if (needsRegistration) {
            ...
            final Dictionary<String, String> params = new Hashtable<>(32);
