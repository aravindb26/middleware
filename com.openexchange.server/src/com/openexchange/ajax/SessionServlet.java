...
public abstract class SessionServlet extends AJAXServlet {
     ...
     * Handles passed {@link OXException} instance.
     *
     * @param oxe The {@code OXException} instance
     ...
     * @throws IOException If an I/O error occurs
     */
    protected void handleOXException(OXException oxe, int statusCode, String reasonPhrase, HttpServletRequest req, HttpServletResponse resp, boolean checkUploadQuota, boolean doLog) throws IOException {
        OXException e = oxe;
    ...
    public static void sendErrorAndPage(int statusCode, String statusMsg, HttpServletResponse httpResponse) throws IOException {
        ...
        try {
            ...
            // Ignore
            httpResponse.sendError(statusCode, null == statusMsg ? null : statusMsg);
