...
public abstract class AJAXModuleActivator extends HousekeepingActivator {
    ...
    /**
     * Registers the specified scope type as an {@link OAuthScopeProvider}
     * and sets-up the denoted scope so that it can always be granted for the passed session users' capabilities.
     *
     * @param type the scope type
     * @param module The module
     * @param description The scope's description
     */
    protected void registerScope(RestrictedAction.Type type, String module, String description) {
        registerScope(type, module, description, (Permission[]) null);
    }

    /**
     * Registers the specified scope type as an {@link OAuthScopeProvider}
     * and sets-up the denoted scope to be checked if it can be granted for the passed session users' capabilities
     *
     * @param type the scope type
     * @param module The module
     * @param description The scope's description
     ...
     */
    protected void registerScope(RestrictedAction.Type type, String module, String description, Permission... permissions) {
        registerService(OAuthScopeProvider.class, new AbstractScopeProvider(type.getScope(module), description) {
            ...
            public boolean canBeGranted(CapabilitySet capabilities) {
                ...
                for(Permission permission : permissions) {
                    if (capabilities.contains(permission.getCapabilityName())) {
                        return true;
                    }
                }
                return false;
    ...
    private void registerInternal(final AJAXActionServiceFactory factory, final String module, final boolean multiple) {
        ...
        if (factory instanceof ExtendableAJAXActionServiceFactory) {
            ...
            registerService(ExtendableAJAXActionServiceFactory.class, (ExtendableAJAXActionServiceFactory) factory);
        }
    }
}
