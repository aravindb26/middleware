        ...
        try {
            if (object instanceof Collection) {
                ...
                for (Object content : ((Collection<? extends Object>) object)) {
                    arr.put(JSONServices.parseObject(MAPPER.writeValueAsString(content)));
                }
                result.setResultObject(arr, "json");
                return;
            }

            result.setResultObject(JSONServices.parseObject(MAPPER.writeValueAsString(object)), "json");
