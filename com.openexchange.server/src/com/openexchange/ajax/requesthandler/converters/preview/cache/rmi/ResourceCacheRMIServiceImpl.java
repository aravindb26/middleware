 ...
 * @since v7.10.1
 */
public class ResourceCacheRMIServiceImpl extends AbstractAuthenticatorRMIService implements ResourceCacheRMIService {
    ...
    /**
     * Initializes a new {@link ResourceCacheRMIServiceImpl}.
     *
     * @param authenticatorReference The reference for authenticator
     */
    public ResourceCacheRMIServiceImpl(AtomicReference<Authenticator> authenticatorReference) {
        super();
        this.authenticatorReference = authenticatorReference;
    }

    @Override
    public void clear(Credentials auth) throws RemoteException {
    ...
    @Override
    public void clearFor(int contextId, Credentials auth) throws RemoteException {
        Authenticator authenticator = authenticatorReference.get();
    ...
    @Override
    public String sanitizeMimeTypesInDatabaseFor(int contextId, String invalids, Credentials auth) throws RemoteException {
        Authenticator authenticator = authenticatorReference.get();
        authenticate(authenticator, auth, contextId);
        ...
        try {
            ...
            if (Strings.isNotEmpty(invalids)) {
                for (String invalid : Strings.splitByComma(invalids)) {
     ...
     */
    private static List<Integer> getContextIds() throws OXException {
     ...
     */
    private static String getPrimaryType(String contentType) {
