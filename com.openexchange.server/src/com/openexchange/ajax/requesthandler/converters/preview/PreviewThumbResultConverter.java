    ...
    public void convert(AJAXRequestData requestData, AJAXRequestResult result, ServerSession session, Converter converter) throws OXException {
        ...
        try {
            ...
            if (isBlockingWorkerAllowed) {
                ...
                // apply to request/response
                ThresholdFileHolder responseFileHolder = null;
                try {
                    responseFileHolder = new ThresholdFileHolder();
                    responseFileHolder.write(thumbnail);
                    responseFileHolder.setContentType(contentType);
                    responseFileHolder.setName(fileName);
                    result.setResultObject(responseFileHolder, "file");
                    responseFileHolder = null; // Avoid premature closing
                } finally {
                    Streams.close(responseFileHolder);
                }
            } else {
