...
public interface ResourceCacheRMIService extends Remote {
     ...
     */
    void clear(Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException If operation fails
     */
    void clearFor(int contextId, Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException If operation fails
     */
    String sanitizeMimeTypesInDatabaseFor(int contextId, String invalids, Credentials auth) throws RemoteException;
}
