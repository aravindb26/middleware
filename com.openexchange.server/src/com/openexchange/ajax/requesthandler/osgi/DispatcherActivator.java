...
public class DispatcherActivator extends AbstractSessionServletActivator {
    ...
    protected synchronized void startBundle() throws Exception {
        DispatcherPrefixService dispatcherPrefixService = getServiceSafe(DispatcherPrefixService.class);
        ...
        dispatcher.addCustomizer((request, session) -> DecoratingAJAXActionCustomizer.getInstance());
        ...
        final OAuthDispatcherServlet oAuthDispatcherServletWithoutPrefix = new OAuthDispatcherServlet(this, prefix);
