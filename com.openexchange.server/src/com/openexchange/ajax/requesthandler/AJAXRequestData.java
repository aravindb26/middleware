...
public class AJAXRequestData {
     ...
     * <li> {@link HttpServletResponse#setCharacterEncoding(String)} </li>
     * <ul>
     * <p>
     *
     ...
     *
     * @param decoratorIds The decorator identifiers
    ...
    public @NonNull AJAXRequestData addDecoratorIds(final @NonNull Collection<String> decoratorIds) {
        ...
        thisDecoratorIds.addAll(decoratorIds);
        return this;
    }
     ...
     * binary data.
     * <p>
     * Calling flush() on the OutputStream commits the response. Either this method or {@link HttpServletResponse#getWriter} may be called to write the
     * body, not both.
     *
     ...
     * encoding returned by {@link HttpServletResponse#getCharacterEncoding}. If the response's character encoding has not been specified as described in
     ...
     * <p>
     * Either this method or {@link HttpServletResponse#getOutputStream} may be called to write the body, not both.
     *
     ...
     * <a href="https://www.iana.org/assignments/character-sets">IANA Character Sets</a>
     ...
     *
     * @param uploadStreamProvider The upload stream provider to set
     */
        ...
        if (multipart) {
            ...
            synchronized (thisFiles) {
                if (streamed) {
                    ...
                    if (null == streamedUpload) {
                        try {
                            ...
                            if (UploadException.UploadCode.FAILED_STREAMED_UPLOAD.equals(e)) {
                                ...
                                if (null == uploadEvent) {
                                    setUploadEvent(thisFiles, (UploadEvent) e.getArgument("__uploadEvent"));
                                }
                            }
                            throw e;
                        }
                    ...
                    UploadEvent uploadEvent = this.uploadEvent;
                    if (null == uploadEvent) {
                        setUploadEvent(thisFiles, AJAXServlet.processUploadStatic(localHttpServletRequest, maxFileSize, maxOverallSize, session));
                    }
                }
            }
    ...
    /**
     * Sets the upload even and processes the uploads
     *
     * @param files The files list
     * @param uploadEvent the upload event
     */
    private void setUploadEvent(List<UploadFile> files, UploadEvent uploadEvent) {
        this.uploadEvent = uploadEvent;
        for (Iterator<UploadFile> iterator = uploadEvent.getUploadFilesIterator(); iterator.hasNext(); ) {
            files.add(iterator.next());
        }
