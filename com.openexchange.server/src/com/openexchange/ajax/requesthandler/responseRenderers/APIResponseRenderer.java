...
public class APIResponseRenderer implements ResponseRenderer {
    ...
    private static final String INCLUDE_STACK_TRACE_ON_ERROR = AJAXServlet.PARAMETER_INCLUDE_STACK_TRACE_ON_ERROR;

    private static final String CONTENTTYPE_HTML = AJAXServlet.CONTENTTYPE_HTML;
    ...
    private static boolean writeResponse(Response response, String action, PrintWriter writer, HttpServletRequest req, HttpServletResponse resp, boolean plainJson) throws IOException {
        try {
            if (parseBoolParameter(INCLUDE_STACK_TRACE_ON_ERROR, req) ) {
