...
public enum FolderExceptionErrorMessage implements DisplayableOXExceptionCode {
    ...
    /**
     * Update operation not permitted for folder "%1$s" for user %2$s in context %3$s
     */
    UPDATE_NOT_PERMITTED("Update operation not permitted for folder \"%1$s\" for user %2$s in context %3$s.", Category.CATEGORY_PERMISSION_DENIED, 1051, FolderExceptionMessages.UPDATE_NOT_PERMITTED_MSG_DISPLAY),
