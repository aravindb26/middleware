...
public class FolderExceptionMessages implements LocalizableStrings {
    ...
    // You do not have appropriate permissions to update the folder.
    public static final String UPDATE_NOT_PERMITTED_MSG_DISPLAY = "You do not have appropriate permissions to update the folder.";
