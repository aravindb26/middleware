...
public final class CacheFolderStorage implements ReinitializableFolderStorage, FolderCacheInvalidationService, TrashAwareFolderStorage, SubfolderListingFolderStorage, RestoringFolderStorage, SearchableFileFolderNameFolderStorage {
    ...
    public void clearCache(int userId, int contextId) {
        ...
        if (userId > 0) {
            dropUserEntries(userId, contextId, false);
        } else {
     ...
     */
    public void removeSingleFromCache(Collection<? extends String> ids, String treeId, int userId, Session session, boolean deleted) {
     ...
     * @param contextId The context identifier
     */
    public void removeSingleFromCache(Collection<? extends String> ids, String treeId, int optUserId, int contextId, boolean deleted, Session optSession) {
     ...
     * @param contextId The context identifier
     */
    public void removeSingleFromCache(Collection<? extends String> ids, String treeId, int optUserId, int contextId, boolean deleted, boolean userCacheOnly, Session optSession) {
        try {
