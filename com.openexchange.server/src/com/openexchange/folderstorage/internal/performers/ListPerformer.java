...
public final class ListPerformer extends AbstractUserizedFolderPerformer {
    ...
    List<SortableId> filterPOP3SubfolderIds(FolderStorage neededStorage, String treeId, String parentId, SortableId[] subfolderIds, StorageParameters newParameters) throws OXException {
        ...
        if (MailProperties.getInstance().isHidePOP3StorageFolders(storageParameters.getUserId(), storageParameters.getContextId()) && FOLDER_TYPE_MAIL.servesFolderId(parentId)) {
            ...
            if (Account.DEFAULT_ID == argument.getAccountId()) {
    ...
    private static final IdsOrObjects EMPTY_IDS_OR_OBJECTS = new IdsOrObjects(Strings.getEmptyStrings());
