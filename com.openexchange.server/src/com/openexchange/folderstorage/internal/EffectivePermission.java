 ...
 */
public final class EffectivePermission implements DeputyAwarePermission {
    ...
    public boolean isDeputyPermissionSupported() {
        return (underlyingPerm instanceof DeputyAwarePermission);
    }

    @Override
    public boolean isDeputyPermission() {
        return (underlyingPerm instanceof DeputyAwarePermission) ? ((DeputyAwarePermission) underlyingPerm).isDeputyPermission() : false;
    }
