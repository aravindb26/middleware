...
public final class Database {
    ...
    private static final AtomicReference<DatabaseService> DB_SERVICE_REF = new AtomicReference<>(null);
    ...
    /**
     * Sets the database service to given reference.
     *
     * @param databaseService The database service or <code>null</code>
     */
    public static void setDatabaseService(final DatabaseService databaseService) {
        DB_SERVICE_REF.set(databaseService);
    }
     ...
     * @throws OXException If database service is unavailable at the moment
     */
    public static DatabaseService getDatabaseService() throws OXException {
        DatabaseService databaseService = DB_SERVICE_REF.get();
     ...
     *
     * @param contextId A unique identifier of the context
