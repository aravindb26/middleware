...
//    }
    ...
    public static void addTaskEvent(final TaskEventInterface event) {
        if ((event instanceof NoDelayEventInterface)) {
    ...
    public static void removeFolderEvent(final FolderEventInterface event) {
        List<FolderEventInterface> toRemoveFrom = (event instanceof NoDelayEventInterface) ? noDelayFolderEventList : folderEventList;
