...
public abstract class ComparedOCLPermission<P> {
    ...
    private final Collection<P> newPermissions;
    private final Collection<P> originalPermissions;
