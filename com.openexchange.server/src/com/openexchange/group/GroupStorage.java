...
public interface GroupStorage {
     ...
     * <p/>
     * If applicable for the storage, an optional passed locale is considered when looking up certain system groups whose name varies by
     * locale. The returned matches are still returned in their default representation, though, as they're subject for subsequent
     * translation towards the client again.
     *
     * @param pattern The pattern to search for within the display name of groups
     * @param loadMembers <code>true</code> to load members, <code>false</code>, otherwise
     * @param context The context
     * @param locale The locale to consider when matching against virtual/system groups, or <code>null</code> if not applicable
     * @return An array of groups that match the search pattern
     * @throws OXException if searching has some storage related problem
     */
    default Group[] searchGroups(Context context, String pattern, boolean loadMembers, Locale locale) throws OXException {
