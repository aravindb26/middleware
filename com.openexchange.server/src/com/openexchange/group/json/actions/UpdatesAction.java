...
public final class UpdatesAction extends AbstractGroupAction {
    ...
    protected AJAXRequestResult perform(final GroupAJAXRequest req) throws OXException {
        ...
        Group[] modifiedGroups = groupService.listModifiedGroups(req.getSession(), modifiedSince);
        Group[] deletedGroups = groupService.listDeletedGroups(req.getSession(), modifiedSince);
