...
public enum MailExceptionCode implements DisplayableOXExceptionCode {
     ...
     */
    INVALID_FOLDER_NAME_SIMPLE("Invalid folder name specified. Information from mail server: %1$s", MailExceptionStrings.INVALID_FOLDER_NAME_SIMPLE_MSG, INVALID_FOLDER_NAME.getCategory(), INVALID_FOLDER_NAME.getNumber()),
    /**
    ...
    /**
     * Mail access is deactivated for server %1$s with login %2$s (user=%3$s, context=%4$s)
     */
    MAIL_ACCESS_DEACTIVATED("Mail access is deactivated for server %1$s with login %2$s (user=%3$s, context=%4$s)", MailExceptionStrings.MAIL_ACCESS_DEACTIVATED_MSG, CATEGORY_PERMISSION_DENIED, 124),
    /**
     * Mail transport is deactivated for server %1$s with login %2$s (user=%3$s, context=%4$s)
     */
    MAIL_TRANSPORT_DEACTIVATED("Mail transport is deactivated for server %1$s with login %2$s (user=%3$s, context=%4$s)", MailExceptionStrings.MAIL_TRANSPORT_DEACTIVATED_MSG, CATEGORY_PERMISSION_DENIED, 124),
    /**
     * Archive function not available for selected mail account.
     */
    ARCHIVE_FUNCTION_NOT_AVAILABLE("Archive function not available for selected mail account.", MailExceptionStrings.ARCHIVE_FUNCTION_NOT_AVAILABLE_MSG, CATEGORY_PERMISSION_DENIED, 125),
    /**
     * The operation can never succeed. Information from mail server: %1$s
     */
    INVALID_OPERATION("The operation can never succeed. Information from mail server: %1$s", MailExceptionStrings.INVALID_OPERATION_MSG, CATEGORY_ERROR, 126),
    /**
     * The "%1$s" operation can never succeed. Information from mail server: %2$s
     */
    INVALID_OPERATION_EXT("The \"%1$s\" operation can never succeed. Information from mail server: %2$s", MailExceptionStrings.INVALID_OPERATION_MSG, CATEGORY_ERROR, 126),
    /**
     * Failed decrypting the password for accessing server %1$s with login %2$s (user=%3$s, context=%4$s)
     */
    CANNOT_DECRYPT_PASSWORD("Failed decrypting the password for accessing server %1$s with login %2$s (user=%3$s, context=%4$s)", MailExceptionStrings.CANNOT_DECRYPT_PASSWORD_MSG, CATEGORY_USER_INPUT, 127),
    /**
     * An SSL error occurred: %1$s
     */
    SSL_ERROR("An SSL error occurred: %1$s", CATEGORY_ERROR, 128),
    /**
     * User %1$s (%2$s) has not granted "send on behalf of" permission to user user %3$s (%4$s) in context on %5$s
     */
    NO_ON_BEHALF_OF_PERMISSION("User %1$s (%2$s) has not granted \"send on behalf of\" permission to user user %3$s (%4$s) in context on %5$s", MailExceptionStrings.NO_ON_BEHALF_OF_PERMISSION_MSG, CATEGORY_PERMISSION_DENIED, 129),
    ;
