 ...
 */
public final class MailPath implements Cloneable, Serializable, Comparable<MailPath> {
    ...
    @Override
    public int compareTo(MailPath o) {
        int c = Integer.compare(accountId, o.accountId);
        if (c != 0) {
            return c;
        }
        c = folder.compareToIgnoreCase(o.folder);
        if (c != 0) {
            return c;
        }
        return mailID.compareToIgnoreCase(o.mailID);
    }
