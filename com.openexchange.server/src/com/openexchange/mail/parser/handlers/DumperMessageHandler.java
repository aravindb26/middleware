...
public class DumperMessageHandler implements MailMessageHandler {
    ...
    public boolean handleSender(InternetAddress[] senderAddrs) throws OXException {
        ...
        strBuilder.append('\n').append("handleSender:\n");
        strBuilder.append("Sender=").append(Arrays.toString(senderAddrs)).append('\n');
        return true;
    }
    ...
    public boolean handleReplyTo(InternetAddress[] replyToAddrs) throws OXException {
        ...
        strBuilder.append('\n').append("handleReplyTo:\n");
        strBuilder.append("Reply-To=").append(Arrays.toString(replyToAddrs)).append('\n');
        return true;
    }
