...
public final class MailExceptionStrings implements LocalizableStrings {
    ...
    public static final String INVALID_FOLDER_NAME_SIMPLE_MSG = "Invalid folder name specified. Information from mail server: %1$s";
    ...
    // Your mail account %2$s is deactivated. Please activate the account in order to access it.
    public static final String MAIL_ACCESS_DEACTIVATED_MSG = "Your mail account %2$s is deactivated. Please activate the account in order to access it.";

    // Your transport account %2$s is deactivated. Please activate the account in order to access it.
    public static final String MAIL_TRANSPORT_DEACTIVATED_MSG = "Your transport account %2$s is deactivated. Please activate the account in order to access it.";

    // Archive function not available for selected mail account.
    public static final String ARCHIVE_FUNCTION_NOT_AVAILABLE_MSG = "Archive function not available for selected mail account.";

    // The operation issued against mail server violates some invariant of the server and can never succeed.
    public static final String INVALID_OPERATION_MSG = "The operation can never succeed. Information from mail server: %1$s";

    // Failed to decrypt an account's password using configured secret string. Note: Passwords for external accounts are stored encrypted in database.
    public static final String CANNOT_DECRYPT_PASSWORD_MSG = "Failed decrypting the password for accessing server %1$s with login %2$s";

    // Sending user does not possess "send on behalf of" permission and thus sending is denied.
    public static final String NO_ON_BEHALF_OF_PERMISSION_MSG = "No \"send on behalf of\" permisison has been granted";
