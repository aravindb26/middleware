        ...
        if (incrementUseCount) {
            ...
            if (null != useCountService) {
                ...
                if (null != addrs && !addrs.isEmpty()) {
                    ...
                    IncrementArguments.Builder builder = IncrementArguments.builderWithMailAddresses(addressesToIncrementBy);
                    useCountService.incrementUseCount(session, builder.build());
                }
            }
        }
    }
