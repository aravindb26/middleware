...
public class MailFolder implements Serializable, Cloneable {
    ...
    /**
     * Gets the shared owner information or <code>null</code>.
     * <p>
     * <b>Note:</b> {@link #isShared()} needs to return <code>true</code>.
     *
     * @return The owner information or <code>null</code>
     */
    ...
    /**
     * Checks if the owner information was set.
     *
     * @return <code>true</code> if owner information is set; otherwise <code>false</code>
     */
    public boolean containsOwnerInfo() {
        return b_ownerInfo;
    }

    /**
     * Removes the owner information.
     */
    public void removeOwnerInfo() {
        ownerInfo = null;
        b_ownerInfo = false;
    }

    /**
     * Sets the shared owner information or <code>null</code>.
     * <p>
     * <b>Note:</b> {@link #setShared(boolean)} needs to be invoked with <code>true</code>.
     *
