...
public abstract class MailPart implements Serializable, Cloneable {
    ...
    /**
     * Creates a new instance of <code>ContentType</code> pre-initialized with default value:
     * <pre>"text/plain; charset=us-ascii"</pre>
     *
     * @return The new default content type
     */
    protected static ContentType newDefaultContentType() {
    ...
    public ContentType getContentType() {
        if (!b_contentType) {
            ...
            if (contentType == null) {
                // No "Content-Type" header or parsing failed
                contentType = newDefaultContentType();
            }
        }
        return contentType;
    }
    ...
    public ContentDisposition getContentDisposition() {
        if (!b_disposition) {
            ...
            if (contentDisposition == null) {
                // No "Content-Disposition" header or parsing failed
    ...
    public String getFileName() {
        ...
        String fn = contentDisposition == null ? null : contentDisposition.getFilenameParameter();
        if (fn == null) {
            fn = contentType == null ? null : contentType.getNameParameter();
        }
        return fn;
    }
