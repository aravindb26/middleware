...
public class SecuritySettings {
    ...
    public static final class Builder {
        ...
        public SecuritySettings build() {
            return new SecuritySettings(encrypt, decrypt, pgpInline, sign, authentication, guest_language, guest_message, pin, msgRef, type);
        }
    }
     ...
     */
    SecuritySettings(boolean encrypt, boolean decrypt, boolean pgpInline, boolean sign, String authentication, String guest_language, String guest_message, String pin, String msgRef, String type) {
        super();
        this.encrypt = encrypt;
        this.decrypt = decrypt;
        this.pgpInline = pgpInline;
    ...
    /**
     * Return the type of crypto used
     *
     * @return
     */
    ...
    public JSONObject getJSON() throws JSONException {
        ...
        settings.put("type", this.getType());
        return settings;
    }
