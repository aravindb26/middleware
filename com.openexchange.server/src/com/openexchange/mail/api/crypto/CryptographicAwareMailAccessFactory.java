...
public interface CryptographicAwareMailAccessFactory {
     ...
     * @throws OXException
     */
    MailAccess<IMailFolderStorage, IMailMessageStorage> createAccess(MailAccess<IMailFolderStorage, IMailMessageStorage> mailAccess, Session session, String authentication, CryptoType.PROTOCOL type) throws OXException;
     ...
     * @throws OXException
     */
    MailAccess<IMailFolderStorage, IMailMessageStorage> createAccess(MailAccess<IMailFolderStorage, IMailMessageStorage> mailAccess, Session session, CryptoType.PROTOCOL type) throws OXException;
