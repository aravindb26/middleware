...
public interface AuthenticationFailedHandler {
    ...
    public static enum Service {
        /**
         * The mail access service; e.g. IMAP.<br>
         * <b>The authentication failed against primary/secondary account.</b>
         */
        MAIL,
        /**
         * The mail transport service; e.g. SMTP<br>
         * <b>The authentication failed against primary/secondary account.</b>
         */
        TRANSPORT,
        /**
     ...
     */
    AuthenticationFailureHandlerResult handleAuthenticationFailed(OXException failedAuthentication, Service service, MailConfig mailConfig, Session session, Map<String, Object> state) throws OXException;
