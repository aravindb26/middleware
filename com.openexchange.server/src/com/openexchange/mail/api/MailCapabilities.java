...
public abstract class MailCapabilities {
    ...
    /**
     * Checks if mail server appears to be a Dovecot server.
     *
     * @return <code>true</code> if mail server appears to be a Dovecot server; otherwise <code>false</code>
     */
    ...
    /**
     * Indicates if mail system supports setting {@link MailMessage#getMailStructure()}.
     *
     * @return <code>true</code> if mail structure is supported; otherwise <code>false</code>
     */
    ...
    /**
     * Indicates if mail system supports group entities; e.g. when selecting entities to share a mail folder to.
     *
     * @return <code>true</code> if group entities are supported; otherwise <code>false</code>
     */
    ...
    /**
     * Indicates if mail system supports setting meta-data.
     *
     * @return <code>true</code> if meta-data is supported; otherwise <code>false</code>
     */
    ...
    /**
     * Indicates if mail system advises to resolve the login name - see {@link MailLoginResolverService}
     *
     * @return currently always <code>false</code> since no mail system supports this feature.
     */
