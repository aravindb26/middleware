...
import com.openexchange.groupware.settings.tree.modules.mail.MailFetchLimit;
...
import com.openexchange.mail.mime.ContentTypeSanitizerImpl;
...
public final class MailJSONActivator extends AJAXModuleActivator {
    ...
    protected Class<?>[] getOptionalServices() {
        return new Class<?>[] { MailCategoriesConfigService.class, CapabilityService.class, CryptographicServiceAuthenticationFactory.class, CryptographicAwareMailAccessFactory.class, EncryptedMailService.class, CryptoMailRecognizerService.class };
    }
    ...
    protected void startBundle() throws Exception {
        ...
        track(MailExportService.class);

        final BundleContext context = this.context;

        System.getProperties().put("mail.mime.contentTypeSanitizer", new ContentTypeSanitizerImpl());
        ...
        registerScope(RestrictedAction.Type.READ, MailActionFactory.MODULE, OAuthScopeDescription.OAUTH_READ_SCOPE, Permission.WEBMAIL);
        registerScope(RestrictedAction.Type.WRITE, MailActionFactory.MODULE, OAuthScopeDescription.OAUTH_WRITE_SCOPE, Permission.WEBMAIL);
        ...
        MailFetchLimit mailFetchLimit = new MailFetchLimit(); // --> Statically registered via ConfigTree class
        registerService(ConfigTreeEquivalent.class, mailFetchLimit);
    ...
    protected void stopBundle() throws Exception {
        super.stopBundle();
        EmailAddressParserWatcher.getInstance().shutDown();
