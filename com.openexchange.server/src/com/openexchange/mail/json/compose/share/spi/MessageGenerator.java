...
public interface MessageGenerator extends Applicable {
     ...
     * @param attachmentIdToContentIdMapping Maps file attachment identifiers to previews' content identifiers
     * @param moreFiles The number of files w/o the preview images
     * @return The generated messages
     * @throws OXException If messages cannot be generated
     */
    List<ComposedMailMessage> generateTransportMessagesFor(ShareComposeMessageInfo info, ShareReference shareReference, Map<String, String> attachmentIdToContentIdMapping, int moreFiles) throws OXException;
     ...
     */
    ComposedMailMessage generateSentMessageFor(ShareComposeMessageInfo info, ShareReference shareReference, Map<String, String> attachmentIdToContentIdMapping, int moreFiles) throws OXException;
