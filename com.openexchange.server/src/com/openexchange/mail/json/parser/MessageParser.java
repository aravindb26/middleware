...
public final class MessageParser {
                    ...
                    String sContent;
                    {
                        ...
                        String contentType;
                        {
                            ...
                            if (null == sContentType) {
                                sContentType = HTMLDetector.containsHTMLTags(sContent, true, HtmlServices.getGlobalEventHandlerIdentifiers()) ? "text/plain" : "text/html";
                            }
    ...
    private static void parseBasics(JSONObject jsonObj, MailMessage mail, TimeZone timeZone, boolean prepare4Transport) throws JSONException, AddressException, OXException {
         ...
         * Sender
         */
        mail.addSender(parseAddressKey(MailJSONField.SENDER.getKey(), jsonObj, prepare4Transport));
        /*
         * Optional Reply-To
         */
        {
