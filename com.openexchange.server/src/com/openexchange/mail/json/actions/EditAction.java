...
public final class EditAction extends AbstractMailAction {
    ...
    protected AJAXRequestResult perform(MailRequest req) throws OXException {
        ...
        try {
            ...
            {
                JSONObject jsonMailObj = JSONServices.parseObject(uploadEvent.getFormField(AJAXServlet.UPLOAD_FORMFIELD_MAIL));
                if (null == csid) {
                ...
                int accountId = resolveSender2Account(session, from, false, true);
                /*
                 ...
                 */
                ComposedMailMessage composedMail = MessageParser.parse4Draft(jsonMailObj, uploadEvent, session, Account.DEFAULT_ID, warnings);
            ...
            if (MailExceptionCode.MAIL_NOT_FOUND.equals(e) && "undefined".equalsIgnoreCase(uid)) {
                throw MailExceptionCode.PROCESSING_ERROR.create(e);
            }
            throw e;
