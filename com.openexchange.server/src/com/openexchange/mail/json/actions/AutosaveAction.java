    ...
    protected AJAXRequestResult perform(MailRequest req) throws OXException {
        try {
            ...
            final List<OXException> warnings = new ArrayList<OXException>();
            {
                 ...
                 */
                ComposedMailMessage composedMail = MessageParser.parse4Draft(jsonMailObj, (UploadEvent) null, session, Account.DEFAULT_ID, warnings);
                ...
                if (composedMail.containsFrom()) {
                    accountId = resolveSender2Account(session, composedMail.getFrom()[0], false, true);
                } else {
