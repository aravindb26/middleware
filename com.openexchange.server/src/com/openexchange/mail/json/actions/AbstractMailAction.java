...
public abstract class AbstractMailAction implements AJAXActionService, MailActionConstants {
     ...
     */
    protected static final Set<String> CACHABLE_FORMATS = Set.of("apiResponse", "json");
     ...
     */
    protected static int resolveSender2Account(ServerSession session, InternetAddress sendingAddress, boolean checkTransportSupport, boolean checkFrom) throws OXException {
        return MimeMessageFiller.resolveSender2Account(session, sendingAddress, checkTransportSupport, checkFrom);
    }
    ...
    protected boolean isIgnoreDeleted(MailRequest mailRequest, boolean defaultValue) {
