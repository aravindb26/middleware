...
public class MailAccountProperties extends AbstractMailAccountProperties implements IMailProperties {
    ...
    public int getReadTimeout() {
        return lookUpIntProperty("com.openexchange.mail.readTimeout", MailProperties.getInstance().getReadTimeout());
    }

    @Override
    public int getConnectTimeout() {
        return lookUpIntProperty("com.openexchange.mail.connectTimeout", MailProperties.getInstance().getConnectTimeout());
    }
