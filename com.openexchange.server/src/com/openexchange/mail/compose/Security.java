...
public class Security {
    ...
    public static class Builder {
        ...
        public Security build() {
            return new Security(encrypt, pgpInline, sign, language, message, pin, msgRef, authToken, type);
        }
    }
    ...
    public static final Security DISABLED = new Security(false, false, false, null, null, null, null, null, null);
     ...
     */
    Security(boolean encrypt, boolean pgpInline, boolean sign, String language, String message, String pin, String msgRef, String authToken, String type) {
        super();
        this.encrypt = encrypt;
        this.pgpInline = pgpInline;
        this.sign = sign;
