...
public class OpenCompositionSpaceParameters {
    ...
    public static class Builder {
        ...
        public Builder withDropExternalImages(boolean dropExternalImages) {
        ...
        public OpenCompositionSpaceParameters build() {
            ...
            return new OpenCompositionSpaceParameters(type, referencedMails, appendVCard, appendOriginalAttachments, priority, contentType, requestReadReceipt, sharedAttachmentsInfo, security, mailSettings, clientToken, dropExternalImages);
        }
    ...
    /**
     * Whether to drop external images from HTML content.
     *
     * @return <code>true</code> to drop external images from HTML content; otherwise <code>false</code>
     */
