...
public class FileNameTerm extends SearchTerm<String> {
    ...
    protected boolean applyCapabilities(CapabilitiesAndOptions capabilities, SearchTerm<?> parentTerm) {
        ...
        if (capabilities.getCapabilities().hasFileNameSearch()) {
            fileNameSearchSupported = true;
            return true;
        }
        return false;
    }
    ...
    public javax.mail.search.SearchTerm getJavaMailSearchTerm() {
        if (!fileNameSearchSupported) {
            return new javax.mail.search.FileNameTerm(this.pattern);
        }

        javax.mail.search.FileNameTerm fnt = new javax.mail.search.FileNameTerm(this.pattern);
        fnt.setFileNameSearchSupported(fileNameSearchSupported);
        return fnt;
    }
    ...
    public javax.mail.search.SearchTerm getNonWildcardJavaMailSearchTerm() {
        ...
        javax.mail.search.FileNameTerm fnt = new javax.mail.search.FileNameTerm(getNonWildcardPart(this.pattern));
        fnt.setFileNameSearchSupported(fileNameSearchSupported);
        return fnt;
    }
