...
public class MimeMailExceptionMessage implements LocalizableStrings {
    ...
    // Reading responses from remote mail server has been aborted because it took too long.
    public static final String READ_ABORTED_MSG_DISPLAY = "The operation couldn't be completed. Please try again later.";
    ...
    public static final String MESSAGE_REJECTED_MSG_DISPLAY = "Message has been rejected being sent";

    // Message was blocked by outgoing SMTP server; e.g. due to triggering a filter such as a URL in the message being found in a domain black list.
    public static final String MESSAGE_REJECTED_EXT_MSG_DISPLAY = "Message has been rejected being sent: (%1$s).";
    ...
    // A mail folder could not be created on a certain mail server
    public static final String FOLDER_CREATION_FAILED_MSG_DISPLAY = "Folder could not be created";

    // Issued search by client contains expressions that are not supported by target mail server
    public static final String UNSUPPORTED_SEARCH_TERM_MSG_DISPLAY = "The search cannot be executed since one or more search expressions are not supported";

    // An unexpected error occurred while trying to communication with remote server; e.g. connection abruptly aborted
    public static final String COMMUNICATION_PROBLEM_MSG_DISPLAY = "A problem occurred while communicating with remote server %1$s: %3$s";
