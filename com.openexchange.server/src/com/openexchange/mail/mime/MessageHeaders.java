...
public final class MessageHeaders {
    ...
    /** "X-OX-Reply-To" */
    public static final String HDR_X_OX_REPLY_TO = "X-OX-Reply-To";

    public static final HeaderName X_OX_REPLY_TO = HeaderName.valueOf(HDR_X_OX_REPLY_TO);

    /** "X-OX-Composition-Space-Look-Up" */
    public static final String HDR_X_OX_COMPOSITION_SPACE_LOOK_UP = "X-OX-Composition-Space-Look-Up";

    public static final HeaderName X_OX_COMPOSITION_SPACE_LOOK_UP = HeaderName.valueOf(HDR_X_OX_COMPOSITION_SPACE_LOOK_UP);
