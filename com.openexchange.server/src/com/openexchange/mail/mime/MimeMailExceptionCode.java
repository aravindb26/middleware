...
public enum MimeMailExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * Connection was refused or timed out while attempting to connect to remote mail server %1$s for user %2$s. Waited for %3$s msec.
     * <p>
     ...
     * </p>
     */
    CONNECT_ERROR("Connection was refused or timed out while attempting to connect to remote server %1$s for user %2$s. Waited for %3$s msec.", CATEGORY_SERVICE_DOWN, 1016, MimeMailExceptionMessage.CONNECT_ERROR_MSG_DISPLAY),
    /**
     ...
     * </p>
     */
    CONNECT_ERROR_SIMPLE("Connection was refused or timed out while attempting to connect to remote server %1$s for user %2$s.", CATEGORY_SERVICE_DOWN, 1016, MimeMailExceptionMessage.CONNECT_ERROR_MSG_DISPLAY),
    /**
    ...
    /**
     * Message has been rejected being sent
     */
    MESSAGE_REJECTED("Message has been rejected being sent", CATEGORY_USER_INPUT, 1012, MimeMailExceptionMessage.MESSAGE_REJECTED_MSG_DISPLAY),
    /**
     * Message has been rejected being sent: (%1$s) (<i>arbitrary server information</i>)
     */
    MESSAGE_REJECTED_EXT("Message has been rejected being sent: (%1$s)", CATEGORY_USER_INPUT, 1012, MimeMailExceptionMessage.MESSAGE_REJECTED_EXT_MSG_DISPLAY),
    /**
     * Folder %1$s could not be created on mail server %2$s for login %3$s
     */
    FOLDER_CREATION_FAILED("Folder %1$s could not be created on mail server %2$s for login %3$s", CATEGORY_ERROR, 1013, MimeMailExceptionMessage.FOLDER_CREATION_FAILED_MSG_DISPLAY),
    /**
     * An I/O error occurred: %1$s
     */
    SSL_ERROR("An SSL error occurred: %1$s.", CATEGORY_ERROR, 128),
    /**
     * I/O error "%1$s" occurred in communication with "%2$s" mail server for login %3$s (user=%4$s, context=%5$s).
     */
    SSL_ERROR_EXT("SSL error \"%1$s\" occurred in communication with \"%2$s\" mail server for login %3$s (user=%4$s, context=%5$s).", CATEGORY_ERROR, 128),
    /**
     * The search cannot be executed against mail server %1$s for login %2$s since one or more search expressions are not supported
     */
    UNSUPPORTED_SEARCH_TERM("The search cannot be executed against mail server %1$s for login %2$s since one or more search expressions are not supported", CATEGORY_USER_INPUT, 1041, MimeMailExceptionMessage.UNSUPPORTED_SEARCH_TERM_MSG_DISPLAY),
    /**
     * A problem occurred while communicating with remote server %1$s for login %2$s: %3$s
     */
    COMMUNICATION_PROBLEM("A problem occurred while communicating with remote server %1$s for login %2$s: %3$s", CATEGORY_ERROR, 1042, MimeMailExceptionMessage.COMMUNICATION_PROBLEM_MSG_DISPLAY),
    /**
     * Aborted reading responses from remote mail server %1$s for user %2$s.
     */
    READ_ABORTED("Aborted reading responses from remote mail server %1$s for user %2$s.", CATEGORY_SERVICE_DOWN, 1043, MimeMailExceptionMessage.READ_ABORTED_MSG_DISPLAY),
    ;
