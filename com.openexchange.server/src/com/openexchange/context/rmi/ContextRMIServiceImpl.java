 ...
 * @since v7.10.1
 */
public class ContextRMIServiceImpl extends AbstractAuthenticatorRMIService implements ContextRMIService {

    private static final Logger LOGGER = LoggerFactory.getLogger(ContextRMIServiceImpl.class);

    @Override
    public boolean checkLogin2ContextMapping(Credentials auth) throws RemoteException {
    ...
    @Override
    public boolean checkLogin2ContextMapping(int contextId, Credentials auth) throws RemoteException {
        Authenticator authenticator = ServerServiceRegistry.getInstance().getService(Authenticator.class);
     ...
     */
    private static int tryInsert(int contextId, Connection connection) throws SQLException {
     ...
     */
    private static void invalidateContext(int contextId, ContextStorage contextStorage) {
        try {
     ...
     */
    private static DatabaseService getDatabaseService() throws RemoteException {
