...
public interface ContextRMIService extends Remote {
     ...
     */
    boolean checkLogin2ContextMapping(Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException If check fails for any reason
     */
    boolean checkLogin2ContextMapping(int contextId, Credentials auth) throws RemoteException;
}
