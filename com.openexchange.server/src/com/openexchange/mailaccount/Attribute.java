...
public enum Attribute {
    ...
    // The flag marking a secondary account
    SECONDARY_ACCOUNT_LITERAL(MailAccountFields.SECONDARY_ACCOUNT, 1051),
    // The flag marking a deactivated account
    DEACTIVATED_LITERAL(MailAccountFields.DEACTIVATED, 1052),
    ;
    ...
    public Object doSwitch(final AttributeSwitch switcher) throws OXException {
        ...
        case SECONDARY_ACCOUNT_LITERAL:
            return switcher.secondaryAccount();
        case DEACTIVATED_LITERAL:
            return switcher.deactivated();
        default:
