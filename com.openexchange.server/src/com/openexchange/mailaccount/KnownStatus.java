...
public enum KnownStatus implements Status {
     ...
     */
    DEACTIVATED("deactivated", KnownStatusMessage.MESSAGE_DEACTIVATED),
    /**
     * There was a communication problem while trying to connect
     */
    COMMUNICATION_PROBLEM("communication_problem", KnownStatusMessage.MESSAGE_COMMUNICATION_PROBLEM),
