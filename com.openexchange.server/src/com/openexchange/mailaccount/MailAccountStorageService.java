...
public interface MailAccountStorageService {
     ...
     */
    boolean isSecondaryMailAccount(int id, int userId, int contextId) throws OXException;
     ...
     * @throws OXException If check fails
     */
    boolean isDeactivatedMailAccount(int id, int userId, int contextId) throws OXException;
    ...
    /**
     * Gets the default and secondary mail accounts belonging to specified user in given context.
     *
     * @param userId The user identifier
     * @param contextId The context identifier
     * @return The user's mail accounts
     * @throws OXException If the mail accounts cannot be returned
     */
    MailAccount[] getUserDefaultAndSecondaryMailAccounts(int userId, int contextId) throws OXException;
     ...
     * @throws OXException If the mail accounts cannot be returned
     */
    MailAccount[] getUserDefaultAndSecondaryMailAccounts(int userId, int contextId, Connection con) throws OXException;
     ...
     * @param userId The user identifier
     * @param contextId The context identifier
     * @param deletePrimaryOrSecondary <code>true</code> to delete also the primary/secondary mail account; otherwise <code>false</code> to deny deletion
     * @return <code>true</code> if the account was successfully deleted; <code>false</code> otherwise
     * @throws OXException If the mail account cannot be deleted
     */
    boolean deleteMailAccount(int id, Map<String, Object> properties, int userId, int contextId, boolean deletePrimaryOrSecondary) throws OXException;
     ...
     * @throws OXException If the mail account cannot be deleted
     */
    boolean deleteMailAccount(int id, Map<String, Object> properties, int userId, int contextId, boolean deletePrimaryOrSecondary, Connection con) throws OXException;
