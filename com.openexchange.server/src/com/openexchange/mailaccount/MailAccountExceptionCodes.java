...
public enum MailAccountExceptionCodes implements DisplayableOXExceptionCode {
    ...
    /**
     * The flag marking a mail account as a secondary account must not be changed.
     */
    NO_SECONDARY_CHANGE("The flag marking a mail account as a secondary account must not be changed.", CATEGORY_PERMISSION_DENIED, 27, MailAccountExceptionStrings.NO_SECONDARY_CHANGE_MSG_DISPLAY),

    /**
     * <li>The mail transport from external accounts is disabled.</li>
     * <li>The mail transport from external accounts is disabled for user '%1$s' in context '%2$s'</li>
     */
    EXTERNAL_ACCOUNTS_DISABLED("The mail transport from external accounts is disabled for user '%1$s' in context '%2$s'", Category.CATEGORY_USER_INPUT, 28, MailAccountExceptionStrings.EXTERNAL_ACCOUNTS_DISABLED_MSG_DISPLAY),
