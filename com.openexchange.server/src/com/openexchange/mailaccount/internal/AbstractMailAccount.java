...
public abstract class AbstractMailAccount implements MailAccount {
    ...
    protected boolean secondaryAccount;
     ...
     *
     * @param archive The default archive folder's name
     */
     ...
     *
     * @param sent The default sent folder's name
     */
     ...
     *
     * @param drafts The default drafts folder's name
     */
     ...
     *
     * @param spam The default spam folder's name
     */
     ...
     *
     * @param confirmedSpam The default confirmed-spam folder's name
     */
     ...
     *
     * @param confirmedHam The default confirmed-ham folder's name
     */
     ...
     *
     * @param transportPassword The optional transport password
     */
