...
final class SanitizingStorageService implements MailAccountStorageService {
    ...
    public boolean isSecondaryMailAccount(int id, int userId, int contextId) throws OXException {
        return storageService.isSecondaryMailAccount(id, userId, contextId);
    }

    @Override
    public boolean isDeactivatedMailAccount(int id, int userId, int contextId) throws OXException {
        return storageService.isDeactivatedMailAccount(id, userId, contextId);
    }
    ...
    @Override
    public MailAccount[] getUserDefaultAndSecondaryMailAccounts(int user, int cid) throws OXException {
        try {
            return storageService.getUserDefaultAndSecondaryMailAccounts(user, cid);
        } catch (OXException e) {
            if (!isURIError(e)) {
                throw e;
            }
    ...
    @Override
    public MailAccount[] getUserDefaultAndSecondaryMailAccounts(int user, int cid, Connection con) throws OXException {
        try {
            return storageService.getUserDefaultAndSecondaryMailAccounts(user, cid, con);
        } catch (OXException e) {
            if (!isURIError(e)) {
                throw e;
            }
    ...
    @Override
    public boolean deleteMailAccount(final int id, final Map<String, Object> properties, final int user, final int cid, final boolean deletePrimaryOrSecondary) throws OXException {
        return storageService.deleteMailAccount(id, properties, user, cid, deletePrimaryOrSecondary);
    }

    @Override
    public boolean deleteMailAccount(final int id, final Map<String, Object> properties, final int user, final int cid, final boolean deletePrimaryOrSecondary, final Connection con) throws OXException {
        return storageService.deleteMailAccount(id, properties, user, cid, deletePrimaryOrSecondary, con);
    }
