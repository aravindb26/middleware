...
public final class MailAccountExceptionStrings implements LocalizableStrings {
    ...
    // The flag marking a mail account as a secondary account must not be changed since only an administrator is allowed to do that
    public static final String NO_SECONDARY_CHANGE_MSG_DISPLAY = "The flag marking a mail account as a secondary account must not be changed.";

    // The external mail transport accounts are disabled
    public static final String EXTERNAL_ACCOUNTS_DISABLED_MSG_DISPLAY = "The mail transport from external accounts is disabled.";
