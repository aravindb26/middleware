...
/**
 * {@link AllowExternalSMTPJSlobEntry} exposes the com.openexchange.smtp.allowExternal property via jslob
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public class AllowExternalSMTPJSlobEntry implements JSlobEntry {

    @Override
    public JSlobKey getKey() {
        return JSlobKey.MAIL;
    }

    @Override
    public String getPath() {
        return "features/allowExternalSMTP";
    }
    ...
    public Object getValue(Session session) throws OXException {
        ...
        return B(configService.getBooleanProperty(session.getUserId(), session.getContextId(), MailProperty.SMTP_ALLOW_EXTERNAL));
    }
