...
public class SetSwitch implements AttributeSwitch {
    ...
    /**
     * Sets the value that is supposed to be applied to account description.
     *
    ...
    public Object mailPort() {
        try {
            desc.setMailPort(value == null ? 143 : Integer.parseInt(value.toString()));
    ...
    public Object transportPort() {
        try {
            desc.setTransportPort(value == null ? 25 : Integer.parseInt(value.toString()));
        } catch (NumberFormatException e) {
