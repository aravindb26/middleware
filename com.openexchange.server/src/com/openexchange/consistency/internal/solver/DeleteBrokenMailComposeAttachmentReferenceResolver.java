...
public class DeleteBrokenMailComposeAttachmentReferenceResolver implements ProblemSolver {
    ...
    private static String removeAttachment(String attachments, UUID toRemove) {
        try {
            JSONArray json = JSONServices.parseArray(attachments);
     ...
     */
    private static String obfuscate(String s) throws OXException {
