...
public interface ConsistencyRMIService extends Remote {
     ...
     */
    List<String> checkOrRepairConfigDB(boolean repair, Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException if an error is occurred
     */
    void repairFilesInContext(int contextId, String repairPolicy, String repairAction, Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException if an error is occurred
     */
    void repairFilesInFilestore(int filestoreId, String repairPolicy, String repairAction, Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException if an error is occurred
     */
    void repairFilesInDatabase(int databaseId, String repairPolicy, String repairAction, Credentials auth) throws RemoteException;
     ...
     * @throws RemoteException if an error is occurred
     */
    void repairAllFiles(String repairPolicy, String repairAction, Credentials auth) throws RemoteException;
}
