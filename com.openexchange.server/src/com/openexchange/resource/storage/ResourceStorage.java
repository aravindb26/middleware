...
public interface ResourceStorage {
    ...
    /**
     * The name for the cache region holding resource information.
     */
    public static final String CACHE_REGION_NAME = "Resource";
     ...
     * @throws OXException If the resource can't be found or an exception appears while reading it.
     */
    Resource getResource(int resourceId, Context context, Connection connection) throws OXException;
    ...
    /**
     * Gets the resource with the given identifier or null
     *
     ...
     * @throws OXException If an exception occurs while reading from the underlying persistent storage.
     */
    public abstract Resource getByIdentifier(String identifier, Context context) throws OXException;

    /**
     * Gets the resource with the given mail address or null
     *
     ...
     * @throws OXException If an exception occurs while reading from the underlying persistent storage.
     */
    public abstract Resource getByMail(String mail, Context context) throws OXException;
    ...
    /**
     * Searches all resources where the passed entities have a certain scheduling privilege for.
     *
     * @param entities The entities that should have the privilege
     * @param privilege The scheduling privilege to match
     * @param context The context
     * @return An array of {@link Resource resources} having the scheduling privilege for one of the entities
     * @throws OXException If searching for resources fails
     */
    public abstract Resource[] searchResourcesByPrivilege(int[] entities, SchedulingPrivilege privilege, Context context) throws OXException;
