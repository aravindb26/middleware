...
public enum ResourceExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * No booking delegate defined.
     */
    NO_BOOKING_DELEGATE("No booking delegate defined.", Category.CATEGORY_USER_INPUT, 14, ResourceExceptionMessage.NO_BOOKING_DELEGATE_MSG),
    /**
     * Invalid scheduling privileges: %1$s
     */
    INVALID_SCHEDULING_PRIVILEGES("Invalid scheduling privileges: %1$s", Category.CATEGORY_USER_INPUT, 15, ResourceExceptionMessage.INVALID_SCHEDULING_PRIVILEGES_MSG),
    /**
     * No privileges for guests: %1$d
     */
    NO_GUEST_PRIVILEGES("No privileges for guests: %1$d", Category.CATEGORY_USER_INPUT, 16, ResourceExceptionMessage.NO_GUEST_PRIVILEGES_MSG),
