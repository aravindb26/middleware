...
public class ResourceExceptionMessage implements LocalizableStrings {
    ...
    // At least one booking delegate must be defined to receive booking requests.
    public static final String NO_BOOKING_DELEGATE_MSG = "At least one booking delegate must be defined to manage booking requests.";

    // The scheduling privileges are invalid and cannot be assigned. 
    public static final String INVALID_SCHEDULING_PRIVILEGES_MSG = "The scheduling privileges are invalid and cannot be assigned.";

    // Scheduling privileges can't be configured for guest users.
    public static final String NO_GUEST_PRIVILEGES_MSG = "Scheduling privileges can't be configured for guest users.";
