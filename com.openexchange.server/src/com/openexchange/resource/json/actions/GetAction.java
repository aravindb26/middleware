...
import com.openexchange.resource.internal.ResourceExceptionCode;
...
public final class GetAction extends AbstractResourceAction {
    ...
    protected AJAXRequestResult perform(final ResourceAJAXRequest req) throws OXException, JSONException {
        ...
        if (r == null) {
            if (UserStorage.getInstance().exists(id, session.getContextId()) == false) {
                throw ResourceExceptionCode.RESOURCE_NOT_FOUND.create(I(id));
            }
