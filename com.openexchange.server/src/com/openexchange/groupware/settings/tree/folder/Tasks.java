...
public final class Tasks implements PreferencesItemService {
    ...
    private static class LoggerHolder {
        static final Logger LOG = org.slf4j.LoggerFactory.getLogger(Tasks.class);
    }
        ...
        return new ReadOnlyValue() {
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                try {
                    ...
                    LoggerHolder.LOG.error("Task default folder could not be applied to user configuration.", any);
                    throw any;
                }
            }
        };
