...
public class InfostoreActivator implements BundleActivator {
    ...
    public synchronized void start(final BundleContext context) throws Exception {
        try {
            ...
            ServiceTracker<Authenticator, Authenticator> authenticatorTracker = new ServiceTracker<Authenticator, Authenticator>(context, Authenticator.class, null) {
                ...
                public Authenticator addingService(ServiceReference<Authenticator> reference) {
                    ...
                    authenticatorReference.set(service);
                    return service;
                }
            ...
            this.authenticatorTracker = authenticatorTracker;
            ...
            context.registerService(Remote.class, new FileChecksumsRMIServiceImpl(authenticatorReference), serviceProperties);
    ...
    public synchronized void stop(final BundleContext context) throws Exception {
        try {
            ...
            ServiceTracker<Authenticator, Authenticator> authenticatorTracker = this.authenticatorTracker;
