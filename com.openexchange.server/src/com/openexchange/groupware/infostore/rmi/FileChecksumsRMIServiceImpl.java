 ...
 * @since v7.10.1
 */
public class FileChecksumsRMIServiceImpl extends AbstractAuthenticatorRMIService implements FileChecksumsRMIService {

    private final AtomicReference<Authenticator> authenticatorReference;

    public FileChecksumsRMIServiceImpl(AtomicReference<Authenticator> authenticatorReference) {
        super();
    ...
    @Override
    public List<String> calculateMissingChecksumsInContext(int contextId, Credentials auth) throws RemoteException {
    ...
    @Override
    public List<String> calculateMissingChecksumsInDatabase(int databaseId, Credentials auth) throws RemoteException {
        Authenticator authenticator = authenticatorReference.get();
    ...
    @Override
    public List<String> calculateAllMissingChecksums(Credentials auth) throws RemoteException {
        Authenticator authenticator = authenticatorReference.get();
        authenticate(authenticator, auth);
