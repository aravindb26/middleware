...
public class CheckSizeSwitch {
    ...
    private static final Map<Metadata, Integer> SIZES = new HashMap<Metadata, Integer>();
    private final DBProvider provider;
    private final Context ctx;

    private static final Set<Metadata> FIELDS_TO_CHECK = Set.of(
    ...
    public int getSize(final Metadata field) {
        ...
        try {
            ...
            final String[] tuple = InfostoreQueryCatalog.getInstance(ctx.getContextId()).getFieldTuple(field, new InfostoreQueryCatalog.VersionWins());
