...
public class ReminderActivator extends AJAXModuleActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerScope(RestrictedAction.Type.READ, ReminderActionFactory.MODULE, OAuthScopeDescription.READ_ONLY, Permission.TASKS, Permission.CALENDAR);
        registerScope(RestrictedAction.Type.WRITE, ReminderActionFactory.MODULE, OAuthScopeDescription.WRITABLE, Permission.TASKS, Permission.CALENDAR);
    }
