 ...
 */
public interface ExtendedUpdateTaskService extends UpdateTaskRMIService {
     ...
     */
    List<TaskFailure> runUpdateFor(int contextId) throws RemoteException;
     ...
     */
    List<TaskFailure> runUpdateFor(String schemaName) throws RemoteException;
}
