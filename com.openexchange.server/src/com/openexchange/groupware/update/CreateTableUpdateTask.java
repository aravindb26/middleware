 ...
 */
public abstract class CreateTableUpdateTask implements UpdateTaskV2 {
     ...
     */
    @Deprecated
    protected CreateTableUpdateTask(CreateTableService create, String[] dependencies, int version, DatabaseService databaseService) {
     ...
     */
    @Deprecated
    protected CreateTableUpdateTask(CreateTableService create, String[] dependencies, DatabaseService databaseService) {
     ...
     */
    protected CreateTableUpdateTask(CreateTableService create, String[] dependencies) {
        super();
        this.create = create;
        this.dependencies = null == dependencies ? Strings.getEmptyStrings() : dependencies;
    }
