...
public class IDCreateTableTask extends UpdateTaskAdapter {
     ...
     */
    private static boolean tableExists(final String tableName, final Connection con) throws SQLException {
        ResultSet resultSet = null;
        try {
            resultSet = con.getMetaData().getTables(con.getCatalog(), null, tableName, types);
