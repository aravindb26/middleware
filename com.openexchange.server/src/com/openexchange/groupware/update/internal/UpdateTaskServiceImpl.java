...
public class UpdateTaskServiceImpl extends AbstractAuthenticatorRMIService implements UpdateTaskRMIService {
     ...
     * @param serviceLookup
     */
    public UpdateTaskServiceImpl(ServiceLookup serviceLookup) {
        super();
    ...
    @Override
    public List<Map<String, Object>> runUpdate(int contextId, Credentials auth) throws RemoteException {
    ...
    @Override
    public List<Map<String, Object>> runUpdate(String schemaName, Credentials auth) throws RemoteException {
        Authenticator authenticator = serviceLookup.getOptionalService(Authenticator.class);
        authenticate(authenticator, auth);
    ...
    @Override
    public TaskStatus runAllUpdates(boolean throwExceptionOnFailure, Credentials auth) throws RemoteException {
        Authenticator authenticator = serviceLookup.getOptionalService(Authenticator.class);
        authenticate(authenticator, auth);
    ...
    @Override
    public void forceUpdateTask(int contextId, String taskName, Credentials auth) throws RemoteException {
        Authenticator authenticator = serviceLookup.getOptionalService(Authenticator.class);
        authenticate(authenticator, auth);
    ...
    @Override
    public void forceUpdateTask(String schemaName, String taskName, Credentials auth) throws RemoteException {
        Authenticator authenticator = serviceLookup.getOptionalService(Authenticator.class);
        authenticate(authenticator, auth);
    ...
    @Override
    public void forceUpdateTaskOnAllSchemata(String taskName, Credentials auth) throws RemoteException {
        Authenticator authenticator = serviceLookup.getOptionalService(Authenticator.class);
        authenticate(authenticator, auth);
