...
public class ExtendedUpdateTaskServiceImpl extends UpdateTaskServiceImpl implements ExtendedUpdateTaskService {
     ...
     */
    public ExtendedUpdateTaskServiceImpl(ServiceLookup serviceLookup) {
        super(serviceLookup);
    }

    @Override
    public List<TaskFailure> runUpdateFor(int contextId) throws RemoteException {
        try {
    ...
    @Override
    public List<TaskFailure> runUpdateFor(String schemaName) throws RemoteException {
        try {
