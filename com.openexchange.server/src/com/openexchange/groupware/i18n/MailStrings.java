...
public class MailStrings implements LocalizableStrings {
    ...
    // The internationalized name for the confirmed-ham mail folder
    public static final String CONFIRMED_HAM = "Confirmed ham"
        .intern();

    // The alternative internationalized name for the confirmed-ham mail folder
