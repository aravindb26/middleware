...
public final class AjaxExceptionMessages implements LocalizableStrings {
    ...
    public static final String BAD_REQUEST_MSG = "Bad request. The server is unable to handle the request.";
    public static final String BAD_REQUEST_CUSTOM_MSG = "Bad request. Message from server: %1$s";
    public static final String DEPRECATED_ACTION = "The requested action '%1$s' in module '%2$s' is deprecated, disabled and about to be removed.";
    public static final String REQUEST_ABORTED = "The request has been aborted by application. Please try again.";
