...
public final class URITools {
    ...
    private static final Set<Integer> REDIRECT_RESPONSE_CODES = Set.of(I(HttpURLConnection.HTTP_MOVED_PERM), I(HttpURLConnection.HTTP_MOVED_TEMP), I(HttpURLConnection.HTTP_SEE_OTHER), I(HttpURLConnection.HTTP_USE_PROXY));
