...
public class OXFolderExceptionMessage implements LocalizableStrings {
    ...
    // User attempts to change a folder permission that is associated with a deputy
    public static final String NO_DEPUTY_PERMISSION_CHANGE = "A deputy permission must not be changed";

    // User attempts to remove a folder permission that is associated with a deputy
    public static final String NO_DEPUTY_PERMISSION_DELETE = "A deputy permission must not be removed";

    /** Administrative access required for the subfolder \"%2$s\". */
    public final static String NO_ADMIN_ACCESS_IN_SUBFOLDER_MSG = "Administrative access required for the subfolder \"%2$s\".";
    
    /** Administrative access required for a hidden subfolder. */
    public final static String NO_ADMIN_ACCESS_IN_HIDDEN_MSG = "Administrative access required for a hidden subfolder.";
