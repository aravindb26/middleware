...
public enum OXFolderExceptionCode implements DisplayableOXExceptionCode  {
    ...
    /**
     * The deputy permission for entity %1$s must not be changed for folder %2$s in context %3$s
     */
    NO_DEPUTY_PERMISSION_CHANGE("The deputy permission for entity %1$s must not be changed for folder %2$s in context %3$s", OXFolderExceptionMessage.NO_DEPUTY_PERMISSION_CHANGE, Category.CATEGORY_USER_INPUT, 97),
    /**
     * The deputy permission for entity %1$s must not be removed for folder %2$s in context %3$s
     */
    NO_DEPUTY_PERMISSION_DELETE("The deputy permission for entity %1$s must not be removed for folder %2$s in context %3$s", OXFolderExceptionMessage.NO_DEPUTY_PERMISSION_DELETE, Category.CATEGORY_USER_INPUT, 98),

    /**
     * User %1$s has no admin access to the folder %2$s in context %3$s
     * <p>
     * {@value OXFolderExceptionMessage#NO_ADMIN_ACCESS_IN_SUBFOLDER_MSG}
     */
    NO_ADMIN_ACCESS_IN_SUBFOLDER("User %1$d has no admin access to folder %2$s in context %3$d", OXFolderExceptionMessage.NO_ADMIN_ACCESS_IN_SUBFOLDER_MSG, Category.CATEGORY_PERMISSION_DENIED, 99, Generic.NO_PERMISSION),

    /**
     * User %1$s has no admin access to the folder %2$s in context %3$s
     * <p>
     * {@value OXFolderExceptionMessage#NO_ADMIN_ACCESS_IN_HIDDEN_MSG}
     */
    NO_ADMIN_ACCESS_IN_HIDDEN("User %1$d has no admin access to folder %2$s in context %3$d", OXFolderExceptionMessage.NO_ADMIN_ACCESS_IN_HIDDEN_MSG, Category.CATEGORY_PERMISSION_DENIED, 100, Generic.NO_PERMISSION),
