...
public class PrefixBasedDAVServletPathProvider implements DAVServletPathProvider {
     ...
     * 
     * @param pathPrefix The static path prefix to match
     */
    public PrefixBasedDAVServletPathProvider(String pathPrefix) {
        super();
    ...
    public boolean servesPath(String path) {
        return null != path && path.startsWith(pathPrefix);
    }

    @Override
    public String toString() {
        return "PrefixBasedDAVServletPathProvider [pathPrefix=" + pathPrefix + "]";
    }
