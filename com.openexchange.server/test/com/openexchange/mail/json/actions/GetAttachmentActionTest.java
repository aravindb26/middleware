...
@SuppressStaticInitializationFor("com.openexchange.mail.compose.HeaderUtility")
@PrepareForTest({ GetAttachmentAction.class, AbstractMailAction.class, MailRequest.class, MailProperties.class, MessageUtility.class, HeaderUtility.class })
public class GetAttachmentActionTest {
    ...
    public void setUp() throws Exception {
        ...
        PowerMockito.mockStatic(HeaderUtility.class);
        ...
        PowerMockito.when(HeaderUtility.decodeHeaderValue(ArgumentMatchers.anyString())).thenReturn(null);
    ...
    public void testReturnedContentTypeAndModifiedParameters() throws Exception {
        ...
        assertTrue("Wrong class", (object instanceof IFileHolder));
