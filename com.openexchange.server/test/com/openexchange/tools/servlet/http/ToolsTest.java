...
public class ToolsTest {
    ...
    private static final String QUERY_STRING_WITHOUT_PASSWORD = "action=autologin&client=open-xchange-appsuite&version=7.8.0-0";

    private static final String QUERY_STRING_WITH_PASSWORD = "action=autologin&client=open-xchange-appsuite&version=7.8.0-0&password=effzeh";
