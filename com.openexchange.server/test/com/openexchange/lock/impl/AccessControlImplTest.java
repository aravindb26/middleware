...
public class AccessControlImplTest {
    ...
    public void tryWithTimeoutMulti2_Success() throws OXException, InterruptedException {
        ...
        // start other
        Thread other1 = new Thread(new LockHolder(accessControl, TimeUnit.MILLISECONDS.toNanos(200), latch));
        other1.start();

        Thread other2 = new Thread(new LockHolder(accessControl, TimeUnit.MILLISECONDS.toNanos(50), latch));
        other2.start();
