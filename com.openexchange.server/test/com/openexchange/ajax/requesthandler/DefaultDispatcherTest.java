...
public class DefaultDispatcherTest {
    ...
    public void testDispatchesToActionService() throws OXException {
        ...
        final AJAXRequestData requestData = getDefaultAjaxRequestData();
        final AJAXRequestResult receivedResult = dispatcher.perform(requestData, null, new SimServerSession(1, 1));

        assertSame(res, receivedResult);
    }

    private AJAXRequestData getDefaultAjaxRequestData() {
    ...
    public void testLaterIncoming() throws OXException {
        ...
        dispatcher.perform(requestData, null, new SimServerSession(1, 1));
