...
public class ApnPushNotificationTransportActivator extends HousekeepingActivator {
    ...
    protected synchronized void startBundle() throws Exception {
        registerService(PushNotificationTransport.class, new ApnPushNotificationTransport(getServiceSafe(PushSubscriptionRegistry.class), // @formatter:off
        ...
        registerService(ForcedReloadable.class, (configservice) -> ApnPushNotificationTransport.invalidateEnabledCache());
    }
