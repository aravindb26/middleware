...
public enum PushExceptionCodes implements DisplayableOXExceptionCode {
    ...
    /**
     * No such generator for client %1$s and transport %2$s
     */
    NO_SUCH_GENERATOR("No such generator for client %1$s and transport %2$s", null, Category.CATEGORY_ERROR, 8),
    /**
    ...
    /**
     * Push subscription denied: %1$s
     */
    PUSH_SUBSCRIPTION_DENIED("Push subscription denied: %1$s", null, Category.CATEGORY_PERMISSION_DENIED, 12),
    /**
     * Max. number of push subscriptions exceeded for transport %1$s and client %2$s
     */
    PUSH_SUBSCRIPTION_MAX_NUMBER_EXCEEDED("Max. number of push subscriptions exceeded for transport %1$s and client %2$s", null, Category.CATEGORY_PERMISSION_DENIED, 13)
