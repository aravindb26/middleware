 ...
 * @since v7.8.3
 */
public interface PushNotification extends Comparable<PushNotification> {

    @Override
    default int compareTo(PushNotification o) {
        int c = Integer.compare(getContextId(), o.getContextId());
        if (c == 0) {
            c = Integer.compare(getUserId(), o.getUserId());
        }
        if (c == 0) {
            c = getTopic().compareTo(o.getTopic());
        }
        return c;
    }
