...
public interface PushSubscriptionListener {
     ...
     * @param restrictions The restrictions to set (if any)
     ...
     */
    boolean addingSubscription(PushSubscriptionDescription subscription, PushSubscriptionRestrictions restrictions) throws OXException;
    ...
    /**
     * Invoked when a subscription is about to be removed from registry.
     *
     * @param subscription The subscription to remove
     * @param restrictions The restrictions to set (if any)
     * @throws OXException If handling fails
     */
    void removingSubscription(PushSubscriptionDescription subscription, PushSubscriptionRestrictions restrictions) throws OXException;
