...
public class DefaultPushSubscription implements PushSubscription {
    ...
    /**
     * Gets the appropriate {@link DefaultPushSubscription} instance from specified description.
     *
     * @param desc The description
     * @return The appropriate {@link DefaultPushSubscription} instance
     */
    public static DefaultPushSubscription instanceFor(PushSubscriptionDescription desc) {
        Builder builder = new Builder()
            .contextId(desc.getContextId())
            .token(desc.getToken())
            .transportId(desc.getTransportId())
            .userId(desc.getUserId())
            .client(desc.getClient())
            .topics(desc.getTopics())
            .expires(desc.getExpires());

        return builder.build();
    }

    /**
     * Gets the appropriate {@link DefaultPushSubscription} instance from specified match.
     *
