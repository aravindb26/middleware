...
public interface PushMessageGenerator {
    ...
    /**
     * The special message generator identifier for generic JSON-style messages in Socket.IO format.
     */
    public static final String ID_GENERIC_SOCKET_IO = "generic";
    ...
    /**
     * Checks if this message generator is suitable for specified client and transport.
     *
     * @param client The client identifier
     * @param transportId The identifier of the transport, with which the message is supposed to be published
     * @return <code>true</code> if served; otherwise <code>false</code>
     */
    boolean servesClient(String client, String transportId);
