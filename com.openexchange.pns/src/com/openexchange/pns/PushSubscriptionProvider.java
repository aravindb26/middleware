...
public interface PushSubscriptionProvider {
    ...
    /**
     * Gets all subscriptions of given client interested in specified topic belonging to certain users.
     *
     ...
     */
    Hits getInterestedSubscriptions(String clientId, int[] userIds, int contextId, String topic) throws OXException;
     ...
     * @throws OXException If interested subscriptions cannot be checked
     */
    boolean hasInterestedSubscriptions(String clientId, int userId, int contextId, String topic) throws OXException;
