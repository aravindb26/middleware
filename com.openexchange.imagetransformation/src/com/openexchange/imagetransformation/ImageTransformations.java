...
public interface ImageTransformations {
     ...
     * @see ImageTransformationConfig#getMaxWidth()
     * @see ImageTransformationConfig#getMaxHeight()
     */
    ...
    /**
     * The same as {@link #getTransformedImage(String)} but only applies the transformation if necessary.
     *
     * @return The optional resulting transformed image
     */
    Optional<BasicTransformedImage> optTransformedImage(String formatName) throws IOException;
    ...
    /**
     * The same as {@link #getFullTransformedImage(String)} but only applies the transformation if necessary.
     *
     * @return The optional resulting transformed image
     */
    Optional<TransformedImage> optFullTransformedImage(String formatName) throws IOException;
