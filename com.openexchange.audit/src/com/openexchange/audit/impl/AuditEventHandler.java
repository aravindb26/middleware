...
import com.openexchange.audit.AuditEventProperty;
 ...
 * @author <a href="mailto:jan.bauerdick@open-xchange.com">Jan Bauerdick</a> - Refactoring, use default (JSON) log appender
 */
public class AuditEventHandler implements EventHandler, Reloadable {

    /** The logger to use */
    private final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(AuditEventHandler.class);
    ...
    private boolean fileAccessLogging;
     ...
     */
    public AuditEventHandler(UserService userService, boolean enabled, boolean fileAccessLogging) {
        super();
        this.userService = userService;
        this.enabled = enabled;
        this.fileAccessLogging = fileAccessLogging;
     ...
     * @throws OXException
     */
    protected void handleInfostoreEvent(Event event, StringBuilder logBuilder) {
    ...
    public Interests getInterests() {
        ...
        return DefaultInterests.builder().propertiesOfInterest(
            AuditEventProperty.enabled.getFQPropertyName(),
            AuditEventProperty.fileAccessLogging.getFQPropertyName()
        ).build();
        //@formatter:on
    }
    ...
    public void reloadConfiguration(ConfigurationService configService) {
        ...
        if (null != leanConfigService) {
            this.enabled  = leanConfigService.getBooleanProperty(AuditEventProperty.enabled);
            this.fileAccessLogging = leanConfigService.getBooleanProperty(AuditEventProperty.fileAccessLogging);
        }
    }
}
