...
@PrepareForTest({ Event.class, UserStorage.class, ContextStorage.class })
public class AuditEventHandlerTest {
    ...
    @Test
    public void testHandleEvent_InfoLoggingEnabledButWrongEvent_NothingToWrite() {
        this.auditEventHandler = new AuditEventHandler(userService, true, true);
    ...
    @Test
    public void testHandleEvent_IsInfoStoreEventButLogEmpty_NotLogged() {
        this.auditEventHandler = new AuditEventHandler(userService, true, true) {
    ...
    @Test
    public void testHandleEvent_IsGroupwareEventButLogEmpty_NotLogged() {
        this.auditEventHandler = new AuditEventHandler(userService, true, true) {
    ...
    @Test
    public void testHandleEvent_IsInfoStoreEventAndLogNotEmpty_Logged() {
        this.auditEventHandler = new AuditEventHandler(userService, true, true) {
    ...
    @Test
    public void testHandleEvent_IsGroupwareEventAndLogNotEmpty_Logged() {
        this.auditEventHandler = new AuditEventHandler(userService, true, true) {
