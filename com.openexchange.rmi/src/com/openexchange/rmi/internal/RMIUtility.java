...
public class RMIUtility {
    ...
    /**
     * Looks up the optional port to associate with the remote reference
     *
     * @param reference The service reference for the remote reference
     * @param r The remote reference
     * @return The port to associate with the remote reference
     */
    public static Optional<Integer> findRMIPort(ServiceReference<Remote> reference, Remote r) {
        Object port = reference.getProperty("RMIPort");
        if (port != null) {
            return Optional.ofNullable((Integer) port);
        }
