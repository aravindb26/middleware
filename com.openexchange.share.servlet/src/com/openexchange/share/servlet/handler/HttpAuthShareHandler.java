...
public abstract class HttpAuthShareHandler extends AbstractShareHandler {
    ...
    protected static boolean indicatesDownload(HttpServletRequest request) {
        return ("download".equalsIgnoreCase(sanitizeParam(request.getParameter("delivery"))) || isTrue(sanitizeParam(request.getParameter("dl")))) && 
            false == "inline".equalsIgnoreCase(sanitizeParam(request.getParameter("content_disposition")));
    }
