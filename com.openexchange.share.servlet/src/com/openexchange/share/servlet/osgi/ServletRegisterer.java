...
import com.openexchange.share.servlet.internal.request.analyzer.SharingRequestAnalyzer;
...
public final class ServletRegisterer implements ServiceTrackerCustomizer<Object, Object>, Reloadable {
    ...
    private ServiceRegistration<RequestAnalyzer> analyzerRegistration;
    ...
    public synchronized Object addingService(final ServiceReference<Object> reference) {
        ...
        if (service instanceof HttpService hsService) {
            this.httpService = hsService;
        }

        if (service instanceof DispatcherPrefixService prefixService) {
            this.prefixService = prefixService;
        }

        boolean needsRegistration = null != httpService && null != prefixService && null == alias;
        if (needsRegistration) {
            alias = prefixService.getPrefix() + ShareServlet.ALIAS_APPENDIX;
    ...
    private boolean registerServlet(String alias, HttpService httpService) {
        try {
            ...
            SharingRequestAnalyzer analyzer = new SharingRequestAnalyzer(alias, () -> services.getServiceSafe(DatabaseService.class));
            analyzerRegistration = context.registerService(RequestAnalyzer.class, analyzer, null);
    ...
    private void unregisterServlet(String alias, HttpService httpService) {
        ...
        this.analyzerRegistration.unregister();
        this.analyzerRegistration = null;
        this.servlet = null;
