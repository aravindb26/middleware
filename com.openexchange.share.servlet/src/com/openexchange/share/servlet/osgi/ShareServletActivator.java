...
public class ShareServletActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] {
            ...
            ConfigurationService.class, ModuleSupport.class, GuestService.class, TranslatorFactory.class, PasswordChangeRegistry.class };
    }
    ...
    protected void startBundle() throws Exception {
        ...
        {
            String property = getService(ConfigurationService.class).getProperty("com.openexchange.cookie.hash.salt");
            if (Strings.isEmpty(property)) {
                throw OXException.general("Property \"com.openexchange.cookie.hash.salt\" is not set");
            }
            byte[] hashSalt = property.getBytes(StandardCharsets.ISO_8859_1);
            Filter filter = context.createFilter("(|(" + Constants.OBJECTCLASS + '=' + HttpService.class.getName() + ")(" + Constants.OBJECTCLASS + '=' + DispatcherPrefixService.class.getName() + "))");
