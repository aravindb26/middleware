...
public class PasswordResetServlet extends AbstractShareServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Send error response
            e.send(response);
        } catch (OXRuntimeException | OXException | NoSuchAlgorithmException e) {
    ...
    private User updatePassword(int userId, Context context, String newPassword) throws OXException {
        ...
        User storageUser = userService.getUser(userId, context);
        GuestService guestService = ShareServiceLookup.getService(GuestService.class);
        if (null != guestService && guestService.isCrossContextGuestHandlingEnabled()) {
            guestService.updateGuestUser(storageUser, context.getContextId());
        }
        return storageUser;
    }
