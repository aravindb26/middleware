...
public interface DriveSubscriptionStore {
    ...
    /**
     * Gets the subscriptions of all registrations to certain services from specific users.
     *
     * @param contextID The context ID
     * @param serviceIDs The service IDs
     ...
     * @return The subscriptions
     */
    List<Subscription> getSubscriptions(int contextID, String[] serviceIDs, int[] userIDs) throws OXException;
