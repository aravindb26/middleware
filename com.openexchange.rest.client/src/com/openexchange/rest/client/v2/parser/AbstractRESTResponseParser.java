...
import com.openexchange.java.DateTimeFormatters;
...
public abstract class AbstractRESTResponseParser implements RESTResponseParser {
    ...
    private static final DateTimeFormatter LAST_MODIFIED_DATE_PARSER = DateTimeFormatter.RFC_1123_DATE_TIME;
     ...
     */
    protected AbstractRESTResponseParser() {
        super();
        ...
        headerParsers.put(HttpHeaders.LAST_MODIFIED, (response, httpResponse) -> {
            ...
            try {
                response.addHeader(HttpHeaders.LAST_MODIFIED, Long.toString(DateTimeFormatters.toEpochMillis(value, LAST_MODIFIED_DATE_PARSER)));
        ...
        responseBodyParsers = new EnumMap<>(RESTMimeType.class);
