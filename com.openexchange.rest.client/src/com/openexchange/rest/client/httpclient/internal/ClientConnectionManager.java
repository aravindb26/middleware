...
public class ClientConnectionManager extends PoolingHttpClientConnectionManager {
     ...
     * @param config HttpBasicConfig object with timeout configuration
     * @param socketFactoryRegistry For super class
     */
    public ClientConnectionManager(String clientName, HttpBasicConfig config, Registry<ConnectionSocketFactory> socketFactoryRegistry) {
        super(socketFactoryRegistry);
        this.clientName = clientName;
        this.defaultConnectTimeout = config.getConnectTimeout();
        this.defaultConnectionRequestTimeout = config.getConnectionRequestTimeout();
        this.keepAliveMonitorInterval = config.getKeepAliveMonitorInterval();
        this.shuttingDown = new AtomicBoolean(false);
        this.metricsInitialized = new AtomicBoolean(false);
    }
