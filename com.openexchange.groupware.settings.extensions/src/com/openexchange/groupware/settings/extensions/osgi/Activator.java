...
public class Activator extends HousekeepingActivator {
    ...
    static Object toPojo(Object value) {
        ...
        return JSONCoercion.parseAndCoerceToNative(value.toString());
    }
     ...
     */
    private static String[] generatePathFor(final ComposedConfigProperty<String> property) throws OXException {
        String preferencePath = property.get(PREFERENCE_PATH);
        if (null == preferencePath) {
            return null;
        }
        String[] path = Strings.splitBy(preferencePath, '/', true);
