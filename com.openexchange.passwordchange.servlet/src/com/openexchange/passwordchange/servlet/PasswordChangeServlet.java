...
public final class PasswordChangeServlet extends SessionServlet {
    ...
    protected void actionPutUpdate(final HttpServletRequest req, final HttpServletResponse resp) throws JSONException, IOException {
        ...
        try {
            ...
            String newPw;
            {
                JSONObject jBody = JSONServices.parseObject(getBody(req));
            ...
            PasswordChangeRegistry service = services.getServiceSafe(PasswordChangeRegistry.class);
            ...
            service.perform(new PasswordChangeEvent(session, context, newPw, oldPw, headers, cookies, req.getRemoteAddr()));
        } catch (OXException e) {
            LOGGER.error("", e);
            response.setException(e);
        }
