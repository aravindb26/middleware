...
public class Scope implements Serializable {
    ...
    public static Scope parseScope(String scopeStr) {
        ...
        Set<String> tokenSet = new LinkedHashSet<>(tokens.length);
     ...
     * The collection must not be <code>null</code> or empty. It must
     ...
     */
    public static Scope newInstance(Collection<String> tokens) {
     ...
     * @throws IllegalArgumentException If the set is <code>null</code>, empty or if any token is syntactically invalid
     */
    private Scope(Set<String> tokens) {
        super();
        this.tokens = tokens;
    }
