...
package com.openexchange.session.restricted;
 ...
 *   <li>
 *     Implement a method to perform the scope check and annotate it with <code>@RestrictedAccessCheck</code>.
 *     The method
 *     <ul>
 ...
 *           <li><code>com.openexchange.oauth.provider.resourceserver.scope.Scope</code></li>
 *         </ul>
 *       </li>
 ...
 * public boolean checkScope(AJAXRequestData request, ServerSession session, Scope scope) {
 *     return scope.has("custom_scope1") && scope.has("custom_scope2");
 * }
 * </pre>
 *
...
public @interface RestrictedAccessCheck {
