...
public class SessionFilter {
    ...
    /**
     * Creates a filter from specified expression w/o user and/or context association.
     *
    ...
    public static SessionFilter create(String filterString) throws IllegalArgumentException {
        return create(filterString, null, null);
    }
     ...
     *
     * @param filterString The filter expression
     * @param optUserAssociation The user association or <code>null</code>
     * @param optContextAssociation The context association or <code>null</code>
     * @return The yielded filter
     * @throws IllegalArgumentException If filter expression is invalid
     */
    public static SessionFilter create(String filterString, UserAndContext optUserAssociation, Integer optContextAssociation) throws IllegalArgumentException {
        Matcher matcher = new Parser(filterString).parse();
        return new SessionFilter(filterString, matcher, optUserAssociation, optContextAssociation);
    }
    ...
    public static SessionFilter createSecretFilter(String secret) {
        ...
        Matcher matcher = new Parser(filterString).parse();
        return new SessionFilter(filterString, matcher,null, null);
    }

    /**
     * Creates a filter from specified context identifier.
     *
     * @param contextId The context identifier
     * @return The yielded filter
     */
    public static SessionFilter createContextIdFilter(int contextId) {
        String filterString = "(" + SessionFilter.CONTEXT_ID + "=" + contextId + ")";
        Matcher matcher = new Parser(filterString).parse();
        return new SessionFilter(filterString, matcher, null, I(contextId));
    }

    /**
     * Creates a filter from specified user and context identifier.
     *
     * @param userId The user identifier
     * @param contextId The context identifier
     * @return The yielded filter
     */
    public static SessionFilter createUserAndContextIdFilter(int userId, int contextId) {
        String filterString = "(&(" + SessionFilter.USER_ID + "=" + userId + ")(" + SessionFilter.CONTEXT_ID + "=" + contextId + "))";
        Matcher matcher = new Parser(filterString).parse();
        return new SessionFilter(filterString, matcher, UserAndContext.newInstance(userId, contextId), null);
    }

    /** The special matcher for all */
    public static final SessionFilter ALL = new SessionFilter("all", null, null, null);

    // -------------------------------------------------------------------------------------------------------------------- //

    private final String filterString;
    private final Matcher matcher;
    private final Optional<UserAndContext> optUserAssociation;
    private final Optional<Integer> optContextAssociation;

    private SessionFilter(String filterString, Matcher matcher, UserAndContext optUserAssociation, Integer optContextAssociation) {
        super();
        this.filterString = filterString;
        this.matcher = matcher;
        this.optUserAssociation = optUserAssociation == null ? Optional.empty() : Optional.of(optUserAssociation);
        this.optContextAssociation = optContextAssociation == null ? Optional.empty() : Optional.of(optContextAssociation);
    }

    /**
     * Gets the optional user association.
     *
     * @return The user association or empty
     */
    public Optional<UserAndContext> getUserAssociation() {
        return optUserAssociation;
    }

    /**
     * Gets the optional context association
     *
     * @return The context association or empty
     */
    public Optional<Integer> getContextAssociation() {
        return optContextAssociation;
    }
    ...
    public boolean apply(Session session) {
        return matcher == null || matcher.matches(new SessionMatchee(session));
    }
