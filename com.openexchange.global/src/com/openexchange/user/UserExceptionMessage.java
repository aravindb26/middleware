...
public class UserExceptionMessage implements LocalizableStrings {
     ...
     */
    public static final String INVALID_MIN_LENGTH_DISPLAY = "Invalid password length. The password must have a minimum length of %1$d characters.";

    /**
     * Invalid password length. The password must have a maximum length of %1$d characters.
     */
    public static final String INVALID_MAX_LENGTH_DISPLAY = "Invalid password length. The password must have a maximum length of %1$d characters.";
