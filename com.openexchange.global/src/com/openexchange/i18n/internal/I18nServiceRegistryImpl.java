...
public class I18nServiceRegistryImpl implements I18nServiceRegistry {
    ...
    /**
     * Gets the best-fitting translation service for given locale.
     *
     * @param locale The locale to look-up by
     * @return The best-fitting translation service
     */
    public I18nService getBestFittingI18nService(Locale locale) {
        ...
        // No direct hit. Check for possible best fit according to locale's language tag.
        String bestFitLanguageTag = Locale2LanguageMapping.getLanguageForLocale(locale.toLanguageTag());
        if (bestFitLanguageTag != null) {
            Locale bestFitLocale = Locale.forLanguageTag(bestFitLanguageTag);
