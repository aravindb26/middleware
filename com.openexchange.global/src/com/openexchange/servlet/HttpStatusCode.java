...
public class HttpStatusCode {
    ...
    private static final Map<Integer, HttpStatusCode> STATUS_MESSAGES = new ConcurrentHashMap<Integer, HttpStatusCode>();

    public static final HttpStatusCode CONTINUE_100 = register(100, "Continue");
    ...
    public static final HttpStatusCode NON_AUTHORITATIVE_INFORMATION_203 = register(203, "Not-Authoritative Information");
    ...
    private static HttpStatusCode register(int statusCode, final String reasonPhrase) {
        ...
        STATUS_MESSAGES.put(I(statusCode), httpStatus);
        return httpStatus;
    }
    ...
    public static HttpStatusCode getHttpStatus(int statusCode) {
        HttpStatusCode status = STATUS_MESSAGES.get(I(statusCode));
        if (status == null) {
     ...
     */
    private HttpStatusCode(int status, String reasonPhrase) {
        super();
        this.status = status;
