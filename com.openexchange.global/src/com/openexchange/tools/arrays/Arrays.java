...
public final class Arrays {
     ...
     *
     * @param removeFrom The array
     * @param toRemove The items to remove
     * @return A new array without the given items
     */
    public static int[] remove(int[] removeFrom, int... toRemove) {
        TIntArrayList tmp = new TIntArrayList();
        for (int copy : removeFrom) {
            tmp.add(copy);
        }
        for (int remove : toRemove) {
            tmp.remove(remove);
        }
        return tmp.toArray((int[]) Array.newInstance(removeFrom.getClass().getComponentType(), tmp.size()));
    }
    ...
    /**
     * Gets a value indicating whether the supplied array is <code>null</code> or does not contain any element.
     *
     * @param <T> The type of the array
     * @param array The array to check
     * @return <code>true</code> if the array is <code>null</code> or empty, <code>false</code>, otherwise
     */
    ...
    /**
     * Converts an array to array list
     *
     * @param <T> The class of the array
     * @param array The array to convert
     * @return A sorted {@link ArrayList} with the elements from the array
     */
