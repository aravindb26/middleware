...
public final class Collections {
    ...
    public static <K, V> boolean put(Map<K, List<V>> multiMap, K key, V value) {
        return put(multiMap, key, value, () -> new ArrayList<>());
    }

    /**
     * Puts a key-value-pair into a "multi-map", i.e. a map associating a key with multiple values. New collections for the key are created
     * automatically as needed, using the given {@link Supplier}.
     *
     * @param <K> The type of the key
     * @param <V> The type of the value to put into the collection
     * @param <C> The collection that contains the values
     * @param multiMap The multi-map to put the value into
     * @param key The key to add the value for
     * @param value The value to add
     * @param collectionSupplier A supplier to instantiate new collections as needed
     * @return <code>true</code> (as specified by {@link Collection#add})
     */
    public static <K, V, C extends Collection<V>> boolean put(Map<K, C> multiMap, K key, V value, Supplier<C> collectionSupplier) {
    ...
    /**
     * Gets a value indicating whether the supplied collection reference does contain at least one element or not
     *
     * @param collection The collection to check
     * @return <code>true</code> if the collection is <b>not</b> <code>null</code> and <b>not</b> empty, <code>false</code> if <code>null</code> or empty
     */
    public static boolean isNotEmpty(Collection<?> collection) {
        return null != collection && false == collection.isEmpty();
    }
