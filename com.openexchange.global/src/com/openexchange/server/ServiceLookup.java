...
public interface ServiceLookup {
     ...
     *
     * @param <S> The (parent) class of the service
    ...
    /**
     * Gets the service of specified type as {@link Optional}
     *
     * @param <S> The (parent) class of the service
     * @param clazz The service's class
     * @return The service or <code>null</code> wrapped into an {@link Optional}
     * @throws IllegalStateException If an error occurs while returning the demanded service
     * @throws ShutDownRuntimeException If system is currently shutting down
     */
    default <S extends Object> Optional<S> ofService(final Class<? extends S> clazz) {
    ...
    /**
     * Gets the optional service of specified type as {@link Optional}
     * 
     * @param <S> The (parent) class of the service
     * @param clazz The service's class
     * @return The service or <code>null</code> wrapped into an {@link Optional}
     * @throws ShutDownRuntimeException If system is currently shutting down
     */
    default <S extends Object> Optional<S> ofOptionalService(final Class<? extends S> clazz) {
        return Optional.ofNullable(getOptionalService(clazz));
    }
