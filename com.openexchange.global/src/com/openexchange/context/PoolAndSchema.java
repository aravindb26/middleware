 ...
 * @since v7.10.0
 */
public class PoolAndSchema implements Comparable<PoolAndSchema> {
    ...
    @Override
    public int compareTo(PoolAndSchema o) {
        int c = Integer.compare(poolId, o.poolId);
        if (c == 0) {
            c = schema.compareTo(o.schema);
        }
        return c;
    }
    ...
    public String toString() {
        return new StringBuilder(schema).append(" (pool=").append(poolId).append(')').toString();
    }
