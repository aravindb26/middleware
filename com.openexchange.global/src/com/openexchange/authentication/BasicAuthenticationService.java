...
public interface BasicAuthenticationService extends AuthenticationService {
    ...
    /**
     * Identifier for the BasicAuthenticationService
     */
    public final static String AUTH_IDENTIFIER = "basic";
     ...
     */
    AuthenticationResult handleLoginInfo(int userId, int contextId) throws OXException;
     ...
     */
    AuthenticationResult handleLoginInfo(int userId, int contextId, String password) throws OXException;
}
