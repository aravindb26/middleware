...
public enum LoginExceptionCodes implements DisplayableOXExceptionCode {
     ...
     *
     * @deprecated: Use {@link #INVALID_CREDENTIALS} instead to avoid possibility of enumerating user base
     */
    @Deprecated
    ...
    /**
     * Thrown in case an auto-login attempt failed.
     * <p>
     * Invalid cookie.
     */
    INVALID_COOKIE("Invalid cookie.", LoginExceptionMessages.INVALID_COOKIE_MSG, Category.CATEGORY_ERROR, 29),
    ;
