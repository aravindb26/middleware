...
public final class Resource implements Serializable, Cloneable {
    ...
    private static final long serialVersionUID = 1330480724346828537L;
    ...
    public void fill(final Resource src) {
        ...
        if (!permissionsSet) {
            setPermissions(src.getPermissions());
        }
    }
    ...
    /**
     * Getter for resource permissions
     *
     * @return Returns the resource permissions.
     */
    ...
    /**
     * Checks if resource permissions have been set
     *
     * @return <code>true</code> if resource permissions have been set; otherwise <code>false</code>
     */
    ...
    /**
     * Setter for resource permissions
     *
    ...
    public Object clone() {
        try {
            Resource result = (Resource) super.clone();
            if (null != permissions) {
                result.permissions = Arrays.stream(permissions).map(perm -> perm.clone()).toArray(size -> new ResourcePermission[size]);
            }
            if (null != lastModified) {
                result.lastModified = (Date) lastModified.clone();
            }
            return result;
