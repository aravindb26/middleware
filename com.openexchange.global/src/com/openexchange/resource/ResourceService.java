...
public interface ResourceService {
     ...
     * @throws OXException If the resource can't be found or an exception appears while reading it.
     */
    Resource getResource(Connection connection, int resourceId, Context context) throws OXException;
    ...
    /**
     * Looks up all resources where a specific user has a certain scheduling privilege for.
     *
     * @param user The user for whom the resources with privilege should be looked up
     * @param ctx The context
     * @param privilege The privilege to match
     * @return An array of found resources
     * @throws OXException If an exception occurs while reading from the underlying persistent storage.
     */
    Resource[] searchResourcesWithPrivilege(User user, Context ctx, SchedulingPrivilege privilege) throws OXException;
