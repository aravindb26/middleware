...
public class SaveAsAction extends AbstractWriteAction {
    ...
    public AJAXRequestResult handle(InfostoreRequest request) throws OXException {
        ...
        Optional<String> adjustedFolderId = Attachments.adjustFolderId(request.getFolderId());
        int folderId = Integer.parseInt(adjustedFolderId.isPresent() ? adjustedFolderId.get() : request.getFolderId());
