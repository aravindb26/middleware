...
public class SearchTest extends FileActionTest {
    ...
    public void testAction() throws OXException, JSONException {
        ...
        fileAccess().expectCall("search", "someSearch", columns, "12", Boolean.FALSE, File.Field.TITLE, SortDirection.DESC, I(10), I(12)).andReturn(SearchIteratorAdapter.emptyIterator());
        perform();
