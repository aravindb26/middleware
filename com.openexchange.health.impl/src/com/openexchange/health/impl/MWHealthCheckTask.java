...
/**
 * {@link MWHealthCheckTask} - A simple task carrying a health check instance, which is invoked.
 *
...
public final class MWHealthCheckTask extends AbstractTask<MWHealthCheckResponse> {
    ...
    /**
     * Initializes a new {@link MWHealthCheckTask}.
     *
     * @param check The health check to invoke
     */
