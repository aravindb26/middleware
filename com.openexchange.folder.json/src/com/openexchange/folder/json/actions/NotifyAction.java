...
public final class NotifyAction extends AbstractFolderAction {
    ...
    protected AJAXRequestResult doPerform(AJAXRequestData request, ServerSession session) throws OXException {
        ...
        List<OXException> warnings = notificationService.sendShareNotifications(notificationData.getTransport(), entities, notificationData.getMessage(), targetPath, session, request.getHostData());
        /*
    ...
    public boolean accessAllowed(final AJAXRequestData request, final ServerSession session, final Scope scope) throws OXException {
        ...
        return RestrictedActionUtil.mayWriteWithScope(contentType, scope);
    }
