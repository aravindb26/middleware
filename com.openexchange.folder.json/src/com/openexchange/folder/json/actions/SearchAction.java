...
public class SearchAction extends AbstractFolderAction {
    ...
    protected AJAXRequestResult doPerform(AJAXRequestData request, ServerSession session) throws OXException, JSONException {
        ...
        FolderResponse<List<UserizedFolder>> response = folderService.searchFolderByName(treeId, folderId, contentType, query, date, includeSubfolders, all, start, start + size, session, decorator);
