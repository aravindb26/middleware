...
public final class FolderWriter {
    ...
    private static interface JSONValuePutter {
         ...
         */
        void putParameter(String name, Object value) throws NullPointerException;
         ...
         * @throws NullPointerException If name is <code>null</code>
         */
        <V> V getParameter(String name) throws NullPointerException;
        ...
        m.put(FolderField.FOLDER_NAME.getColumn(), new FolderFieldWriter() {
            ...
            public void writeField(final JSONValuePutter jsonPutter, final UserizedFolder folder, Map<String, Object> state, ServerSession session) throws JSONException {
                ...
                if (folder.supportsAltName()) {
                    jsonPutter.put(jsonPutter.withKey() ? FolderField.FOLDER_NAME.getName() : null, folder.getName(locale == null ? DEFAULT_LOCALE : locale, folder.isAltNames()));
                } else {
                    jsonPutter.put(jsonPutter.withKey() ? FolderField.FOLDER_NAME.getName() : null, folder.getName(locale == null ? DEFAULT_LOCALE : locale));
                }
            }
        });
