...
public class TokenRefreshResponse {
    ...
    public static final TokenRefreshResponse MISSING_REFRESH_TOKEN = new TokenRefreshResponse(new Error(ErrorType.PERMANENT, "missing_token", "Session contained no refresh token"));
    ...
    public static enum ErrorType {
        ...
        /**
         * Access token could not be refreshed because the ID token received on refresh was invalid.
         * This will lead to session termination!
         */
        INVALID_ID_TOKEN,
        /**
