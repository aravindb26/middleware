...
public class OAuthTokens {
    ...
    public OAuthTokens(String accessToken, Date expiryDate, String refreshToken) {
        this(accessToken, expiryDate, refreshToken, null);
    }
     ...
     * @param expiryDate The expiry date; must not be {@code null}
     * @param refreshToken The refresh token; might be {@code null}
     * @param idToken The ID token; might be {@code null}
     */
    public OAuthTokens(String accessToken, Date expiryDate, String refreshToken, String idToken) {
        super();
        if (accessToken == null) {
    ...
    /**
     * Gets whether an ID token is contained
     *
     * @return {@code true} if a ID token is available
     */
     ...
     * Gets the ID token
     *
     * @return The ID token or {@code null}
     */
    ...
    public String toString() {
        ...
        if (idToken != null) {
            sb.append(", id_token=").append(Integer.toHexString(idToken.hashCode()));
        }
        sb.append(']');
        return sb.toString();
    }
