...
public class MultifactorManagementREST {
     ...
     * @throws OXException
     */
    private Optional<Response> authenticate(int contextId, String auth) throws OXException {
    ...
    public Response getDevices(@PathParam("context-id") int contextId, @PathParam("user-id") int userId) throws JSONException {
        try {
            String auth = httpHeaders.getHeaderString(HttpHeaders.AUTHORIZATION);
            Optional<Response> authenticationError = authenticate(contextId, auth);
     ...
     */
    @DELETE
    public Response removeDevices(@PathParam("context-id") int contextId, @PathParam("user-id") int userId) throws JSONException {
        try {
            String auth = httpHeaders.getHeaderString(HttpHeaders.AUTHORIZATION);
            Optional<Response> authenticationError = authenticate(contextId, auth);
            if (authenticationError.isPresent()) {
