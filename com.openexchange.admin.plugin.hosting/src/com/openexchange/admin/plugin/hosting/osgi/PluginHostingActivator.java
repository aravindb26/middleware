...
public class PluginHostingActivator extends HousekeepingActivator {
    ...
    public void startBundle() throws Exception {
        ...
        track(Authenticator.class, new RegistryServiceTrackerCustomizer<>(context, AdminServiceRegistry.getInstance(), Authenticator.class));
    ...
    public void stopBundle() throws Exception {
        ...
        super.stopBundle();
        AdminServiceRegistry.getInstance().clearRegistry();
