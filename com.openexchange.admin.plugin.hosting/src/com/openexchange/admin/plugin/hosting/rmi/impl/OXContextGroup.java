 ...
 */
public class OXContextGroup extends AbstractAuthenticatorRMIService implements OXContextGroupInterface {
    ...
    @Override
    public void deleteContextGroup(String contextGroupId, Credentials auth) throws RemoteException, StorageException {
        Authenticator authenticator = AdminServiceRegistry.getInstance().getService(Authenticator.class);
