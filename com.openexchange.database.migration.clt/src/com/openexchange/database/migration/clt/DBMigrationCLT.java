...
public class DBMigrationCLT extends AbstractRmiCLI<Void> {
    ...
    protected Void invoke(Options options, CommandLine cmd, String optRmiHostName) throws Exception {
        ...
        if (cmd.hasOption(OPT_RUN_SHORT)) {
            rmiService.forceMigration(schemaName, new Credentials(adminUser, adminPassword));
            ...
            rmiService.releaseLocks(schemaName, new Credentials(adminUser, adminPassword));
