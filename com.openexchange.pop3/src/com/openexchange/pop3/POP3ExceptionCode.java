...
public enum POP3ExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * Connection was refused or timed out while attempting to connect to remote server %1$s for user %2$s. Waited for %3$s msec.
     */
     ...
     */
    CONNECT_ERROR_SIMPLE(MimeMailExceptionCode.CONNECT_ERROR_SIMPLE),
    /**
