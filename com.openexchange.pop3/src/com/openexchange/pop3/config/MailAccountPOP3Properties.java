...
public final class MailAccountPOP3Properties extends MailAccountProperties implements IPOP3Properties {
    ...
    public int getConnectTimeout() {
        return lookUpIntProperty("com.openexchange.pop3.pop3ConnectionTimeout", POP3Properties.getInstance().getConnectTimeout());
    }
    ...
    public int getReadTimeout() {
        return lookUpIntProperty("com.openexchange.pop3.pop3Timeout", POP3Properties.getInstance().getReadTimeout());
    }
    ...
    public boolean isRequireTls() {
        return lookUpBoolProperty("com.openexchange.pop3.requireTls", POP3Properties.getInstance().isRequireTls());
    }
