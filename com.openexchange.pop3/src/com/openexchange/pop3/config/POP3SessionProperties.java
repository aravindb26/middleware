...
public final class POP3SessionProperties {
    ...
    private static void initializePOP3Properties() {
        ...
        if (POP3Properties.getInstance().getReadTimeout() > 0) {
            properties.put("mail.pop3.timeout", String.valueOf(POP3Properties.getInstance().getReadTimeout()));
        }
        if (POP3Properties.getInstance().getConnectTimeout() > 0) {
            properties.put(
                "mail.pop3.connectiontimeout",
                String.valueOf(POP3Properties.getInstance().getConnectTimeout()));
        }
        /*
