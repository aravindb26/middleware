...
public final class POP3SyncMessagesCallable implements Callable<Object> {
    ...
    public Object call() throws Exception {
        ...
        final int port = pop3Config.getPort();
        {
            String capabilities;
            try {
                capabilities = POP3CapabilityCache.getCapability(InetAddress.getByName(IDNA.toASCII(server)), port, pop3Config.isSecure(), pop3Config.getPOP3Properties(), pop3Config.getLogin());
            } catch (Exception e) {
                LOG.warn("Couldn't detect capabilities for POP3 account \"pop3://{}@{}:{}\"", pop3Config.getLogin(), server, Integer.valueOf(port), e);
        ...
        LOG.debug("\n\tSynchronizing messages with POP3 account \"pop3://{}@{}:{}\"", pop3Config.getLogin(), server, Integer.valueOf(port), new Throwable());
        /*
        ...
        try {
            ...
            LOG.debug("\n\tPOP3 account \"pop3://{}@{}:{}\" locked.", pop3Config.getLogin(), server, Integer.valueOf(port), e);
        }
        return null;
    }

    private static boolean isConnectable(final long refreshRateMillis, final Long lastAccessed) {
