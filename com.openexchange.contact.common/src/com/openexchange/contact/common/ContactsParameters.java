...
public interface ContactsParameters {
     ...
     * {@link Boolean}
     * <p/>
     * Controls whether also unsubscribed folders (i.e. not visible in the tree) are considered (used during searches).
     */
    static final String PARAMETER_INCLUDE_UNSUBSCRIBED_FOLDERS = "include_unsubscribed_folders";

    /**
     * {@link Boolean}
     * <p/>
     * Configures if only folders that are explicitly marked for usage in the picker are considered (used during searches).
     */
    static final String PARAMETER_PICKER_FOLDERS_ONLY = "picker_folders_only";
