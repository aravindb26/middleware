...
public class Messages implements LocalizableStrings {
    ...
    /**
     * Introduction that current user has received an invitation for another internal user
     * <code>%1$s has been invited to an appointment by %2$s:</code>
     */
    public static final String CREATE_ON_OTHER_BEHALF_INTRO = "%1$s has been invited to an appointment by %2$s:";
    ...
    /**
     * Introduction that current user has received an event update for another internal user
     * <code>%1$s has changed an appointment %2$s participates in:</code>
     */
    public static final String UPDATE_ON_OTHER_BEHALF_INTRO = "%1$s has changed an appointment %2$s participates in:";
    ...
    /**
     * Introduction that current user has received an cancel for another internal user
     * <code>%1$s has deleted an appointment, or %2$s has been removed as a participant:</code>
     */
    public static final String DELETE_ON_OTHER_BEHALF_INTRO = "%1$s has deleted an appointment, or %2$s has been removed as a participant:";
    ...
    /** Displayed within notification mails next to an attendee's display name */
    public static final String PARTICIPANT_ROLE_OPTIONAL = "(Optional)";
    ...
    public static final String HAS_ADDED_RESOURCE = "The resource %1$s has been added to the appointment.";

    public static final String HAS_REMOVED_RESOURCE = "The resource %1$s has been removed from the appointment.";
    ...
    public static final String HAS_CHANGED_ORIGINAL_RRULE_UNTIL = "The original appointment series now ends on %1$s.";
    ...
    public static final String REPLY_FOR_ATTENDEE = "You have received an E-Mail containing a reply to an appointment that you didn't organize. Best ignore it.";
    ...
    /** An unknown attendee wants to be brought up to date to an appointment. Best ignore this message. */
    public static final String REFRESH_FROM_UNKNOWN = "An unknown attendee wants to be brought up to date to an appointment. Best ignore this message.";

    /** An unknown attendee has proposed changes to an appointment. Best ignore this message. */
    public static final String COUNTER_FROM_UNKNOWN = "An unknown attendee has proposed changes to an appointment. Best ignore this message.";

    /*
     * ============================== Resources ==============================
     */

    /** %1$s has accepted the booking request for the resource %2$s for the appointment %3$s. */
    public static final String RESOURCE_ACCEPTED = "%1$s has accepted the booking request for the resource %2$s for the appointment %3$s.";

    /** %1$s has accepted the booking request for the resource %2$s for an appointment of the series %3$s. */
    public static final String RESOURCE_ACCEPTED_INSTANCE = "%1$s has accepted the booking request for the resource %2$s for an appointment of the series %3$s.";

    /** %1$s has tentatively accepted the booking request for the resource %2$s for the appointment %3$s. */
    public static final String RESOURCE_TENTATIVE = "%1$s has tentatively accepted the booking request for the resource %2$s for the appointment %3$s.";

    /** %1$s has tentatively accepted the booking request for the resource %2$s for an appointment of the series %3$s. */
    public static final String RESOURCE_TENTATIVE_INSTANCE = "%1$s has tentatively accepted the booking request for the resource %2$s for an appointment of the series %3$s.";

    /** %1$s has declined the booking request for the resource %2$s for the appointment %3$s. */
    public static final String RESOURCE_DECLINED = "%1$s has declined the booking request for the resource %2$s for the appointment %3$s.";

    /** %1$s has declined the booking request for the resource %2$s for an appointment of the series %3$s. */
    public static final String RESOURCE_DECLINED_INSTANCE = "%1$s has declined the booking request for the resource %2$s for an appointment of the series %3$s.";

    /** %1$s has deferred the booking request for the resource %2$s for the appointment %3$s. */
    public static final String RESOURCE_NEEDS_ACTION = "%1$s has deferred the booking request for the resource %2$s for the appointment %3$s.";

    /** %1$s has deferred the booking request for the resource %2$s for an appointment of the series %3$s. */
    public static final String RESOURCE_NEEDS_ACTION_INSTANCE = "%1$s has deferred the booking request for the resource %2$s for an appointment of the series %3$s.";

    /** %1$s has added the resource %2$s to the appointment %3$s. */
    public static final String RESOURCE_CREATE = "%1$s has added the resource %2$s to the appointment %3$s.";

    /** %1$s has added the resource %2$s to an appointment of the series %3$s. */
    public static final String RESOURCE_CREATE_INSTANCE = "%1$s has added the resource %2$s to an appointment of the series %3$s.";

    /** On behalf of %1$s, %2$s has added the resource %3$s to the appointment %4$s. */
    public static final String RESOURCE_CREATE_ON_BEHALF = "On behalf of %1$s, %2$s has added the resource %3$s to the appointment %4$s.";

    /** On behalf of %1$s, %2$s has added the resource %3$s to an appointment of the series %4$s. */
    public static final String RESOURCE_CREATE_ON_BEHALF_INSTANCE = "On behalf of %1$s, %2$s has added the resource %3$s to an appointment of the series %4$s.";

    /** The appointment %1$s with the resource %2$s has been changed by %3$s. */
    public static final String RESOURCE_UPDATE = "The appointment %1$s with the resource %2$s has been changed by %3$s.";

    /** An appointment of the series %1$s with the resource %2$s has been changed by %3$s. */
    public static final String RESOURCE_UPDATE_INSTANCE = "An appointment of the series %1$s with the resource %2$s has been changed by %3$s.";

    /** On behalf of %1$s, the appointment %2$s with the resource %3$s has been changed by %4$s. */
    public static final String RESOURCE_UPDATE_ON_BEHALF = "On behalf of %1$s, the appointment %2$s with the resource %3$s has been changed by %4$s.";

    /** On behalf of %1$s, an appointment of the series %2$s with the resource %3$s has been changed by %4$s. */
    public static final String RESOURCE_UPDATE_ON_BEHALF_INSTANCE = "On behalf of %1$s, an appointment of the series %2$s with the resource %3$s has been changed by %4$s.";

    /** The resource %1$s has been removed from the appointment %2$s by %3$s, or the appointment has been deleted. */
    public static final String RESOURCE_DELETE = "The resource %1$s has been removed from the appointment %2$s by %3$s, or the appointment has been deleted.";

    /** The resource %1$s has been removed from an appointment of the series %2$s by %3$s, or the appointment has been deleted. */
    public static final String RESOURCE_DELETE_INSTANCE = "The resource %1$s has been removed from an appointment of the series %2$s by %3$s, or the appointment has been deleted.";

    /** On behalf of %1$s, the resource %2$s has been removed from the appointment %3$s by %4$s, or the appointment has been deleted. */
    public static final String RESOURCE_DELETE_ON_BEHALF = "On behalf of %1$s, the resource %2$s has been removed from the appointment %3$s by %4$s, or the appointment has been deleted.";

    /** On behalf of %1$s, the resource %2$s has been removed from an appointment of the series %3$s by %4$s, or the appointment has been deleted. */
    public static final String RESOURCE_DELETE_ON_BEHALF_INSTANCE = "On behalf of %1$s, the resource %2$s has been removed from an appointment of the series %3$s by %4$s, or the appointment has been deleted.";

    /** New appointment for resource %1$s: %2$s */
    public static final String RESOURCE_SUBJECT_NEW_APPOINTMENT = "New appointment for resource %1$s: %2$s";

    /** Appointment changed for resource %1$s: %2$s */
    public static final String RESOURCE_SUBJECT_CHANGED_APPOINTMENT = "Appointment changed for resource %1$s: %2$s";

    /** Appointment canceled for resource %1$s: %2$s */
    public static final String RESOURCE_SUBJECT_CANCELLED_APPOINTMENT = "Appointment canceled for resource %1$s: %2$s";

    /** Booking request for resource %1$s accepted: %2$s */
    public static final String RESOURCE_SUBJECT_ACCEPTED = "Booking request for resource %1$s accepted: %2$s";

    /** Booking request for resource %1$s tentative accepted: %2$s" */
    public static final String RESOURCE_SUBJECT_TENTATIVE = "Booking request for resource %1$s tentatively accepted: %2$s";

    /** Booking request for resource %1$s declined: %2$s */
    public static final String RESOURCE_SUBJECT_DECLINED = "Booking request for resource %1$s declined: %2$s";

    /** Booking request for resource %1$s deferred: %2$s" */
    public static final String RESOURCE_SUBJECT_NEEDS_ACTION = "Booking request for resource %1$s deferred: %2$s";
