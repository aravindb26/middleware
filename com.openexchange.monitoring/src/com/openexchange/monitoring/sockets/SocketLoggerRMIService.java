...
public interface SocketLoggerRMIService extends Remote {
     ...
     */
    void registerLoggerFor(String name, Credentials auth) throws RemoteException;
     ...
     * @param auth Credentials for authenticating against server.
     */
    void unregisterLoggerFor(String name, Credentials auth) throws RemoteException;
