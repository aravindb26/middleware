...
public class PendingAction extends ChronosAction {
    ...
    protected AJAXRequestResult perform(IDBasedCalendarAccess calendarAccess, AJAXRequestData requestData) throws OXException {
        ...
        List<AlarmTrigger> defaultAlarmTrigger = calendarAccess.getAlarmTriggers(actions);
        return new AJAXRequestResult(defaultAlarmTrigger, AlarmTriggerConverter.INPUT_FORMAT);
    }
