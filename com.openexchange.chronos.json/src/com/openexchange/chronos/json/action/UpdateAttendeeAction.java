...
public class UpdateAttendeeAction extends ChronosAction {
    ...
    protected AJAXRequestResult perform(IDBasedCalendarAccess calendarAccess, AJAXRequestData requestData) throws OXException {
        ...
        try {
            ...
            /*
             * explicitly parse and set {@value #TRANSP} parameter, to avoid de-serialization on common attendee object
             */
            if (jsonObject.isNull(TRANSP)) {
                attendee.setTransp(null);
            } else if (jsonObject.has(TRANSP)) {
                String transp = jsonObject.getString(TRANSP);
                attendee.setTransp(TimeTransparency.parse(transp));
            }
