...
import static com.openexchange.chronos.json.action.ChronosJsonParameters.PARAM_MASK_UID;
...
public class FreeBusyAction extends ChronosAction {
    ...
    private static final Set<String> OPTIONAL_PARAMETERS = unmodifiableSet(PARAM_FIELDS, PARAM_MASK_UID);
