...
import com.openexchange.chronos.storage.rdb.groupware.CalendarAlarmTriggerAddClaimColumnTask;
...
import com.openexchange.chronos.storage.rdb.groupware.CalendarAttendeeAddSequenceColumnTask;
...
import com.openexchange.chronos.storage.rdb.groupware.CalendarEventAddDtStampColumnTask;
...
public class RdbCalendarStorageActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getOptionalServices() {
        return new Class<?>[] { CalendarUtilities.class, CacheService.class, UserPermissionService.class, LeanConfigurationService.class, TimerService.class };
    }
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            registerService(UpdateTaskProviderService.class, new DefaultUpdateTaskProviderService(
                ...
                new CalendarAttendeeAddSequenceColumnTask(),
                new CalendarEventAddDtStampColumnTask(),
                new CalendarAlarmTriggerAddClaimColumnTask()
            ));
            // @formatter:on
