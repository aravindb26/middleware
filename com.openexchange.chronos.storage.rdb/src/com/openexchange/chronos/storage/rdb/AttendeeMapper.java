...
public class AttendeeMapper extends DefaultDbMapper<Attendee, AttendeeField> {
	...
	protected EnumMap<AttendeeField, DbMapping<? extends Object, Attendee>> createMappings() {
        ...
        mappings.put(AttendeeField.SEQUENCE, new IntegerMapping<Attendee>("sequence", "AttendeeSequence") {
            ...
            public void set(Attendee object, Integer value) throws OXException {
                object.setSequence(null == value ? -1 : value.intValue());
            }
            
            @Override
            public Integer get(Attendee object) {
                return 0 >= object.getSequence() ? I(0) : I(object.getSequence());
            }
