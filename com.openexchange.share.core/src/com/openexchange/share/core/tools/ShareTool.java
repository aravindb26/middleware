        ...
        if (RecipientType.ANONYMOUS == type) {
            ...
            if (jsonObject.has("expiry_date")) {
                ...
                if(jsonObject.isNull("expiry_date")){
                    ...
                    newExpiry = new Date(date);
                }
                anonymousRecipient.setExpiryDate(newExpiry);
            }
            if (jsonObject.has("password")) {
                String newPassword = jsonObject.isNull("password") ? null : jsonObject.getString("password");
                anonymousRecipient.setPassword(newPassword);
            }
            if (jsonObject.has("includeSubfolders")) {
                boolean includeSubfolders = jsonObject.isNull("includeSubfolders") ? false : jsonObject.getBoolean("includeSubfolders");
                anonymousRecipient.setIncludeSubfolders(includeSubfolders);
            }
