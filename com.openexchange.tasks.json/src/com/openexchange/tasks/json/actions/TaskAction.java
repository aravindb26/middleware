            ...
            switch (p.getType()) {
                case Participant.USER:
                    ...
                    if (p.getIdentifier() != session.getUserId()) {
                        IncrementArguments arguments = IncrementArguments.builderWithUserId(p.getIdentifier()).build();
                        service.incrementUseCount(session, arguments);
                    }
                    break;
                case Participant.EXTERNAL_USER:
                    ...
                    IncrementArguments arguments = IncrementArguments.builderWithMailAddresses(p.getEmailAddress()).build();
                    service.incrementUseCount(session, arguments);
                    break;
