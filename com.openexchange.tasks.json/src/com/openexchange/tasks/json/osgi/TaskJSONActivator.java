...
public class TaskJSONActivator extends AJAXModuleActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerScope(RestrictedAction.Type.READ, TaskActionFactory.MODULE, OAuthScopeDescription.READ_ONLY, Permission.TASKS);
        registerScope(RestrictedAction.Type.WRITE, TaskActionFactory.MODULE, OAuthScopeDescription.WRITABLE, Permission.TASKS);
