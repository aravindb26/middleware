...
public class MailMappingActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        RankingAwareNearRegistryServiceTracker<MailResolver> resolverTracker = new RankingAwareNearRegistryServiceTracker<MailResolver>(context, MailResolver.class);
        rememberTracker(resolverTracker);
        openTrackers();

        MailResolverServiceImpl osgiMailMappingService = new MailResolverServiceImpl(resolverTracker);
