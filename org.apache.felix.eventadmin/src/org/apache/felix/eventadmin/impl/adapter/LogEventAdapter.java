        ...
        synchronized (m_lock)
        {
            ...
            m_logListener = new org.osgi.service.log.LogListener()
            {
                ...
                public void logged(final org.osgi.service.log.LogEntry entry)
                {
                    ...
                    if (null != bundle)
                    {
                        properties.put("bundle.id", Long.valueOf(bundle
                            .getBundleId()));
                    ...
                    properties.put("log.level", Integer.valueOf(entry.getLevel()));

                    properties.put(EventConstants.MESSAGE, entry.getMessage());

                    properties.put(EventConstants.TIMESTAMP, Long.valueOf(
                        entry.getTime()));
