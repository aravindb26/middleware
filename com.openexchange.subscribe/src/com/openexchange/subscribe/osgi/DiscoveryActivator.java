...
public class DiscoveryActivator extends HousekeepingActivator {
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        AbstractSubscribeService.SECRET_SERVICE.set(getService(SecretService.class));
        AbstractSubscribeService.THREADPOOL_SERVICE.set(getService(ThreadPoolService.class));
    ...
    protected synchronized void stopBundle() throws Exception {
        ...
        AbstractSubscribeService.SECRET_SERVICE.set(null);
        AbstractSubscribeService.THREADPOOL_SERVICE.set(null);
    ...
    protected Class<?>[] getNeededServices() {
        return new Class[] { UserService.class, UserPermissionService.class, InfostoreFacade.class, FolderService.class, com.openexchange.folderstorage.FolderService.class,
            DBProvider.class, SecretEncryptionFactoryService.class, CryptoService.class, ContextService.class, SecretService.class, ThreadPoolService.class };
    }
