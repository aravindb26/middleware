...
public abstract class AbstractSubscribeService implements SubscribeService {
    ...
    public static final AtomicReference<SecretService> SECRET_SERVICE = new AtomicReference<>();
    public static final AtomicReference<ThreadPoolService> THREADPOOL_SERVICE = new AtomicReference<>();
