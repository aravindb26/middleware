...
/**
 * {@link PreUpgradeExceptionCodes}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 * @since v8.0.0
 */
public enum PreUpgradeExceptionCodes implements DisplayableOXExceptionCode {
    ...
    public static final String PREFIX = "PRE_UPGRADE";
    ...
    /**
     * Initializes a new {@link PreUpgradeExceptionCodes}.
     * 
     * @param message The message
     * @param category The category
     * @param detailNumber The detail number
     */
    private PreUpgradeExceptionCodes(final String message, final Category category, final int detailNumber) {
