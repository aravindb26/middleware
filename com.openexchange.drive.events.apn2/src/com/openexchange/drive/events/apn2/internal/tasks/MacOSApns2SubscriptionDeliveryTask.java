...
/**
 * {@link MacOSApns2SubscriptionDeliveryTask} is a {@link SubscriptionDeliveryTask} for apns2 based {@link ApnsDriveEventPublisher} for macOS
 *
 * @author <a href="mailto:jan.bauerdick@open-xchange.com">Jan Bauerdick</a>
 */
public class MacOSApns2SubscriptionDeliveryTask extends SubscriptionDeliveryTask {

    /**
     * Initializes a new {@link MacOSApns2SubscriptionDeliveryTask}.
     *
     ...
     */
    public MacOSApns2SubscriptionDeliveryTask(Subscription subscription, DriveEvent event, APNClient apnClient, ServiceLookup services) {
    ...
    protected SimpleApnsPushNotification getNotification(DriveEvent event, Subscription subscription, APNClient apnClient) {
        ...
        ApnsHttp2Notification.Builder builder = new ApnsHttp2Notification.Builder(subscription.getToken(), apnClient.optTopic().orElse(null))
            .withCustomField("container-identifier", "NSFileProviderWorkingSetContainerItemIdentifier")
