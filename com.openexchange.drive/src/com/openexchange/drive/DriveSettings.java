...
public class DriveSettings {
    ...
    private String localizedPathToRoot;
    ...
    /**
     * Gets the localized path from driveRootFolder to internal 'real' root folder
     *
    ...
    /**
     * Sets the localized path from driveRootFolder to internal 'real' root folder
     *
     * @param localizedPathToRoot The localized path to set
     */
    public void setLocalizedPathToRoot(String localizedPathToRoot) {
