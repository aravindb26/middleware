...
import static com.openexchange.drive.DriveExceptionMessages.NOT_SYNCHRONIZABLE_DIRECTORY_IN_TRASH_MSG;
...
public enum DriveExceptionCodes implements DisplayableOXExceptionCode {
    ...
    LONG_POLLING_DISABLED("Push via long polling is disabled for user \"%1$s\" in context \"%2$s\".", LONG_POLLING_DISABLED_MSG, Category.CATEGORY_CONFIGURATION, 43),
    ...
    /** The directory \"%1$s\" was moved to trash and is not synchronizable. Please select another directory. */
    NOT_SYNCHRONIZABLE_DIRECTORY_IN_TRASH("Directory in trash: %1$s", NOT_SYNCHRONIZABLE_DIRECTORY_IN_TRASH_MSG, Category.CATEGORY_USER_INPUT, 46),
    ;
