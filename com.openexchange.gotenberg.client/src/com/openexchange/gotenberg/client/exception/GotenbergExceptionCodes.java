...
package com.openexchange.gotenberg.client.exception;
...
/**
 * {@link GotenbergExceptionCodes}
 *
 * @author <a href="mailto:benjamin.gruedelbach@open-xchange.com">Benjamin Gruedelbach</a>
 */
public enum GotenbergExceptionCodes implements DisplayableOXExceptionCode {
    ...
    private static final String PREFIX = "GOTENBERG";
    ...
    GotenbergExceptionCodes(final String message, final Category category, final int detailNumber) {
        this(message, category, detailNumber, null);
    }

    GotenbergExceptionCodes(String message, Category category, int detailNumber, String displayMessage) {
