...
import com.openexchange.database.tombstone.cleanup.config.TombstoneCleanupTimespan;
...
public class TombstoneCleanupActivator extends HousekeepingActivator implements Reloadable {
    ...
    protected synchronized void startBundle() throws Exception {
        ...
        TombstoneCleanupTimespan timespan = new TombstoneCleanupTimespan();
        registerService(PreferencesItemService.class, timespan);
    }
