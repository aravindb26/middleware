...
public final class Autoboxing {
    ...
    /**
     * Converts a char-array into an Character-array.
     *
     * @param charArray char[] to be converted to Character[]
     * @return Character[]
     */
    public static Character[] c2C(char[] charArray) {
        Character[] characterArray = new Character[charArray.length];
        for (int i = 0; i < charArray.length; i++) {
            characterArray[i] = C(charArray[i]);
        }
    ...
    public static int a2i(final Object anything) {
        if (anything == null) {
            throw new IllegalArgumentException("Can't convert null into integer");
        }
        ...
        throw new ClassCastException("Don't know how to turn " + anything + " of class " + anything.getClass().getName() + " into an int.");
    }

    public static boolean a2b(final Object anything) {
        if (anything == null) {
            throw new IllegalArgumentException("Can't convert null into boolean");
        }
        ...
        throw new ClassCastException("Don't know how to turn " + anything + " of class " + anything.getClass().getName() + " into a boolean.");
    }
