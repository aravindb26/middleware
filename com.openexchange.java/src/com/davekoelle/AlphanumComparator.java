...
public class AlphanumComparator implements Comparator<String> {
    ...
    private static ImmutableMap<Locale, Collator> initCollatorOverrides() {
        ...
        Collator defaultJapaneseCollator = Collators.getInstance(Locale.JAPANESE);
        if (null != defaultJapaneseCollator && (defaultJapaneseCollator instanceof RuleBasedCollator)) {
