...
public class ListLsubCollectionTest {
    ...
    public void testCollectionContent() throws Exception {
        ...
        Namespaces namespaces = new Namespaces(List.of(new Namespace("INBOX/", '/')), List.of(new Namespace("user/", '/')), List.of(new Namespace("", '/')));
        ListLsubCollection collection = ListLsubCollection.craftListLsubCollectionFrom(rootList, allList, allLsub, namespaces);
