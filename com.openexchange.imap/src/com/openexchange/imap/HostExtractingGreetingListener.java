...
/**
 * {@link HostExtractingGreetingListener} - Extracts the host name from IMAP server's greeting using a regular expression
...
public class HostExtractingGreetingListener implements GreetingListener {
     ...
     *
     * @param pattern The pattern to use to extract the host name from IMAP server's greeting
     */
