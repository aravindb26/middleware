...
public final class IMAPProtocol extends Protocol {
    ...
    public boolean putIfAbsent(String host, int maxCount) {
        ...
        try {
            return (null == concurrentMap.putIfAbsent(InetAddresses.forString(host), Integer.valueOf(maxCount)));
    ...
    public void remove(String host) {
        ...
        try {
            concurrentMap.remove(InetAddresses.forString(host));
        } catch (UnknownHostException e) {
    ...
    public int getMaxCount(String host, boolean primary) throws OXException {
        ...
        try {
            final Integer mc = concurrentMap.get(InetAddresses.forString(host));
