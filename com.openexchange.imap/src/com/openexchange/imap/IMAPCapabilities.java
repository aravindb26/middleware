...
public class IMAPCapabilities extends MailCapabilities {
    ...
    /**
     * Allows setting meta-data: <code>"METADATA=SIEVE"</code>
     */
    public static final String CAP_METADATA = "METADATA";

    /**
     * Advertises Dovecot IMAP server: <code>"XDOVECOT"</code>
     */
    public static final String CAP_XDOVECOT = "XDOVECOT";
    ...
    private boolean hasXDovecotCapability;
    ...
    /**
     * Sets whether IMAP server appears to be a Dovecot server.
     *
     * @param hasXDovecotCapability <code>true</code> to indicate IMAP server appears to be a Dovecot server; otherwise <code>false</code>
     */
    public void setDovecotServer(boolean hasXDovecotCapability) {
        this.hasXDovecotCapability = hasXDovecotCapability;
    }

    @Override
    public boolean isDovecotServer() {
        return hasXDovecotCapability;
    }
    ...
    @Override
    public boolean hasMailStructure() {
        // Through IMAP BODYSTRUCTURE
        return true;
    }

    /**
     * Sets whether group entities are supported
     *
     * @param hasGroupEntities <code>true</code> to signal support for group entities; otherwise <code>false</code>
     */
    public void setGroupEntities(boolean hasGroupEntities) {
    ...
    /**
     * Sets whether meta-data is supported
     *
     * @param hasMetadata <code>true</code> to signal support for meta-data; otherwise <code>false</code>
     */
