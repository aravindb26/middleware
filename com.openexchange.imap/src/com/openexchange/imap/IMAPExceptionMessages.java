...
public final class IMAPExceptionMessages implements LocalizableStrings {
    ...
    public static final String NO_UPDATE_ACCESS_MSG = "It is not allowed to change any flags of contained messages. Please contact the folder administrator if you wish to be granted extended permissions.";
    ...
    public static final String TOO_MANY_FOLDERS_MSG = "Mail folder \"%1$s\" could not be created since there are too many folders. Please delete a folder in order to create a new one.";

    public static final String SUBSCRIBE_AFTER_CREATE_FAILED_MSG = "Mail folder \"%1$s\" could be successfully created, but subscription of that folder failed.";

    // User attempts to change an IMAP folder permission that is associated with a deputy
    public static final String NO_DEPUTY_PERMISSION_CHANGE = "A deputy permission must not be changed";

    // User attempts to remove an IMAP folder permission that is associated with a deputy
    public static final String NO_DEPUTY_PERMISSION_DELETE = "A deputy permission must not be removed";
