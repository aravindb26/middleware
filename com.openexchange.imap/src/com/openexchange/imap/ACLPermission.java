...
public final class ACLPermission extends MailPermission {
    ...
    private boolean deputyPermission;
    ...
    /**
     * Sets the deputy permission flag.
     *
     * @param deputyPermission The flag to set
     */
    public void setDeputyPermission(boolean deputyPermission) {
     ...
     *
     * @param acl The ACL providing the rights to parse
     * @param imapConfig The IMAP configuration
     */
    public void parseRightsFrom(ACL acl, IMAPConfig imapConfig) {
        parseRights(acl.getRights(), imapConfig);
        this.acl = acl;
    }
