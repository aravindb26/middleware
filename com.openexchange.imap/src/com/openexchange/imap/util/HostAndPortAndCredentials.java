 ...
 */
public final class HostAndPortAndCredentials implements Comparable<HostAndPortAndCredentials> {
    ...
    @Override
    public int compareTo(HostAndPortAndCredentials other) {
