    ...
    public static final MailFolder loadFolder(String fullName, IMAPFolderStorage folderStorage, IMAPFolder imapFolder) throws OXException {
        ...
        try {
            ...
            if (MailFolder.ROOT_FOLDER_ID.equals(fullName)) {
                ...
                boolean exists = "INBOX".equals(imapFullName) || ListLsubCache.getCachedLISTEntry(imapFullName, folderStorage.getAccountId(), f, session, folderStorage.getImapConfig().getIMAPProperties()).exists();
                if (!exists) {
