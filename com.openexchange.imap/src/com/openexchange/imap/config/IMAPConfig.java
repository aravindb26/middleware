...
public final class IMAPConfig extends MailConfig {
        ...
        if (imapCapabilities == null) {
            synchronized (this) {
                ...
                try {
                    ...
                    Map<String, String> caps = response.getMap();
    ...
    public boolean isSupportsACLs() {
        ...
        BoolCapVal supportsACLs = mailProperties == null ? IMAPProperties.getInstance().getSupportsACLs() : mailProperties.getSupportsACLs();
        if (BoolCapVal.AUTO.equals(supportsACLs)) {
            Map<String, String> capabilities = this.capabilities;
            if (capabilities != null) {
                return capabilities.containsKey("ACL");
            }
        }
        return BoolCapVal.TRUE.equals(supportsACLs);
    }
    ...
    public InetAddress getImapServerAddress() throws OXException {
        if (null == imapServerAddress) {
            try {
                imapServerAddress = InetAddresses.forString(imapServer);
