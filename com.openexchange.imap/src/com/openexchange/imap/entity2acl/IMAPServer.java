...
public enum IMAPServer {
    ...
    COURIER("Courier", CourierEntity2ACL.getInstance(), new ArgumentGenerator() {
        ...
        @Override
        public Object[] getArguments(int accountId, String serverUrl, int sessionUser, String fullname, char separator, String[] otherUserNamespaces, String[] publicNamespaces, boolean secondaryAccount, boolean resolve) {
            return new Object[] { Integer.valueOf(accountId), serverUrl, Integer.valueOf(sessionUser), fullname, Character.valueOf(separator), otherUserNamespaces, publicNamespaces, Boolean.valueOf(secondaryAccount), Boolean.valueOf(resolve) };
        }
    }, new GreetingMatcher() {
    ...
    CYRUS("Cyrus", CyrusEntity2ACL.getInstance(), new ArgumentGenerator() {
        ...
        @Override
        public Object[] getArguments(int accountId, String serverUrl, int sessionUser, String fullname, char separator, String[] otherUserNamespaces, String[] publicNamespaces, boolean secondaryAccount, boolean resolve) {
            return new Object[] { Integer.valueOf(accountId), serverUrl, Integer.valueOf(sessionUser), Boolean.valueOf(secondaryAccount), Boolean.valueOf(resolve) };
        }
    }, new GreetingMatcher() {
     ...
     * @param secondaryAccount Whether denoted account is a secondary one
     * @param resolve Whether ACL entities or system users need to be resolved
     * @return The needed arguments to reliably map an ACL entity to a system user and vice versa
     */
    public Object[] getArguments(int accountId, String serverUrl, int sessionUser, String fullname, char separator, String[] otherUserNamespaces, String[] publicNamespaces, boolean secondaryAccount, boolean resolve) {
        return argumentGenerator.getArguments(accountId, serverUrl, sessionUser, fullname, separator, otherUserNamespaces, publicNamespaces, secondaryAccount, resolve);
    }
