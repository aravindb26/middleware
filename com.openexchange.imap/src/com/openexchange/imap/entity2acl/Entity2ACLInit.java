...
public final class Entity2ACLInit implements Initialization {
    ...
    public void start() throws OXException {
        ...
        try {
            ...
            throw Entity2ACLExceptionCode.CLASS_NOT_FOUND.create(e);
        } catch (InstantiationException | IllegalAccessException e) {
            throw Entity2ACLExceptionCode.INSTANTIATION_FAILED.create(e);
        }
    }
    ...
    public void stop() throws OXException {
        if (!started.compareAndSet(true, false)) {
            LOG.error("{} cannot be stopped since it has not been started before", Entity2ACLInit.class.getName());
            return;
        }
        implementingClass = null;
