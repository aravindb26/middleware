 ...
 * @since v7.10.5
 */
public class ServerVersionCall extends AbstractGetCall<Version> {
    ...
    @Override
    public HttpResponseParser<Version> getParser() {
     ...
     * @since v7.10.5
     */
    private final static class ServerVersionParser extends AbstractHttpResponseParser<Version> {
        ...
        @Override
        public Version parse(CommonApiResponse commonResponse, HttpContext httpContext) throws OXException, JSONException {
