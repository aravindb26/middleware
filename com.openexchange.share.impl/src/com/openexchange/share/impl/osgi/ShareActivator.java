...
public class ShareActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        String cryptKey = getService(ConfigurationService.class).getProperty("com.openexchange.share.cryptKey");
        if (Strings.isEmpty(cryptKey)) {
            throw OXException.general("Property \"com.openexchange.share.cryptKey\" is not set");
        }
        ...
        registerService(QuotaProvider.class, new InviteGuestsQuotaProvider(this));
        {
            ...
            registerService(Remote.class, new ShareRMIServiceImpl(shareService, this), serviceProperties);
        }
        ...
        registerService(EventHandler.class, xctxSessionCache, singletonDictionary(EventConstants.EVENT_TOPIC, new String[] { SessiondEventConstants.TOPIC_REMOVE_SESSION, SessiondEventConstants.TOPIC_REMOVE_CONTAINER }));
