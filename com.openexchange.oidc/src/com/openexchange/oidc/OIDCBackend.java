...
public interface OIDCBackend {
    ...
    /**
     * Validate the given logout Token.
     * 
     * @param logoutToken The {@link JWT} to validate
     * @return A valid {@link LogoutTokenClaimsSet}
     * @throws OXException If something fails
     */
    LogoutTokenClaimsSet validateLogoutToken(JWT logoutToken) throws OXException;
     ...
     *
     * @param authenticationRequest An authentication request object containing the information needed for login
     * @param tokens The {@link OIDCTokenResponse} with additional information
     * @return The {@link AuthenticationInfo}
     * @throws OXException If something fails
     */
    AuthenticationInfo resolveAuthenticationResponse(com.openexchange.authentication.AuthenticationRequest authenticationRequest, OIDCTokenResponse tokens) throws OXException;

    /**
     * Resolve the given {@link Authenticated} to an {@link AuthenticationInfo} with all needed user information. Indirectly called from
     * {@link #resolveAuthenticationResponse} after the ID token was extracted and resolved.
     *
     * @param loginInfo The {@link Authenticated} with login information
     * @return The {@link AuthenticationInfo}
     * @throws OXException If something fails
     */
    AuthenticationInfo resolveLoginInfo(Authenticated loginInfo) throws OXException;

    /**
     * Extracts the user/context information from the supplied ID token, using the configured lookup claims. Indirectly called from
     * {@link #resolveAuthenticationResponse} after the ID token was extracted.
     * 
     * @param idToken The ID token to extract the user/context name for
     * @return The extracted login information
     * @throws OXException If extraction fails for any reason
     */
    Authenticated extractLoginInfo(JWT idToken) throws OXException;
     ...
     * @param tokenMap The {@link Map} with the tokens that should be written into the session
     * @throws OXException If anything fails
     */
