...
public interface OIDCWebSSOProvider {
    ...
    /**
     * Processes a <i>back-channel</i> logout request from the OP.
     * 
     * @param request The incoming HTTP servlet request
     * @param response The associated HTTP response
     */
    void backchannelLogout(HttpServletRequest request, HttpServletResponse response) throws OXException;

    /**
     * Processes a <i>front-channel</i> logout request from the OP.
     * 
     * @param request The incoming HTTP servlet request
     * @param response The associated HTTP response
     */
    void frontchannelLogout(HttpServletRequest request, HttpServletResponse response) throws OXException;
