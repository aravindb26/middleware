...
public class TokenLoginActivatorTest {
    ...
    public void setUp() throws Exception {
     ...
     @Test
     public void testStartBundle_EverythingFine_ThreeServicesRegistered() throws Exception {
        PowerMockito.when(B(hazelcastConfigurationService.isEnabled())).thenReturn(Boolean.FALSE);

        this.tokenLoginActivator.startBundle();

        ServiceMockActivatorAsserter.verifyAllServicesRegistered(this.tokenLoginActivator, 3);
