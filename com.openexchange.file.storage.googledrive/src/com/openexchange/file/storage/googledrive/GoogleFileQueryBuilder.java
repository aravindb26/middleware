...
public class GoogleFileQueryBuilder {
    ...
    /**
     * Extends a query to search modification time stamps greater than the given one.
     *
     * @param updateSince The time stamp of the modification date to search
     * @return The query
     */
    public GoogleFileQueryBuilder modificationDateGreaterThan(long updateSince) {
        return and().append(" modifiedDate > ").quote().append(DATE_FORMAT.format(updateSince)).quote();
    }
