...
public class DatabaseServiceRegisterer implements ServiceTrackerCustomizer<Object, Object> {
    ...
    public synchronized Object addingService(final ServiceReference<Object> reference) {
        ...
        if (obj instanceof LeanConfigurationService) {
            leanConfigService = (LeanConfigurationService) obj;
        }
        ...
        if (needsRegistration && !Initialization.getInstance().isStarted()) {
            ...
            try {
                ...
                databaseService = Initialization.getInstance().start(configService, leanConfigService, configViewFactory, migrationService, connectionListeners, configuration, reloader, context);
