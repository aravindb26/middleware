...
public final class Management {
    ...
    public Management(Timer timer) {
        super();
        this.timer = timer;
    }

    public synchronized void removeManagementService() {
        unregisterMBeans();
     ...
     */
    private void registerPool(@NonNull final String name, final ConnectionPool pool) {
    ...
    private void registerOverview() {
        try {
            if (null != overview && null != managementService) {
     ...
     */
    private void unregisterMBean(@NonNull final String name) {
        final ManagementService service = managementService;
        if (null == service) {
            return;
        }
     ...
     */
    private static @NonNull String createMBeanName(final int poolId) {
        switch (poolId) {
