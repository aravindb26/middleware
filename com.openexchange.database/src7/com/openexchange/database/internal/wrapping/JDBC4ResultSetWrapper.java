...
public abstract class JDBC4ResultSetWrapper implements ResultSet {
    ...
    private static class LoggerHolder {
        static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(JDBC4ResultSetWrapper.class);
    }
    ...
    private boolean logBigResultSet;
    ...
    public boolean next() throws SQLException {
        ...
        if (next) {
            if (logBigResultSet && ++rowCount > Databases.PAGINATION_LIMIT) {
                LoggerHolder.LOGGER.warn("Big result set through query: {}. Consider chunking...", Databases.getSqlStatement(stmt, "<no-query-available>"), new Throwable("Big result set detected"));
                logBigResultSet = false;
            }
        }
        return next;
    }
