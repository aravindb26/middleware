...
public class ReportClientBase extends AbstractJMXTools {
        ...
        try {
            ...
            if (report == null) {
                ...
                if (errorReport == null) { // no successful and no error report available
                    ...
                    String error = (JSONServices.parseObject((String) errorReport.get("data")).get("error")).toString();
                    JSONObject errors = JSONServices.parseObject(error.trim());
    ...
    private void printASReport(CompositeData report) {
        try {
            ...
            System.out.println("\n------ report -------");
            JSONObject data = JSONServices.parseObject((String) report.get("data"));
