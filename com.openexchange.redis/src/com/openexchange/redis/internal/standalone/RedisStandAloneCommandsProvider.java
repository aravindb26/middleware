...
/**
 * {@link RedisStandAloneCommandsProvider} - The commands provider for a Stand-Alone connection.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class RedisStandAloneCommandsProvider implements RedisCommandsProvider {

    private final StatefulRedisConnection<String, InputStream> connection;

    /**
     * Initializes a new {@link RedisStandAloneCommandsProvider}.
     *
     * @param connection The connection to use
     */
    public RedisStandAloneCommandsProvider(StatefulRedisConnection<String, InputStream> connection) {
        super();
