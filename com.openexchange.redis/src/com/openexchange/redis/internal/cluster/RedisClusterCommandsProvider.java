...
/**
 * {@link RedisClusterCommandsProvider} - The commands provider for a Cluster connection.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class RedisClusterCommandsProvider implements RedisCommandsProvider {

    private final StatefulRedisClusterConnection<String, InputStream> connection;

    /**
     * Initializes a new {@link RedisClusterCommandsProvider}.
     *
     * @param connection The connection to use
     */
    public RedisClusterCommandsProvider(StatefulRedisClusterConnection<String, InputStream> connection) {
        super();
