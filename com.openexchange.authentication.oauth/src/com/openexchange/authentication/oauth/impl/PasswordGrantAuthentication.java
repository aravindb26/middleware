 ...
 * @since v7.10.3
 */
public class PasswordGrantAuthentication extends OAuthRequestIssuer {
    ...
    public ResourceOwnerPasswordCredentialsGrant getAuthorizationGrant(LoginInfo loginInfo) {
    ...
    public AccessTokenResponse validateResponse(TokenRequest request, TokenResponse response, String username) throws OXException {
    ...
    public EnhancedAuthenticated authenticate(LoginInfo loginInfo, AccessTokenResponse tokenResponse) throws OXException {
    ...
    private ContextWrapper resolveContext(LoginInfo loginInfo, AccessTokenResponse tokenResponse) throws OXException, IllegalArgumentException {
        ...
        if (contextId < 0) {
            ...
            throw LoginExceptionCodes.INVALID_CREDENTIALS.create(contextInfo);
        }
    ...
    public OAuthAuthenticationConfig getConfig() {
        return config;
    }
