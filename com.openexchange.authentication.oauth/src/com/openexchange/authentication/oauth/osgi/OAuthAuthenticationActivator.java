...
import com.openexchange.authentication.oauth.impl.OAuthAuthenticationService;
...
public class OAuthAuthenticationActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        registerService(AuthenticationService.class, new OAuthAuthenticationService(passwordGrantAuthentication, this));
