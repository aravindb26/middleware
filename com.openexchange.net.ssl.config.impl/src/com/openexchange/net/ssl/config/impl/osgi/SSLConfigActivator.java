...
public class SSLConfigActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            if (configService.getBooleanProperty(SSLProperties.SECURE_CONNECTIONS_DEBUG_LOGS_ENABLED)) {
                System.setProperty("javax.net.debug", "ssl:record");
                org.slf4j.LoggerFactory.getLogger(SSLConfigActivator.class).info("Enabled SSL debug logging.");
            }

            UserAwareSSLConfigurationServiceRegisterer registerer = new UserAwareSSLConfigurationServiceRegisterer(configService, context);
            ...
            SSLConfigurationService sslConfigurationService;
            {
                ...
                if (TrustLevel.TRUST_ALL.equals(trustLevel)) {
                    ...
                    registerService(Reloadable.class, new SSLPropertiesReloadable(restrictedSslConfigurationService, configService));
                }
            }
