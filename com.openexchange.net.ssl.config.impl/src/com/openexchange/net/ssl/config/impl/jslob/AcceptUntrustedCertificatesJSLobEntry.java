...
public class AcceptUntrustedCertificatesJSLobEntry implements JSlobEntry {
    ...
    public void setValue(Object value, Session sessiond) throws OXException {
        ...
        if (!allowedToDefineTrustLevel) {
            LOG.debug("Setting {} has been disabled due to configuration ('{}'). The request will be ignored.", UserAwareSSLConfigurationService.USER_ATTRIBUTE_NAME, UserAwareSSLConfigurationService.USER_CONFIG_ENABLED_PROPERTY.getFQPropertyName());
            return;
        }
