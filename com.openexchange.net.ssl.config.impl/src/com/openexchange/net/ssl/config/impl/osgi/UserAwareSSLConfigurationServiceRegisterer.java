...
public class UserAwareSSLConfigurationServiceRegisterer implements ServiceTrackerCustomizer<Object, Object> {
     ...
     */
    public UserAwareSSLConfigurationServiceRegisterer(LeanConfigurationService configService, BundleContext context) {
        super();
    ...
    private void update() {
        ...
        UserAwareSSLConfigurationImpl userAwareSSLConfigurationImpl = new UserAwareSSLConfigurationImpl(userService, contextService, configService);
