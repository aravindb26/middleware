...
public class UserAwareSSLConfigurationImpl implements UserAwareSSLConfigurationService {
     ...
     */
    public UserAwareSSLConfigurationImpl(UserService userService, ContextService contextService, LeanConfigurationService leanConfigurationService) {
        this.userService = userService;
        this.contextService = contextService;
        this.configService = leanConfigurationService;
    }
    ...
    public boolean isAllowedToDefineTrustLevel(int userId, int contextId) {
        ...
        return configService.getBooleanProperty(userId, contextId, USER_CONFIG_ENABLED_PROPERTY);
    }
