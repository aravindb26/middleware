...
public enum DatabaseCleanUpExceptionCode implements DisplayableOXExceptionCode {
    ...
    /**
     * No schedule specified. Please set "com.openexchange.database.cleanup.schedule" configuration option.
     */
    NO_SCHEDULE_SPECIFIED("No schedule specified. Please set \"" + DatabaseCleanUpProperty.SCHEDULE.getFQPropertyName() + "\" configuration option.", CATEGORY_CONFIGURATION),
    ;
