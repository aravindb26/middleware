...
public interface CleanUpExecution {
    ...
    /**
     * Signals whether this clean-up job considers all database schemas or if only a single invocation is sufficient.
     *
     * @return <code>true</code> if database schemas are considered; otherwise <code>false</code> if only a single invocation is sufficient
     */
    default boolean considersAllDatabaseSchemas() {
        return true;
    }
