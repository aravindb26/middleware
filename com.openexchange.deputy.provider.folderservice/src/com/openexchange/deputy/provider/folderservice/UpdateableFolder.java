...
/**
 * {@link UpdateableFolder} - An updateable folder.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class UpdateableFolder implements SetterAwareFolder, ParameterizedFolder {
    ...
    /**
     * Initializes an empty {@link UpdateableFolder}.
     */
    public UpdateableFolder() {
        super();
        createdBy = -1;
        modifiedBy = -1;
        total = -1;
    ...
    public Object clone() {
        try {
            final UpdateableFolder clone = (UpdateableFolder) super.clone();
