...
final class WebSocketHits implements Hits {
     ...
     */
    WebSocketHits(Set<WebSocketClient> clients, int userId, int contextId, String topic) {
        super();
    ...
    public Iterator<Hit> iterator() {
        return new Iter(clients.iterator(), userId, contextId, topic);
    }
    ...
    private static final class Iter implements Iterator<Hit> {
         ...
         */
        Iter(Iterator<WebSocketClient> iterator, int userId, int contextId, String topic) {
            super();
        ...
        public Hit next() {
            ...
            return new WebSocketHit(client.getClient(), userId, contextId, topic);
        }
