...
public class Bug66234Test extends CalDAVTest {
    ...
    public void testExceptionWithInvalidRecurrenceId(String authMethod) throws Exception {
        /*
        ...
        assertNotEquals(StatusCodes.SC_CREATED, responseCode, "response code wrong");
        /*
        ...
        assertTrue(null == changeExceptions || changeExceptions.isEmpty(), "no change exceptions expected");
        iCalResource = get(uid);
        assertEquals(1, iCalResource.getVEvents().size(), "Expected one VEVENT component only");
        assertEquals(uid, iCalResource.getVEvent().getUID(), "UID wrong");
    }
}
