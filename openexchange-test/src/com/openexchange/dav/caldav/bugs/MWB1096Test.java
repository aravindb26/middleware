...
public class MWB1096Test extends Abstract2UserCalDAVTest {
    ...
    public void testInvitePropertyEscaping(String authMethod) throws Exception {
        /*
        ...
        String uri = webDAVClient.getBaseURI() + Config.getPathPrefix() + "/caldav/" + encodeFolderID(String.valueOf(sharedFolder.getObjectID()));
        ...
        assertTrue(found, userData.getDisplayName() + " not found");
    }
