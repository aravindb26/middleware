...
public class Bug44167Test extends Abstract2UserCalDAVTest {
    ...
    public void testAcknowledgeForeignRecurringReminder(String authMethod) throws Exception {
        /*
        ...
        assertEquals(StatusCodes.SC_FORBIDDEN, putICalUpdate(iCalResource), "response code wrong");
    }
