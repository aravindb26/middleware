...
public class Bug55916Test extends CalDAVTest {
    ...
    public void testKOrganizer(String authMethod) throws Exception {
        /*
        ...
        String iCal = // @formatter:off
            ...
            "END:VCALENDAR\r\n"
        ; // @formatter:on
        assertEquals(StatusCodes.SC_CREATED, putICal(getDefaultFolderID(), filename, iCal), "response code wrong");
        /*
        ...
        assertEquals(StatusCodes.SC_FORBIDDEN, putICal(getDefaultFolderID(), filename2, iCal), "response code wrong");
    }
