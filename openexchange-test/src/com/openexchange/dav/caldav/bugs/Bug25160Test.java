...
public class Bug25160Test extends Abstract2UserCalDAVTest {
    ...
    public void testOwner(String authMethod) throws Exception {
        /*
        ...
        propFind = new PropFindMethod(webDAVClient.getBaseURI() + Config.getPathPrefix() + "/caldav/" + encodeFolderID(String.valueOf(subfolder.getObjectID())), DavConstants.PROPFIND_BY_PROPERTY, props, DavConstants.DEPTH_0);
        response = assertSingleResponse(super.webDAVClient.doPropFind(propFind));
        assertTrue(response.getPropertyNames(HttpServletResponse.SC_NOT_FOUND).contains(PropertyNames.OWNER), "owner found");
    }
