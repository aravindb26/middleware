...
public class Bug68847Test extends CalDAVTest {
    ...
    public void testSyncCategories(String authMethod) throws Exception {
        /*
        ...
        assertEquals(Appointment.ABSENT, appointment.getShownAs(), "shown as wrong");
        /*
        ...
        assertEquals("OOF", iCalResource.getVEvent().getPropertyValue("X-MICROSOFT-CDO-BUSYSTATUS"), "X-MICROSOFT-CDO-BUSYSTATUS wrong");
    }
