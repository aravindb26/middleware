...
public class MkCalendarTest extends CalDAVTest {
    ...
    public void testOptions(String authMethod) throws Exception {
        /*
        ...
        try {
            ...
            assertEquals(StatusCodes.SC_OK, webDAVClient.executeMethod(options), "unexpected http status");
    ...
    @ParameterizedTest
    @MethodSource("availableAuthMethods")
    public void testCreateCalendar(String authMethod) throws Exception {
        /*
         * prepare OAuthClient if authMethod is OAuth
         */
        if(authMethod.equals("OAuth")) prepareOAuthClient();
        ...
        PropFindMethod propFind = new PropFindMethod(webDAVClient.getBaseURI() + Config.getPathPrefix() + "/caldav/", DavConstants.PROPFIND_BY_PROPERTY, props, DavConstants.DEPTH_1);
