...
public class CurrentUserPrincipalTest extends CardDAVTest {
    ...
    public void testDiscoverCurrentUserPrincipal(String authMethod) throws Exception {
        /*
        ...
        final PropFindMethod propFind = new PropFindMethod(super.webDAVClient.getBaseURI() + Config.getPathPrefix() + "/", DavConstants.PROPFIND_BY_PROPERTY, props, DavConstants.DEPTH_0);
        ...
        assertTrue(principal.contains("/" + getClient().getValues().getUserId()), "username not found in href child of " + PropertyNames.CURRENT_USER_PRINCIPAL);
    ...
    @ParameterizedTest
    @MethodSource("availableAuthMethods")
    public void testDiscoverCurrentUserPrincipalAtUnknown(String authMethod) throws Exception {
        /*
         * prepare OAuthClient if authMethod is OAuth
         */
        if(authMethod.equals("OAuth")) prepareOAuthClient();
        ...
        props.add(PropertyNames.PRINCIPAL_URL);
        props.add(PropertyNames.RESOURCETYPE);
        final PropFindMethod propFind = new PropFindMethod(super.webDAVClient.getBaseURI() + Config.getPathPrefix() + "/gibt/es/nicht", DavConstants.PROPFIND_BY_PROPERTY, props, DavConstants.DEPTH_0);
        super.webDAVClient.doPropFind(propFind, StatusCodes.SC_NOT_FOUND);
    }
}
