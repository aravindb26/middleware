...
public class MWB346Test extends CardDAVTest {
    ...
    public void testCreateInGAB(String authMethod) throws Exception {
        /*
         ...
         */
        assertEquals(StatusCodes.SC_CREATED, putVCard(uid, vCard, gabFolderId), "response code wrong");
        /*
        ...
        assertTrue(found, "contact not reported as deleted in GAB");
    }
