...
/**
 * {@link ConfigAwareProvisioningService} - Small helper class to determine the configured {@link ProvisioningMode}
 *
 * @author <a href="mailto:sebastian.lutz@open-xchange.com">Sebastian Lutz</a>
 * @since v8.0.0
 */
public final class ConfigAwareProvisioningService {

    /**
     * Gets the configured {@link ProvisioningService}
     *
     * @return The {@link ProvisioningService}
     */
    public static ProvisioningService getService() {
        return SoapProvisioningService.getInstance();
    }
}
