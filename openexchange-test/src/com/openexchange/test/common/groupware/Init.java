...
import com.openexchange.charset.internal.ModifyCharsetExtendedProvider.Result;
...
public final class Init {
    ...
    private static void startAndInjectConfigViewFactory() {
        ConfigCascade cascade = new ConfigCascade(false);
    ...
    private static void startVersionBundle() throws Exception {
        ...
        com.openexchange.version.internal.VersionServiceImpl versionService = new com.openexchange.version.internal.VersionServiceImpl();
    ...
    private static void startAndInjectBasicServices() throws OXException {
        ...
        if (null == TestServiceRegistry.getInstance().getService(UserConfigurationService.class)) {
            try {
                ...
                Result result = ModifyCharsetExtendedProvider.modifyCharsetExtendedProvider();
                final CollectionCharsetProvider collectionCharsetProvider = result.getCollectionCharsetProvider();
    ...
    public static void startAndInjectDatabaseBundle() throws OXException {
        if (null == services.get(DatabaseService.class)) {
            ...
            final LeanConfigurationService leanConfigurationService = (LeanConfigurationService) services.get(LeanConfigurationService.class);
            ...
            final DatabaseService dbService = com.openexchange.database.internal.Initialization.getInstance().start(configurationService, leanConfigurationService, configViewFactory, null, ServiceListings.emptyList(), configuration, reloader, null);
