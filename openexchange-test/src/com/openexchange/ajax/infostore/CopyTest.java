...
public class CopyTest extends InfostoreAJAXTest {
    ...
    public void testCopy() throws Exception {
        ...
        for (Map.Entry<String, Object> entry : meta.entrySet()) {
            ...
            if (!skipKeys.contains(key)) {
                assertEquals(orig.getMeta().get(key).toString(), copy.getMeta().get(key).toString(), key + " seems to have a wrong value");
            }
        }
    }
    ...
    public void virtualFolderTest(int folderId) throws Exception {
        try {
            ...
            assertTrue(x.getMessage().contains("IFO-1700"), x.getMessage());
        }
