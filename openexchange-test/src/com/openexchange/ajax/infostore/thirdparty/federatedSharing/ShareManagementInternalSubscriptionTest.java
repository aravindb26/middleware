...
public class ShareManagementInternalSubscriptionTest extends AbstractShareManagementTest {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        smApi2 = new ShareManagementApi(testUser2.getApiClient(Host.SINGLENODE));
    }
    ...
    public void testInternalLink_Subscribed() throws Exception {
        ...
        updatedPermissions.add(prepareUser(testUser2));
         ...
         */
        String shareLink = receiveShareLink(testUser2.getApiClient(Host.SINGLENODE), testUser.getLogin());
        ...
        SubscribeShareResponse subscribeShareResponse = smApi2.subscribeShare(body);
        MatcherAssert.assertThat(subscribeShareResponse.getErrorDesc(), is(notNullValue()));
    }
