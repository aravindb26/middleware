...
public class WebDAVTest extends AbstractFileStorageAccountTest {
     ...
     */
    private static final String WEB_DAV_URL = String.format(
            "%s://%s:%s/servlet/webdav.infostore",
            AJAXConfig.getProperty(AJAXConfig.Property.PROTOCOL),
            AJAXConfig.getProperty(AJAXConfig.Property.SINGLENODE_HOSTNAME),
            AJAXConfig.getProperty(AJAXConfig.Property.SERVER_PORT)
    );
    ...
    private String getWebDAVFolderId(String path) throws ApiException {
        final String infostoreRootFolderName = getPrivateInfostoreFolderName(getApiClient(Host.SINGLENODE)).replace(" ", "%20");
    ...
    public TestClassConfig getTestConfig() {
        return TestClassConfig.builder().withContextConfig(getContextConfig()).build();
    }
