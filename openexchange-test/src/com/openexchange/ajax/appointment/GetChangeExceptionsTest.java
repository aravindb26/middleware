...
public class GetChangeExceptionsTest extends AbstractAJAXSession {
    ...
    public void testGetChangeExceptions() throws Exception {
        ...
        assertEquals(2, exceptions.size(), "Wrong amount of returned exceptions.");

        boolean foundFirst = false;
        boolean foundSecond = false;
        for (Appointment exception : exceptions) {
            assertEquals(appointment.getObjectID(), exception.getRecurrenceID(), "Wrong recurrence id.");
        ...
        assertTrue(foundFirst, "Missing exception.");
        assertTrue(foundSecond, "Missing exception.");
    }
    ...
    public void testPermission() throws Exception {
        ...
        assertTrue(response.hasError(), "Missing error.");
        OXException oxException = response.getException();
        assertEquals(OXCachingExceptionCode.CATEGORY_PERMISSION_DENIED, oxException.getCategory(), "Wrong error.");
    }
