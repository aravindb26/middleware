...
public final class Bug12614Test extends AbstractAJAXSession {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        assertFalse(boss == null, "Could not acquire enough users");
        assertFalse(secretary == null, "Could not acquire enough users");
        assertFalse(thirdUser == null, "Could not acquire enough users");
    ...
    public void testDeleteException() throws Throwable {
        ...
        assertFalse(response.hasError(), "Secretary is not able to delete a change exception in a " + "shared folder: " + cause);
    }
