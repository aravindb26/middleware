    ...
    public void testBug10760() {
        ...
        for (int a = 0; a < appointmentArray.length; a++) {
            if (appointmentArray[a].getObjectID() == newObjectId) {
                assertEquals(objectId, appointmentArray[a].getRecurrenceID(), "recurrence id is not equals expected");
                assertEquals(2, appointmentArray[a].getRecurrencePosition(), "recurrence pos is not equals expected");
            }
        }
    }
