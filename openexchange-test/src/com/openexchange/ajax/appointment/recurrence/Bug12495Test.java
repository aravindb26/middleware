...
public class Bug12495Test extends AbstractAJAXSession {
    ...
    public void testShouldNotLoseRecurrenceDatePositionWhenOtherUserDeletesOneOccurrence() throws OXException, IOException, JSONException {
        ...
        try {
            ...
            assertTrue((exceptionId != -1) && (recurrenceDatePosition != -1), "Should be able to find both a recurrence_date_position and an exception_id");
            ...
            assertEquals(recurrenceDatePosition, recurrence_date_position_in_result, "Must contain matching recurrence_date_position in list request");
            ...
            assertTrue(exception.containsRecurrenceDatePosition(), "Must contain recurrence_date_position in get request");
