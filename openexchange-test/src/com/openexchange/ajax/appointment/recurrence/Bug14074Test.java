...
public final class Bug14074Test extends AbstractAJAXSession {
    ...
    public void testDailyFullTimeUntil() throws Throwable {
        ...
        assertFalse(-1 == recurrencePosition, "Changed appointment not found.");
        // Load appointment
        ...
        assertEquals(changed.getStartDate(), toTest.getStartDate(), "Start date is not 1400.");
        assertEquals(changed.getEndDate(), toTest.getEndDate(), "Start date is not 1500.");
    }
