...
public class Bug21620Test extends AbstractAJAXSession {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        /*
         * prepare appointment with organizer set to user A ("folder owner")
         */
    ...
    public void testBug21620() throws Exception {
        ...
        /*
         * as user B, organizer in created appointment
         */
        ...
        assertEquals(clientA.getValues().getUserId(), loadedAppointment.getOrganizerId(), "Wrong organizer ID");
        /*
