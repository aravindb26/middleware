...
public class Bug16249Test extends AttachmentTest {
    ...
    public void testBug16249() throws Exception {
        ...
        assertTrue(beforeAttach.compareTo(afterAttach) < 0, "Wrong last modified after attach");
        assertTrue(beforeAttach.compareTo(afterDetach) < 0, "Wrong last modified after detach");
        assertTrue(afterAttach.compareTo(afterDetach) < 0, "Wrong last modified after detach");
    }
}
