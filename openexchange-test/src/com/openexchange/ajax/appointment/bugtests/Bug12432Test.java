...
public class Bug12432Test extends AbstractAJAXSession {
    ...
    public void testChangeFree() throws Throwable {
        ...
        try {
            ...
            assertFalse(updateResponse.hasConflicts(), "Update on free Appointment should not conflict.");
        ...
        try {
            ...
            if (updateResponse.hasConflicts()) {
                for (ConflictObject conflict : updateResponse.getConflicts()) {
                    assertFalse(conflict.getId() == appointmentFree.getObjectID(), "Update on Appointment should not conflict with free Appointment.");
                }
            }
