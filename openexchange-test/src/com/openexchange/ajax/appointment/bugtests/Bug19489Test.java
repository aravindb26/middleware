...
public class Bug19489Test extends AbstractAJAXSession {
    ...
    public void testBug19489() throws Exception {
        ...
        assertEquals(appointment.getStartDate(), loadedAppointment.getStartDate(), "Wrong start date");
        assertEquals(appointment.getEndDate(), loadedAppointment.getEndDate(), "Wrong end date");
    }
