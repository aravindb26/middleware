...
public class Bug48149Test extends AbstractAJAXSession {
    ...
    public void testLoadAppointmentFromUserWithShared() {
        ...
        assertTrue(ctm3.getLastResponse().hasError(), "Expected error.");
        assertTrue(ctm3.getLastResponse().getErrorMessage().contains("ermission"), "Excpected something with permissions. (" + ctm3.getLastResponse().getErrorMessage() + ")");
    }
