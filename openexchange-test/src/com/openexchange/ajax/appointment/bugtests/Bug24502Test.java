...
public class Bug24502Test extends AbstractAJAXSession {
    ...
    public void testBug() throws Exception {
        ...
        assertTrue(getResponse.hasError(), "Appointment should be deleted completely.");
        assertTrue(getResponse.getErrorMessage().contains("not found"), "Appointment should be deleted completely.");
    }
