...
public class Bug53073Test extends AbstractAJAXSession {
    ...
    public void testBug53073() throws Exception {
        ...
        assertTrue(catm2.getLastResponse().hasError(), "Expected error.");
        assertTrue(catm2.getLastResponse().getException().similarTo(OXCalendarExceptionCodes.LOAD_PERMISSION_EXCEPTION_2.create()), "Wrong exception");
