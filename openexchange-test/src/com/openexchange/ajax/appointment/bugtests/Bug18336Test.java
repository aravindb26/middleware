...
public class Bug18336Test extends AbstractAJAXSession {
    ...
    public void testBug18336() throws Exception {
        ...
        assertEquals(updateAppointment.getStartDate(), loadedAppointment.getStartDate(), "Wrong start date");
        assertEquals(updateAppointment.getEndDate(), loadedAppointment.getEndDate(), "Wrong end date");
    }
