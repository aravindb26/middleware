...
public class Bug42018Test extends AbstractAJAXSession {
    ...
    public void testBug42018() throws Exception {
        ...
        assertNotNull(loadedAppointment.getDeleteException(), "Expect delete exception.");
        assertEquals(1, loadedAppointment.getDeleteException().length, "Expect exactly one delete exception");
    }
