...
public class Bug29566Test extends AbstractAJAXSession {
    ...
    private void addParticipantWithExternalOrganizerAndUid(boolean shared) throws Exception {
        ...
        String organizer = "test@extern.example.com";
        ...
        assertTrue(updateResponse.hasError(), "Should fail.");
        String errorCode = updateResponse.getException().getErrorCode();
        if (shared) {
            assertTrue("APP-0062".equals(errorCode) || "CAL-4006".equals(errorCode), "Wrong error.");
        } else {
            assertTrue("APP-0059".equals(errorCode) || "CAL-4006".equals(errorCode), "Wrong error.");
        }
    }
