...
public class Bug17327Test extends AbstractAJAXSession {
    ...
    public void testAlarmInAllRequest() throws Exception {
        ...
        assertEquals(getResponseBeforeUpdate.getAppointment(tz).getAlarm(), alarmValueInt, "Alarm is not equal in All- and GetRequest before update.");
        ...
        assertEquals(getResponseAfterUpdate.getAppointment(tz).getAlarm(), alarmValueInt, "Alarm is not equal in All- and GetRequest after update.");
    }
