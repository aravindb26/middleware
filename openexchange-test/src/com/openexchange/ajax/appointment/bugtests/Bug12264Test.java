...
public class Bug12264Test extends AbstractAJAXSession {
    ...
    public void testBugAsWritten() throws Throwable {
        ...
        try {
            ...
            getAppointment();
            assertEquals(2, appointment.getOccurrence(), "Unexpected occurrence value");
    ...
    private void checkForNoEnd() {
        if (appointment.containsUntil()) {
            assertNull(appointment.getUntil(), "Until exists and is not null. Until: " + appointment.getUntil());
        }

        if (appointment.containsOccurrence()) {
            assertEquals(0, appointment.getOccurrence(), "Occurrences exist and is not 0. Occurrences: " + appointment.getOccurrence());
        }
    }
