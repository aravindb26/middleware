...
public class Bug16292Test extends AbstractAJAXSession {
    ...
    public void testAppointmentAtGet() throws Exception {
        ...
        assertTrue((appointmentJSON.get("number_of_attachments") != null), "Appointment: Number of attachments is null after GetRequest.");
    }
    ...
    public void testTaskAtGet() throws Exception {
        ...
        assertTrue((taskJSON.get("number_of_attachments") != null), "Task: Number of attachments is null after GetRequest.");
    }
    ...
    public void testContactAtGet() throws Exception {
        ...
        assertTrue((contactJSON.get("number_of_attachments") != null), "Contact: Number of attachments is null after GetRequest.");
    }
        ...
        while (it.hasNext()) {
            ...
            if (candidate.getClass().isAssignableFrom(Integer.class)) {
                ...
                if (actual != null && actual.intValue() == appointment.getObjectID()) {
                    assertNotNull(resp.getValue(i, noaColumn), type + ": Number of attachments is null after " + reqType);
                }
