...
public class Bug38079Test extends AbstractAJAXSession {
    ...
    private void runTest(String tzId, int month) throws OXException, IOException, JSONException {
        ...
        assertEquals(D("16." + (month + 1) + "." + year + " 08:00", tz), loadedAppointment.getStartDate(), "Wrong start for month " + (month + 1));
        assertEquals(D("16." + (month + 1) + "." + year + " 09:00", tz), loadedAppointment.getEndDate(), "Wrong end for month " + (month + 1));
    }
