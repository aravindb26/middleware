...
public class Bug13214Test extends AbstractAJAXSession {
    ...
    public void testBugAsWritten() throws Exception {
        ...
        try {
            ...
            try {
                assertTrue(updateResponse.hasError(), "No Exception occurred.");
                OXException e = updateResponse.getException();
                assertTrue(e.similarTo(OXCalendarExceptionCodes.END_DATE_BEFORE_START_DATE.create()), "Wrong Exception");
            } finally {
