...
public class ListTest extends AppointmentTest {
    ...
    public void testList() {
        ...
        assertEquals(3, appointmentArray.size(), "check response array");
    }
    ...
    public void testListWithNoEntries() {
        ...
        assertEquals(0, appointmentArray.size(), "check response array");
    }
    ...
    public void testListWithAllFields() throws Exception {
        ...
        assertEquals(1, appointmentArray.size(), "check response array");
