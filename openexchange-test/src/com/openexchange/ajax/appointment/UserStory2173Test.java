...
public class UserStory2173Test extends AbstractAJAXSession {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        assertFalse(respPriv.hasError(), respPriv.getErrorMessage());
        ...
        assertFalse(respPub.hasError(), respPub.getErrorMessage());
        ...
        assertFalse(folderResponse.hasError(), folderResponse.getErrorMessage());
    ...
    public void testPrivate() throws Exception {
        ...
        assertFalse(insertResponse.hasError(), insertResponse.getErrorMessage());
        ...
        for (UserParticipant user : loadedAppointment.getUsers()) {
            if (user.getIdentifier() == clientB.getValues().getUserId()) {
                assertEquals(Appointment.ACCEPT, user.getConfirm(), "Wrong confirmation status");
            }
        }
    }
