...
public class Bug34552Test extends AbstractJSlobTest {
    ...
    public void testUpdateIsVisibleImmediately() throws Exception {
        ...
        assertEquals(1, tasksWidget.getInt("index"), "Wrong widget index");
        assertEquals(2, mailWidget.getInt("index"), "Wrong widget index");
        assertEquals(3, birthdayWidget.getInt("index"), "Wrong widget index");
        ...
        assertEquals(2, tasksWidget.getInt("index"), "Wrong widget index");
        assertEquals(3, mailWidget.getInt("index"), "Wrong widget index");
        assertEquals(1, birthdayWidget.getInt("index"), "Wrong widget index");
    }
