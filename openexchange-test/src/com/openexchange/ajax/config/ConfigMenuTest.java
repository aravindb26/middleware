...
public class ConfigMenuTest extends AbstractAJAXSession {
    ...
    public void testReadSettings() throws Throwable {
        ...
        assertTrue(settings.length() > 0, "Got no value from server.");
    }
    ...
    public void testHasSpam() throws Throwable {
        ...
        assertTrue(response.hasValue(), "Got no spam-button-enabled flag from server.");
    }
    ...
    public void testTimeZone() throws Throwable {
        ...
        try {
            ...
            assertEquals(testTimeZone, getResponse.getString(), "Written timezone isn't returned from server. Used session id: " + getClient().getSession().getId());
        } finally {
    ...
    public void testBeta() throws Throwable {
        ...
        try {
            getClient().execute(setRequest);
            getResponse = getClient().execute(getRequest);
            assertTrue(testBeta.booleanValue() == getResponse.getBoolean(), "Written beta attribute isn't returned from server.");
        } finally {
    ...
    public void testIdentifier() throws Throwable {
        ...
        assertTrue(userId > 0, "No valid user identifier");
    }
}
