...
public class ShareFolderTest extends Abstrac2UserAJAXSession {
    ...
    public void testShareFolder() throws Throwable {
        ...
        assertTrue(l != null && !l.isEmpty(), "No shared subfolder available for second user " + client2.getValues().getUserId());
        ...
        assertTrue(found, "Folder " + folderId + " not beneath shared folder of second user " + client2.getValues().getUserId());
    }
