...
public class DeleteFolderTest extends AbstractAJAXSession {
    ...
    public void testUnauthorizedDeletion() throws Throwable {
        ...
        assertTrue(l != null && !l.isEmpty(), "No public subfolders available for user " + getClient().getValues().getUserId());
        ...
        assertTrue(found, "Folder " + folderId + " not beneath public folder of user " + getClient().getValues().getUserId());
        ...
        assertTrue(deleteResponse.hasError(), "Delete attempt should have failed");
