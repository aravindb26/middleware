...
public class AppointmentObjectCountTest extends AbstractObjectCountTest {
    ...
    public void testPrivate() throws Exception {
        ...
        assertEquals(0, getCount(client1, folder), "Wrong amount.");
        assertEquals(initialValue, getCount(client2), "Wrong amount.");
        insertAppointments(ctm1, folder);
        assertEquals(3, getCount(client1, folder), "Wrong amount.");
        assertEquals(initialValue + 3, getCount(client2), "Wrong amount.");
    }
    ...
    public void testPublicReadOwn() throws Exception {
        ...
        assertEquals(0, getCount(client1, folder), "Wrong amount.");
        assertEquals(0, getCount(client2, folder), "Wrong amount.");
        insertAppointments(ctm1, folder);
        assertEquals(3, getCount(client1, folder), "Wrong amount.");
        assertEquals(0, getCount(client2, folder), "Wrong amount.");
        insertAppointments(ctm2, folder);
        assertEquals(6, getCount(client1, folder), "Wrong amount.");
        assertEquals(3, getCount(client2, folder), "Wrong amount.");
    }
    ...
    public void testPublicReadAll() throws Exception {
        ...
        insertAppointments(ctm2, folder);
        assertEquals(6, getCount(client1, folder), "Wrong amount.");
        assertEquals(6, getCount(client2, folder), "Wrong amount.");
    ...
    private int getCount(AJAXClient client) throws Exception {
        return getCountTotal(client, client.getValues().getPrivateAppointmentFolder());
    }

    private int getCount(AJAXClient client, FolderObject folder) throws Exception {
        return getCountTotal(client, folder.getObjectID());
    }
