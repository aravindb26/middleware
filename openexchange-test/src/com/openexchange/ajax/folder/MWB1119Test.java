...
public class MWB1119Test extends AbstractConfigAwareAPIClientSession {
    ...
    public void testMoveInAnonymousShareLinkFolderTypeNormal() throws Exception {
        ...
        assertNotNull(linkData, "Precondition failed: No link for the parent folder created.");
        assertNotNull(linkData.getUrl(), "Precondition failed: No link for the parent folder created.");
