...
public class MergeWarningPermissionOnMoveTest extends AbstractFolderMoveWarningTest {
     ...
     */
    @Test
    public void testMoveFromPublicFolderToSharedFolder() {
     ...
     */
    @Test
    public void testMoveFromSharedFolderToPublicFolder() {
        Assertions.assertThrows(AssertionError.class, () -> {
     ...
     */
    @Test
    public void testMoveFromSharedPrivateToSharedPrivate() {
        Assertions.assertThrows(AssertionError.class, () -> {
     ...
     */
    @Test
    public void testMoveFromUnsharedPrivateToPublicFolder() {
        Assertions.assertThrows(AssertionError.class, () -> {
     ...
     */
    @Test
    public void testMoveFromUnsharedPrivateToSharedFolder() {
        Assertions.assertThrows(AssertionError.class, () -> {
            String sourceFolder = createPrivateFolder(null);
            String destinationFolder = sharedFolderId;
            FolderExceptionErrorMessage expectedWarning = FolderExceptionErrorMessage.MOVE_TO_SHARED_WARNING;
     ...
     */
    @Test
    public void testMoveFromUnsharedPrivateToSharedPrivate() {
        Assertions.assertThrows(AssertionError.class, () -> {
            String sourceFolder = createPrivateFolder(null);
     ...
     */
    @Test
    public void testMoveSubfoldersFromPrivateToSharedPrivate() {
        Assertions.assertThrows(AssertionError.class, () -> {
            String sourceFolder = createPrivateFolder(null);
            String folderToMove = createChildFolder(sourceFolder);
            String subfolder1 = createChildFolder(folderToMove, userId2);
     ...
     */
    @Test
    public void testMoveSubfoldersFromSharedPrivateToSharedPrivate() {
        Assertions.assertThrows(AssertionError.class, () -> {
            String sourceFolder = createPrivateFolder(userId2);
            String folderToMove = createChildFolder(sourceFolder);
            String subfolder1 = createChildFolder(folderToMove, userId2);
