...
public class FolderManager {
    ...
    public ArrayList<ArrayList<Object>> listFolders(String parent, String columns, Boolean all) throws ApiException {
        return listFolders(parent, columns, all, null);
    }
     ...
     * @throws ApiException
     */
    public ArrayList<ArrayList<Object>> listFolders(String parent, String columns, Boolean all, Boolean altNames) throws ApiException {
        FoldersResponse resp = foldersApi.getSubFolders(parent, columns, I(all == null || b(all) ? 1 : 0), tree, null, null, altNames, Boolean.FALSE);
    ...
    public String updateFolder(String folderId, FolderData folder, String message) throws ApiException {
        return updateFolder(folderId, folder, message, Boolean.TRUE, Boolean.FALSE, null);
    }
     ...
     * @param folder The folder data to change
     * @param message The optional message to send to a recipient
     * @param cascadePermissions Whether to cascade permissions or not
     * @param autorename Whether to auto rename the folder name or not
     * @param ignoreWarnings Whether to ignore warnings or not
     * @return Te ID of the updated folder
     * @throws ApiException In case of error
     */
    public String updateFolder(String folderId, FolderData folder, String message, Boolean cascadePermissions, Boolean autorename, Boolean ignoreWarnings) throws ApiException {
        ...
        FolderUpdateResponse response = foldersApi.updateFolder(folderId, folderBody, Boolean.FALSE, lastTimestamp, tree, null, cascadePermissions, null, autorename, ignoreWarnings);
     ...
     * @throws ApiException In case of error
     */
    public String updateFolderExpectingError(String folderId, FolderData folder, String message, Boolean cascadePermissions, Boolean autorename, Boolean ignoreWarnings) throws ApiException {
        FolderBody folderBody = new FolderBody();
        ...
        FolderUpdateResponse response = foldersApi.updateFolder(folderId, folderBody, Boolean.FALSE, lastTimestamp, tree, null, cascadePermissions, null, autorename, ignoreWarnings);
        assertNotNull(response.getError(), response.getErrorDesc());
        lastTimestamp = response.getTimestamp();
    ...
    public FolderData getFolder(String id) throws ApiException {
        FolderResponse folderResponse = foldersApi.getFolder(id, tree, null, null, null);
    ...
    public String getFolderName(String folderId) throws ApiException {
        FolderResponse folder = foldersApi.getFolder(folderId, tree, null, null, null);
    ...
    public String findInfostoreRoot() throws ApiException {
        ...
        assertNotNull(parent, "Unable to find parent folder!");
        return parent;
    }
    ...
    public String getDefaultFolder(String module) throws Exception {
        ...
        if (privateList != null) {
            ...
            for (ArrayList<?> folder : privateList) {
                if (((Boolean) folder.get(1)).booleanValue() && (defType <= 0 || ((Double) folder.get(2)).intValue() == defType)) {
