...
public class GetTest extends AbstractAJAXSession {
    ...
    public void testGetRoot() throws Throwable {
        ...
        assertEquals("0", jsonObject.get("id"), "Unexpected root folder ID.");
    }
    ...
    public void testGetPrivate() throws Throwable {
        ...
        assertEquals("1", jsonObject.get("id"), "Unexpected private folder ID.");
        assertTrue(jsonObject.getBoolean("subfolders"), "Subfolder expected below private folder");
    }
    ...
    public void testGetPublic() throws Throwable {
        ...
        assertEquals("2", jsonObject.get("id"), "Unexpected public folder ID.");
        assertTrue(jsonObject.getBoolean("subfolders"), "Subfolder expected below public folder");
    }
    ...
    public void testGetShared() throws Throwable {
        ...
        assertEquals("3", jsonObject.get("id"), "Unexpected public folder ID.");
    }
