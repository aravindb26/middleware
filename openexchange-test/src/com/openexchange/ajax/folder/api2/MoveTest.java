    ...
    public void testMoveCalBelowMail() throws Throwable {
        ...
        try {
            final int userId = getClient().getValues().getUserId();
            {
                ...
                assertNotNull(newCalId, "New ID must not be null!");
                ...
                assertNotNull(newMailId, "New ID must not be null!");
            }

            {
                ...
                assertEquals(newCalId, newCalIDMoved, "ID not equal.");
            }
        } finally {
            if (null != newCalId) {
                // Delete folder
    ...
    public void testMoveMailBelowCal() throws Throwable {
        ...
        try {
...

            {
                ...
                assertEquals(newMailId, newMailIDMoved, "ID must not be equal.");
