...
public class ClearTest extends AbstractAJAXSession {
    ...
    public void testClearPrivate() throws Throwable {
        ...
        try {
            ...
            assertTrue(null != appointments && appointments.length == 2, "Appointments were not created.");
            ...
            assertEquals(0, nonClearedIDs.length(), "Folder could not be cleared.");
            ...
            assertTrue(null == emptyAppointments || emptyAppointments.length == 0, "Appointments were not cleared.");
