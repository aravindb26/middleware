...
public class Bug16243Test extends AbstractAJAXSession {
    ...
    public void testListWithoutInfoStore() throws Throwable {
        ...
        assertTrue(iter.hasNext(), "List request does not return any folders.");
        while (iter.hasNext()) {
            FolderObject folder = iter.next();
            assertNotSame(I(InfostoreContentType.getInstance().getModule()), I(folder.getModule()), "Found some infostore folder.");
        }
    }
}
