...
public class PathTest extends AbstractAJAXSession {
    ...
    public void testPath1() throws Throwable {
        ...
        assertEquals(0, length, "Unexpected path length.");
    }
    ...
    public void testPath2() throws Throwable {
        ...
        assertEquals(1, length, "Unexpected path length.");

        assertEquals(PRIVATE_FOLDER_ID, jsonArray.getJSONArray(0).getString(0), "Unexpected path element.");
    ...
    public void testPath3() throws Throwable {
        ...
        try {
            ...
            assertNotNull(newId, "New ID must not be null!");
            ...
            assertEquals(2, length, "Unexpected path length:" + System.getProperty("line.separator") + jsonArray);

            assertEquals(newId, jsonArray.getJSONArray(0).getString(0), "Unexpected path element.");
            assertEquals(PRIVATE_FOLDER_ID, jsonArray.getJSONArray(1).getString(0), "Unexpected path element.");
        } finally {
            if (null != newId) {
                // Delete folder
                try {
