...
public class VisibleFoldersTest extends Abstrac2UserAJAXSession {
    ...
    public void testForVisibleFolders() throws Throwable {
         ...
         */
        {
            ...
            assertTrue(found, "Previously created private folder not found in private folders.");
        }
        /*
         ...
         */
        {
            ...
            assertTrue(found, "Previously created public folder not found in public folders.");
        }
        /*
         ...
         */
        {
            ...
            assertTrue(found, "Previously created shared folder not found in shared folders.");
        }
    }
    ...
    public void testFindingGlobalAddressbook() throws Exception {
        ...
        assertTrue(globalAddressBookFound, "Could not find the global address book");
    }
