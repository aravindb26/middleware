...
public class Bug12393Test extends AbstractAJAXSession {
    ...
    public void testPermissionsOfSubfoldersRemainIntactAfterRemovalOfFolderGroupPermission() throws Exception {
        ...
        assertEquals(expectedSet.size(), isSet.size(), "The permissions of the subfolder have changed. Differing size. ");

        expectedSet.removeAll(isSet);
        assertTrue(expectedSet.isEmpty(), "The permissions of the subfolder have changed: " + expectedSet.toString());
    }
}
