...
public class MWB905Test extends AbstractClientSession {
    ...
    public void testMultipleLogins() throws Exception {
        ...
        Assertions.assertTrue(data.size() >= THREADS + 1, "Failed to login all clients");
        ...
        Assertions.assertTrue(count == 1, "There should be exactly one \"Collected Addresses\" folder.");
    }

    private ApiClient generateApiClient(TestUser user) throws ApiException {
        Assertions.assertTrue(null != user, "No test user give");
