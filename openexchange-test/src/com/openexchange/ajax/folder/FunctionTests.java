...
public class FunctionTests extends Abstrac2UserAJAXSession {
    ...
    public void testUnknownAction() throws IOException, JSONException, OXException {
        ...
        assertTrue(response.hasError(), "JSON response should contain an error message.");
        ...
        assertTrue(error.equals("SVL-0001"), "Error is not the expected one: \"" + error + "\"");
    }
    ...
    public void testFailDeleteFolder() throws OXException, IOException, JSONException {
        ...
        try {
            ...
            assertEquals(1, notDeleted.length(), "Expected identifier of not deletable folder.");
            assertEquals(parent.getObjectID(), notDeleted.getInt(0), "Wrong folder identifier");
        } finally {
            if (null != subChild01) {
                try {
