...
public final class ContactObjectCountTest extends AbstractObjectCountTest {
    ...
    public void testCountInPrivateFolder() throws Exception {
        ...
        try {
            ...
            int countTotal = getCountTotal(client1, created.getObjectID());
            assertEquals(0, countTotal, "Wrong object count");

            int numContacts = rand.nextInt(20) + 1;
            createContacts(ctm, numContacts, created.getObjectID(), false);
            countTotal = getCountTotal(client1, created.getObjectID());
            assertEquals(numContacts, countTotal, "Wrong object count");
        } finally {
            ctm.cleanUp();
            ftm.cleanUp();
        }
    ...
    public void testCountInSharedFolder() throws Exception {
        ...
        try {
            ...
            countTotal = getCountTotal(client1, created.getObjectID());
            assertEquals(numContacts1 + numPrivateContacts1 + numContacts2, countTotal, "Wrong object count");

            countTotal = getCountTotal(client2, created.getObjectID());
            assertEquals(numContacts1 + numContacts2, countTotal, "Wrong object count");
        } finally {
            ctm1.cleanUp();
            ctm2.cleanUp();
            ftm.cleanUp();
    ...
    public void testCountInPublicFolder() throws Exception {
        ...
        try {
            ...
            countTotal = getCountTotal(client2, created.getObjectID());
            assertEquals(numContacts2, countTotal, "Wrong object count");
        } finally {
            ctm1.cleanUp();
            ctm2.cleanUp();
            ftm.cleanUp();
