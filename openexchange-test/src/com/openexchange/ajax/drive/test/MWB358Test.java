...
public class MWB358Test extends InfostoreApiClientTest {
    ...
    public void testDeleteFolderWithSharedFile() throws ApiException {
        ...
        assertNull(deleteFoldersResponse.getError(), deleteFoldersResponse.getErrorDesc());
        checkForSyncAction();
    }
    ...
    private void emptyTrash() throws ApiException {
        ...
        TrashFolderResponse trashContent = driveApiUser1.getTrashContent(infostoreFolder);
        ...
        if (data != null && data.getFiles() != null && data.getFiles().isEmpty() == false) {
            ...
            TrashFolderResponse removeFromTrash = driveApiUser1.deleteFromTrash(infostoreFolder, body);
     ...
     * @throws ApiException
     */
    private List<DriveAction> syncFolder(SessionAwareClient apiClient, String folderId, String clientChecksum, String originalChecksum) throws ApiException {
        ...
        DriveSyncFolderResponse syncFolderResponse = driveApiUser2.syncFolder(folderId, driveSyncFolderBody, I(2), null, null, null, null);
        assertNotNull(syncFolderResponse);
        assertNull(syncFolderResponse.getError(), syncFolderResponse.getErrorDesc());
