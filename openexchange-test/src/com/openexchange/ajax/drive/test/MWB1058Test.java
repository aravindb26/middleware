...
public class MWB1058Test extends AbstractAPIClientSession {
    ...
    private final String FILE_NAME = "oxlogo.png";
    ...
    public void testSyncFileWithDashes() throws Exception {
        ...
        infostoreTestManager.newAction(testFile, new java.io.File(testDataDir, FILE_NAME));
        DriveDownloadBody body = new DriveDownloadBody();
        java.io.File file = driveApi.downloadFile(String.valueOf(driveRootFolderId), "/" + testFolder.getFolderName(), testFile.getFileName(), FILE_MD5, I(8), L(0), L(FILE_SIZE), Boolean.TRUE, body);
        assertNotNull(file);
    }
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        testDataDir = AJAXConfig.getProperty(AJAXConfig.Property.TEST_DIR);
    }
