...
public class ResumableChecksumTest extends AbstractConfigAwareAPIClientSession {
    ...
    public void testResumableChecksum_UploadWith3EmptyChunks_Successful() throws NoSuchAlgorithmException, ApiException, IOException {
        ...
        DriveUploadResponse uploadFile = driveApi.uploadFile(folderId, "/", newName, newChecksum, body, null, null, null, null, offset, totalLength, null, null, null, null, null);
        assertNull(uploadFile.getError(), uploadFile.getErrorDesc());
        offset = L(chunksize);
        uploadFile = driveApi.uploadFile(folderId, "/", newName, newChecksum, body, null, null, null, null, offset, totalLength, null, null, null, null, null);
        assertNull(uploadFile.getError(), uploadFile.getErrorDesc());
        ...
        File downloadFile = driveApi.downloadFile(folderId, "/", newName, newChecksum, null, L(0), L(-1), null, downloadBody);
    ...
    public void testResumableChecksum_UploadWithFilledChunks_Successful() throws NoSuchAlgorithmException, ApiException, IOException {
        ...
        DriveUploadResponse uploadFile = driveApi.uploadFile(folderId, "/", newName, newChecksum, body1, null, null, null, null, offset, totalLength, null, null, null, null, null);
        assertNull(uploadFile.getError(), uploadFile.getErrorDesc());
        offset = L(chunksize);
        uploadFile = driveApi.uploadFile(folderId, "/", newName, newChecksum, body2, null, null, null, null, offset, totalLength, null, null, null, null, null);
    ...
    private String getPrivateInfostoreFolder() throws ApiException {
        if (null == privateInfostoreFolder) {
            ...
            if (data != null && !data.toString().equalsIgnoreCase("null")) {
                ...
                org.junit.jupiter.api.Assertions.fail("It seems that the user doesn't support drive.");
            }
    ...
    private Object checkResponse(ConfigResponse resp) {
        org.junit.jupiter.api.Assertions.assertNull(resp.getError(), resp.getErrorDesc());
        org.junit.jupiter.api.Assertions.assertNotNull(resp.getData());
        return resp.getData();
    }
