...
public class MultifactorBypassTest extends AbstractAppPasswordTest {
    ...
    private void setupSMS() throws ApiException {
        ...
        // Finalize
        MultifactorFinishRegistrationResponse finalresp = multifactorApi.multifactorDeviceActionfinishRegistration(SMS_PROVIDER_NAME, respData.getDeviceId(), data);
    ...
    public void checkLoginWithMultifactor() throws ApiException {
        ...
        // Add a password
        AppPasswordRegistrationResponseData loginData = addPassword("mailapp");
        ...
        LoginResponse login = loginApi.doLogin(testUser.getLogin(), testUser.getPassword(), null, null, null, null, null, null, FALSE);
        ...
        login = loginApi.doLogin(loginData.getLogin(), loginData.getPassword(), null, null, "mobile-something", null, null, null, FALSE);
