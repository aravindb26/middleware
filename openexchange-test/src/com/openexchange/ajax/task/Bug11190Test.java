...
public class Bug11190Test extends AbstractAJAXSession {
    ...
    public void testSwitchingBetweenMonthlyRecurrencePatternsShouldNotBreakRecurrence() throws OXException, IOException, JSONException {
        ...
        try {
            ...
            //compare
            assertEquals(Task.MONTHLY, resultingTask.getRecurrenceType(), "Recurrence type does not match");
            assertEquals(2, resultingTask.getInterval(), "Recurrence interval does not match");
            assertEquals(12, resultingTask.getDayInMonth(), "Recurring day in month does not match");
            assertFalse(resultingTask.containsDays(), "Recurring days should not be set anymore");
        } finally {
