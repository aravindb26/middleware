...
public final class Bug27840Test extends AbstractTaskTest {
    ...
    public void testForBug() throws OXException, IOException, JSONException {
        ...
        MatcherAssert.assertThat("Actual costs not equal", test.getActualCosts(), CoreMatchers.equalTo(task.getActualCosts()));
        MatcherAssert.assertThat("Target costs not equal", test.getTargetCosts(), CoreMatchers.equalTo(task.getTargetCosts()));
        task = test;
    }
}
