...
public class TruncationTest extends AbstractTaskTest {
    ...
    public void testTruncation() throws Throwable {
        ...
        assertTrue(response.hasError(), "Server did not detect truncated data.");
        assertTrue(response.getProblematics().length > 0, "Array of truncated attribute identifier is empty.");
        ...
        assertEquals(Task.TITLE, truncatedAttributeId, "Wrong attribute discovered as truncated.");
    }
}
