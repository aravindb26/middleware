...
public class Bug10071Test extends AbstractTaskTest {
    ...
    public void testDurationAndCostsSetToZero() throws OXException, IOException, JSONException {
        ...
        for (int attributeId : ATTRIBUTE_IDS) {
            ...
            assertTrue(mapper.isSet(toTest), "Attribute " + mapper.getDBColumnName() + " is missing in GET.");
            assertEquals(mapper.get(task), mapper.get(toTest), "Attribute " + mapper.getDBColumnName() + " has wrong value in GET.");
            ...
            assertNotNull(value, "Attribute " + mapper.getDBColumnName() + " is missing in LIST.");
            assertEquals(mapper.get(task), value, "Attribute " + mapper.getDBColumnName() + " has wrong value in LIST.");
        }
    }
}
