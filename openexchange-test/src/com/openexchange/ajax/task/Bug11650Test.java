...
public class Bug11650Test extends AbstractTaskTest {
    ...
    public void testSearchInSharedFolder() throws Throwable {
        ...
        try {
            ...
            }
            {
                ...
                MatcherAssert.assertThat("Searching for tasks in a shared folder failed.", !response.hasError());
            }
        } finally {
    ...
    private static FolderObject createFolder(final int owner, final int sharee) {
        assertNotEquals(owner, sharee, "Owner and sharee are the same. Sharing is not possible");
