...
public class Bug10119Test extends AbstractTaskTest {
    ...
    public void testFunambol() throws Throwable {
        ...
        final TaskUpdatesResponse uResponse;
        {
            ...
            assertTrue(uResponse.size() >= 2, "Can't find initial inserts. Only found " + uResponse.size() + " changed tasks.");
        }
        // Delete one
        {
        ...
        // Check if we see 2 updates, 1 insert and 1 delete.
        {
            ...
            assertTrue(uResponse2.size() >= 2, "Can't get created and deleted item.");
        }
        // Delete all.
        {
