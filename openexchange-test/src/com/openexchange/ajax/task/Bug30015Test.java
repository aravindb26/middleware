...
public final class Bug30015Test extends AbstractAJAXSession {
    ...
    public void testForTaskCompletedAttributeInNextOccurrence() throws OXException, IOException, JSONException {
        ...
        Assertions.assertFalse(second.containsDateCompleted(), "Next occurrence of task must not contain the attribute 'date completed'.");
        assertNull(second.getDateCompleted(), "Next occurrence of task must not contain the attribute 'date completed'.");
    }
}
