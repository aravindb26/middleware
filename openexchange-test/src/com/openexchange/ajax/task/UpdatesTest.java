...
public class UpdatesTest extends AbstractTaskTest {
    ...
    public void testUpdates() throws Throwable {
        ...
        assertTrue(allR.getArray().length >= total, "Can't find " + total + " inserted tasks.");
        ...
        assertTrue(updatesR.size() >= UPDATES + DELETES, "Only found " + updatesR.size() + " updated tasks but should be more than " + (UPDATES + DELETES) + '.');
