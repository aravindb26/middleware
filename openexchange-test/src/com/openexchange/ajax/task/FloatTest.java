...
public class FloatTest extends AbstractTaskTest {
    ...
    public void testFloats() throws Throwable {
        ...
        assertEquals(task.getActualDuration(), reload.getActualDuration(), "Actual duration differs.");
        assertEquals(task.getTargetDuration(), reload.getTargetDuration(), "Target duration differs.");
        assertEquals(task.getActualCosts(), reload.getActualCosts(), "Actual costs differs.");
        assertEquals(task.getTargetCosts(), reload.getTargetCosts(), "Target costs differs.");
