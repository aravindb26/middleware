...
public class RemoveAllOtherSessionsTest extends AbstractSessionManagementTest {
    ...
    public void testRemoveAllOtherSessions() throws Exception {
        ...
        MatcherAssert.assertThat("Not all clients has been removed", Integer.valueOf(1), is(Integer.valueOf(sessions.size())));

        for (SessionManagementData session : sessions) {
            MatcherAssert.assertThat("Wrong client is still loged in", sessionId, is(session.getSessionId()));
        }
    ...
    public void testRemoveAllOtherSessionsWithoutBlacklisted() throws Exception {
        ...
        MatcherAssert.assertThat("Blacklisted client is visible!", Integer.valueOf(sessions.size()), is(Integer.valueOf(2)));
        ...
        MatcherAssert.assertThat("Not all clients has been removed", Integer.valueOf(sessions.size()), is(Integer.valueOf(1)));
