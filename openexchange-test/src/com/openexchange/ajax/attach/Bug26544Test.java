...
public class Bug26544Test extends AbstractTestEnvironment {
    ...
    public void testAllRequestWithSortOrder() throws OXException, IOException, JSONException {
        ...
        assertEquals(3, attachmentMetadata.size(), "Incorrect amount of attachments");
        assertEquals("C.txt", attachmentMetadata.get(0).getFilename(), "Wrong sort order");
        assertEquals("A.txt", attachmentMetadata.get(1).getFilename(), "Wrong sort order");
        assertEquals("B.txt", attachmentMetadata.get(2).getFilename(), "Wrong sort order");
        ...
        assertEquals(3, attachmentMetadata.size(), "Incorrect amount of attachments");
        assertEquals("A.txt", attachmentMetadata.get(0).getFilename(), "Wrong sort order");
        assertEquals("B.txt", attachmentMetadata.get(1).getFilename(), "Wrong sort order");
        assertEquals("C.txt", attachmentMetadata.get(2).getFilename(), "Wrong sort order");
    }
