...
public class MailManager {
    ...
    public int getMailCount() throws Exception {
        ...
        List<List<Object>> idResponse = getMailIds(folder);
    ...
    public List<MailData> getMails() throws Exception {
        ...
        for (List<Object> mail : idResponse) {
            MailResponse mailResponse = mailApi.getMail(folder, mail.get(0).toString(), null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    private List<List<Object>> getMailIds(String folder) throws ApiException {
        MailsResponse allMailIdsResponse = mailApi.getAllMails(folder, "600,609", null, null, null, "609", "desc", null, null, null, null);
        List<List<Object>> idResponse = checkResponse(allMailIdsResponse.getError(), allMailIdsResponse.getErrorDesc(), allMailIdsResponse.getData());
        return idResponse;
    }
