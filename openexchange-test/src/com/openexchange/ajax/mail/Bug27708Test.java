...
public final class Bug27708Test extends AbstractMailTest {
    ...
    public void testBug27708() throws Exception {
        ...
        Assertions.assertTrue(0 == sb.length(), sb.toString());
    }
        ...
        public void run() {
            try {
                for (int j = 0; j < 1000 && running; j++) {
                    ...
                    Assertions.assertTrue(body.contains(identifier), "Sent mail does not contain senders mail body.\n" + body);
                    for (String other : others) {
                        Assertions.assertFalse(body.contains(other), "Sent mail does contain others mail body.\n" + body);
                    }
                }
            } catch (Exception e) {
                throwable = e;
