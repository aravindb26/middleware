...
public class Base64Test extends AbstractMailTest {
    ...
    public void testGetBase64() throws OXException, IOException, JSONException {
        ...
        assertNotNull(newMailResponse.getFolder(), "Missing folder in response.");
        ...
        assertTrue(attachment.getString("content").startsWith("Hallo Herr Gabler"), "Unexpected content in JSON mail representation:\n" + data.toString(2));
    }
}
