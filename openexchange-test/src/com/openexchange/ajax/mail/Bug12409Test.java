...
public class Bug12409Test extends AbstractMailTest {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        mailObject.put(MailJSONField.DISPOSITION_NOTIFICATION_TO.getKey(), "testmail@example.com");
        // mark it as a draft
    ...
    public void testSavedDispositionNotificationReturnedWhenEditing() throws IOException, JSONException, OXException {
        ...
        assertTrue(response.getMail(getTimeZone()).getDispositionNotification().toString().equals("testmail@example.com"), "Disposition notification was not saved.");
    }
