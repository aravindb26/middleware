...
public class ResourceUseCountTest extends AbstractChronosTest {
    ...
    public void setUp(TestInfo testInfo) throws Exception {
        ...
        resourceData.setMailaddress(ProvisioningUtils.getMailAddress("test1", testContext.getId()));
        ...
        resourceData.setMailaddress(ProvisioningUtils.getMailAddress("test2", testContext.getId()));
    ...
    public void testUseCount() throws ApiException {
        ...
        for (ResourceData resource : resources) {
            Assertions.assertEquals(resourceIds[x++], resource.getId());
        }
