...
public class RemindAgainTest extends AbstractAJAXSession {
    ...
    public void testRemindAgain() throws Exception {
        ...
        try {
            ...
            assertTrue(reminderObject.getObjectId() > 0, "object id not found");
            assertNotNull(reminderObject.getLastModified(), "last modified is null");
            assertEquals(targetId, reminderObject.getTargetId(), "target id is not equal");
            assertEquals(folderId, reminderObject.getFolder(), "folder id is not equal");
            assertEquals(userId, reminderObject.getUser(), "user id is not equal");
            ...
            assertEquals(timzonedNewAlarm, reminderObject.getDate(), "alarm is not equal");
