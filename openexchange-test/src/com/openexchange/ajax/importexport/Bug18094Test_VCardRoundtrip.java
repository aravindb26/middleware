...
public class Bug18094Test_VCardRoundtrip extends AbstractManagedContactTest {
    ...
    public void testFullVCardRoundtrip() throws Exception {
        ...
        assertEquals(1, response.length(), "Precondition: Should only find one contact in there");
        ...
        assertTrue(mismatches.size() < 58, "Too many (" + mismatches.size() + ") fields not surviving the roundtrip: \n" + fields);
    }
