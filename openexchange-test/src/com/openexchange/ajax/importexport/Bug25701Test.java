...
public class Bug25701Test extends AbstractManagedContactTest {
    ...
    public void testPreferredTelephoneHomeType() throws Exception {
        ...
        assertTrue(homeTelephoneNumbers.contains("33465472555"), "33465472555 not found");
        assertTrue(homeTelephoneNumbers.contains("47574573624"), "47574573624 not found");
        /*
         * check roundtrip
         */
        vCard = export();
    ...
    public void testPreferredTelephoneBusinessType() throws Exception {
        ...
        assertTrue(businessTelephoneNumbers.contains("33465472555"), "33465472555 not found");
        assertTrue(businessTelephoneNumbers.contains("47574573624"), "47574573624 not found");
        /*
         * check roundtrip
         */
        vCard = export();
    ...
    public void testPreferredFaxHomeType() throws Exception {
        ...
        Contact importedContact = importAndFetch(vCard);
        assertEquals("33465472555", importedContact.getFaxHome(), "33465472555 not found");
        /*
         * check roundtrip
         */
        vCard = export();
    ...
    public void testPreferredFaxBusinessType() throws Exception {
        ...
        Contact importedContact = importAndFetch(vCard);
        assertEquals("33465472555", importedContact.getFaxBusiness(), "33465472555 not found");
        /*
         * check roundtrip
         */
        vCard = export();
