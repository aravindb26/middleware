...
public class MWB464Test extends ManagedAppointmentTest {
    ...
    public void testMountainStandardTime() throws Exception {
        ...
        assertNotNull(importResponse.getImports(), "Should have processed 1 event");
        assertEquals(1, importResponse.getImports().length, "Should have processed 1 event");
        ...
        assertEquals("America/Phoenix", appointment.getTimezone(), "Timezone wrong");
        DateTime expectedStart = DateTime.parse("America/Phoenix", "20200709T120000");
        assertEquals(expectedStart.getTimestamp(), appointment.getStartDate().getTime(), "Wrong start");
        DateTime expectedEnd = DateTime.parse("America/Phoenix", "20200709T130000");
        assertEquals(expectedEnd.getTimestamp(), appointment.getEndDate().getTime(), "Wrong end");
    }
