...
public final class POSTResponse extends AbstractResponse {
    ...
    POSTResponse(CloseableHttpResponse response) throws IOException {
        super(response);
    ...
    public void assertRedirect() {
        ...
        assertNotNull(redirectLocation, "Location header was missing in response");
    }

    public GETResponse followRedirect(CloseableHttpClient client) throws IOException {
        assertRedirect();
        try {
