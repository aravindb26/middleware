...
public class OAuthClient extends AJAXClient {
                ...
                try {
                    ...
                    switch (error) {
                        ...
                        case "insufficient_scope":
                            String requiredScope = jsonObject.optString("scope", "");
                            e = RestrictedActionExceptionCodes.INSUFFICIENT_SCOPES.create(requiredScope);
                            break;
    ...
    public void assertAccess() throws Exception {
        ...
        Assertions.assertFalse(allResponse.hasError());
    }
