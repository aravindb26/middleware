...
public class ReadContactTest extends AbstractOAuthTest {
    ...
    final Scope scope = Scope.newInstance(RestrictedAction.Type.READ.getScope(ContactActionFactory.MODULE), RestrictedAction.Type.WRITE.getScope(ContactActionFactory.MODULE));

    @Test
    public void testContactImageRetrieval() throws Exception {
        setOAuthClient(scope);
        byte[] image;
        {
