...
public class MWB263Test extends AbstractITipAnalyzeTest {
    ...
    public void testBug() throws Exception {
        ...
        MatcherAssert.assertThat(createdEvent.getSequence(), is(I(0)));
        ...
        applyResponse(apiClient, constructBody(reply));
        ...
        MatcherAssert.assertThat(masterEvent.getSequence(), is(I(0)));
        ...
        MatcherAssert.assertThat(change.getCurrentEvent().getId(), is(attendeeEvent.getId()));
        ...
        for (EventData event : updates) {
            ...
            MatcherAssert.assertThat(event.getSeriesId(), is(attendeeEvent.getId()));
            MatcherAssert.assertThat(event.getUid(), is(attendeeEvent.getUid()));
        }
        attendeeEvent = eventManagerC2.getEvent(attendeeEvent.getFolder(), attendeeEvent.getSeriesId());
        assertAttendeePartStat(attendeeEvent.getAttendees(), replyingAttendee.getEmail(), PartStat.ACCEPTED.getStatus());
        MatcherAssert.assertThat("no exception", attendeeEvent.getChangeExceptionDates(), is(not(empty())));
        MatcherAssert.assertThat("no exception", I(attendeeEvent.getChangeExceptionDates().size()), is(I(1)));
        /*
        ...
        MatcherAssert.assertThat(I(allEvents.size()), is(I(2)));
        /*
         ...
         */
        allEvents.forEach(e -> MatcherAssert.assertThat(e.getSequence(), is(I(e.getId().equals(e.getSeriesId()) ? 0 : 1))));
        ...
        MatcherAssert.assertThat(exceptionEvent.getSequence(), is(I(1)));
    }
