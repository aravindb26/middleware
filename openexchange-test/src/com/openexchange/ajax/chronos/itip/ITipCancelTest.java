...
public class ITipCancelTest extends AbstractITipAnalyzeTest {
    ...
    @Test
    public void testSingleEvent_CancelEvent() throws Exception {
        ...
        assertAnalyzeActions(analyze(apiClientC2, iMip), ITipActionSet.CANCEL);
        ...
        Assertions.assertNotNull(e, "Excpected an error");
    ...
    public void testSeriesEvent_CancelOccurrence() throws Exception {
        ...
        assertThat("Wrong occurrence has been deleted!", attendeeEvent.getDeleteExceptionDates().get(0), is(secondOccurrence.getRecurrenceId().toString()));
    ...
    @Test
    public void testSeriesEvent_CancelSeries() throws Exception {
        EventData seriesToCreate = EventFactory.createSeriesEvent(0, summary, 10, defaultFolderId);
        Attendee replyingAttendee = prepareCommonAttendees(seriesToCreate);
        createdEvent = prepareSituation(seriesToCreate, replyingAttendee);
    ...
    public void testSeriesEvent_ShortenSeries() throws Exception {
        ...
        assertAnalyzeActions(analyze(apiClientC2, iMip), ITipActionSet.ALL);
    ...
    private EventData receiveAndApplyUpdate(EventData event, Attendee replyingAttendee, int sequence) throws Exception, ApiException {
         ...
         */
        assertSingleEvent(applyResponse(testUser.getApiClient(), constructBody(reply)), event.getUid());
