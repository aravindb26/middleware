...
public class Bug11250Test extends AbstractChronosTest {
    ...
    public void testBug11250() throws Exception {
        ...
        assertEquals(4, allEvents.size(), "Event array size not equals");

        assertEquals(event1.getSummary(), allEvents.get(0).getSummary(), "appointment id at position 1 not equals");
        assertEquals(event2.getSummary(), allEvents.get(1).getSummary(), "appointment id at position 2 not equals");
        assertEquals(event3.getSummary(), allEvents.get(2).getSummary(), "appointment id at position 3 not equals");
        assertEquals(event2.getSummary(), allEvents.get(3).getSummary(), "appointment id at position 4 not equals");
    }
}
