...
public class MWB1077Test extends AbstractICalCalendarProviderTest {
    ...
    @Test
    public void testMicrosoftException() throws ApiException {
        /*
         * mock iCalendar feed
         */
         ...
         * verify event data
         */
        assertEquals(18, events.size(), "unexpcted number of events");
        ...
        assertNotNull(changeException, "change exception not imported");
    }
