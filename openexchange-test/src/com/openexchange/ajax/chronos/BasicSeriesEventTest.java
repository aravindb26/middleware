...
public class BasicSeriesEventTest extends AbstractChronosTest {
    ...
    public void testDeleteSeriesOccurence() throws Exception {
        ...
        assertEquals(3, allEvents.size(), "Expected 3 occurrences");
    ...
    public void testUpdateSeriesMaster() throws Exception {
        ...
        assertNotEquals(expectedEventData.getLastModified(), updatedEvent.getLastModified(), "The timestamp matches");
        assertNotEquals(expectedEventData.getSequence(), updatedEvent.getSequence(), "The sequence matches");

        expectedEventData.setLastModified(updatedEvent.getLastModified());
        expectedEventData.setSequence(updatedEvent.getSequence());
        CalendarAssertUtil.assertEventsEqual(expectedEventData, updatedEvent);
    ...
    public void testGetSeries() throws Exception {
        ...
        Calendar calendar = Calendar.getInstance(TimeZone.getTimeZone(expectedEventData.getStartDate().getTzid()));
        calendar.setTime(DateTimeUtil.parseDateTime(expectedEventData.getStartDate()));
        calendar.add(Calendar.DATE, 2);
        DateTimeData expectedRecurrenceId = DateTimeUtil.getDateTime(actualEventData.getStartDate().getTzid(), calendar.getTimeInMillis());
