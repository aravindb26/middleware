...
public class BasicSelfProtectionTest extends AbstractChronosTest {
    ...
    public void testTooManyEvents() throws Exception {
        ...
        Assertions.assertNotNull("Response doesn't contain an error", createEvent.getError());
        Assertions.assertEquals(excpectedErrorCode, createEvent.getCode());
        ...
        Assertions.assertNotNull("Response doesn't contain an error", eventsResponse.getError());
        Assertions.assertEquals(excpectedErrorCode, eventsResponse.getCode());
        ...
        Assertions.assertNotNull("Response doesn't contain an error", updateResponse.getError());
        Assertions.assertEquals(excpectedErrorCode, updateResponse.getCode());
        ...
        Assertions.assertNotNull("Response doesn't contain an error", updatesResponse.getError());
        Assertions.assertEquals(excpectedErrorCode, updatesResponse.getCode());
    }
