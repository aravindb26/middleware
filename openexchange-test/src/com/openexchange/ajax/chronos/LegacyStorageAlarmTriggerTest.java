...
public class LegacyStorageAlarmTriggerTest extends AbstractAlarmTriggerTest {
    ...
    public void testTimeShiftOfEventSeries() throws Exception {
        ...
        for(AlarmTrigger trigger : triggerData) {
            ...
            assertTrue(parseZuluDateTime.getTime() == exceptionTriggerTime.getTime() || parseZuluDateTime.getTime() == expectedTriggerTime.getTime(), "The trigger time is wrong. Expected either " + exceptionTriggerTime + " or " + expectedTriggerTime + " but was " + parseZuluDateTime);
        }
    }
}
