...
public class FolderTransactionTest extends ShareTest {
    ...
    private void testDontCreateShareOnFailingFolderCreate(EnumAPI api, int module) throws Exception {
        ...
        assertTrue(insertionFailed, "API: " + api + ", Module: " + module);

        List<FolderShare> newShares = getFolderShares(api, module);
        assertEquals(oldShares.size(), newShares.size(), "The number of shares differs but should not. " + "API: " + api + ", Module: " + module);
    }
    ...
    private void testDontCreateShareOnFailingFolderUpdate(EnumAPI api, int module) throws Exception {
        ...
        assertTrue(updateFailed, "API: " + api + ", Module: " + module);
    ...
    private void testDontRemoveSharesOnFailingFolderUpdate(EnumAPI api, int module) throws Exception {
        ...
        assertNotNull(matchingPermission, "No matching permission in created folder found." + "API: " + api + ", Module: " + module);
        ...
        assertNotNull(guest, "API: " + api + ", Module: " + module);
        ...
        GuestClient guestClient = new GuestClient(testContext.getUsedBy(), shareURL, guestPermission.getRecipient());
        ...
        if (module == FolderObject.CALENDAR) {
            assertEquals("cal://0/" + Integer.toString(sharedFolder.getObjectID()), resolveResponse.getFolder(), "API: " + api + ", Module: " + module);
        } else if (module == FolderObject.CONTACT) {
            assertEquals("con://0/" + Integer.toString(sharedFolder.getObjectID()), resolveResponse.getFolder(), "API: " + api + ", Module: " + module);
        } else {
            assertEquals(Integer.toString(sharedFolder.getObjectID()), resolveResponse.getFolder(), "API: " + api + ", Module: " + module);
        }
    }
