...
public class Bug40826Test extends ShareTest {
    ...
    private void testShareToAuthor(int module) throws Exception {
        ...
        assertTrue(insertResponse.hasError(), "No error in response");
        assertNotNull(insertResponse.getException(), "No error in response");
        assertEquals("FLD-1039", insertResponse.getException().getErrorCode(), "Unexpected error");
    }
