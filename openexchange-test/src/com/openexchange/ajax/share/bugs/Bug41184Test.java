...
public class Bug41184Test extends Abstract2UserShareTest {
    ...
    public void testAccessSharedFileInSharedFolder() throws Exception {
        ...
        Assertions.assertNotNull(folderLink, "Invitation link not found");
        ...
        Assertions.assertTrue(folderMatcher.find(), "Folder param missing in fragment");
        String folderID = String.valueOf(folder.getObjectID());
        Assertions.assertEquals(folderID, folderMatcher.group(1));
        ...
        Assertions.assertNotNull(fileLink, "Invitation link not found");
        ...
        Assertions.assertTrue(fileMatcher.find(), "ID param missing in fragment");
        FileID fileID = new FileID(file.getId());
        fileID.setFolderId(folderID);
        Assertions.assertEquals(fileID.toUniqueID(), fileMatcher.group(1));
        /*
