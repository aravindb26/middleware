...
public class BirthdayAndAnniversaryTest extends AbstractManagedContactTest {
    ...
    public void testSearchByBirthday() throws Exception {
        ...
        assertEquals(2, contacts.size(), "wrong number of results");
