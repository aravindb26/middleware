...
public class AbstractApiClientContactTest extends AbstractAPIClientSession {
    ...
    protected void compareObject(final ContactData contactObj1, final ContactData contactObj2, boolean compareUID) {
        assertEquals(contactObj1.getId(), contactObj2.getId(), "id is not equals");
        assertEquals(contactObj1.getFolderId(), contactObj2.getFolderId(), "folder id is not equals");
        assertEquals(contactObj1.getPrivateFlag(), contactObj2.getPrivateFlag(), "private flag is not equals");
    ...
    public void updateContact(final ContactData contactObj, String folder) throws Exception {
        ...
        assertNull(updateContact.getError(), updateContact.getErrorDesc());
    }
