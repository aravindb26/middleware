...
public class Bug55703Test extends AbstractManagedContactTest {
    ...
    public void testUpdateOXAdmin() throws Exception {
        ...
        assertTrue(updateResponse.hasError(), "No errors when updating the admin contact");
        assertEquals("CON-0176", updateResponse.getException().getErrorCode(), "Unexpected error code");
        /*
         * check that the admin contact was not modified
         */
        Contact reloadedContact = cotm.getAction(FolderObject.SYSTEM_LDAP_FOLDER_ID, 1);
        assertEquals(originalContact.getNote(), reloadedContact.getNote(), "Note was modified");
    }
