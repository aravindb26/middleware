...
public class YomiTest extends AbstractAJAXSession {
    ...
    public void testYomiFields() throws Exception {
        ...
        assertEquals("\u660e\u65e5\u9999", loadedContact.getGivenName(), "Wrong Kanji First name");
        assertEquals("\u4f50\u85e4", loadedContact.getSurName(), "Wrong Kanji Last name");
        assertEquals("\u30a2\u30b9\u30ab", loadedContact.getYomiFirstName(), "Wrong Yomi First name");
        assertEquals("\u30b5\u30c8\u30a6", loadedContact.getYomiLastName(), "Wrong Yomi Last name");
        ...
        assertEquals("\u660e\u65e5\u9999", loadedUpdatedContact.getGivenName(), "Wrong Kanji First name");
        assertEquals("\u4f50\u85e4", loadedUpdatedContact.getSurName(), "Wrong Kanji Last name");
        assertEquals("\u3055\u3068\u3046", loadedUpdatedContact.getYomiFirstName(), "Wrong Yomi First name");
        assertEquals("\u3059\u305a\u304d", loadedUpdatedContact.getYomiLastName(), "Wrong Yomi Last name");
    }
