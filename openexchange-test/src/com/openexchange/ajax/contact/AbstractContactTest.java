...
public class AbstractContactTest extends AbstractAJAXSession {
    ...
    protected void compareObject(final Contact contactObj1, final Contact contactObj2, boolean compareUID) {
        ...
        assertTrue(contactObj1.getNumberOfAttachments() == contactObj2.getNumberOfAttachments(), "number of attachments is not equals");
        assertTrue(contactObj1.getDefaultAddress() == contactObj2.getDefaultAddress(), "default address is not equals");
        if (compareUID) {
