...
public class AllRequest extends CommonAllRequest {
    ...
    /**
     * Initializes a new {@link AllRequest} using a certain servlet path.
     * 
     * @param servletPath The servlet path containing the module the request is targeted at
     * @param folderId The identifier of the folder to request all contacts in
     * @param columns The column identifiers specifying the returned properties of the contacts
     */
    public AllRequest(String servletPath, String folderId, int[] columns) {
        super(servletPath, folderId, addGUIColumns(columns), 0, null, true);
    }
