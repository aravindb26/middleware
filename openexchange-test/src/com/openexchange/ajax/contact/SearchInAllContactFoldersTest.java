...
public class SearchInAllContactFoldersTest extends AbstractAJAXSession {
    ...
    public void testAutoCompleteSearchForAllFolders() throws Throwable {
        ...
        SearchRequest request = new SearchRequest(cso, columns, Contact.USE_COUNT, null);
    ...
    private void assertFoundContacts(SearchResponse response) {
        ...
        assertTrue(foundFirst, "Search did not return first inserted contact.");
        assertTrue(foundSecond, "Search did not return second inserted contact.");
    }
}
