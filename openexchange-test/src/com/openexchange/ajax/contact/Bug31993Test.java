...
public class Bug31993Test extends AbstractManagedContactTest {
    ...
    public void testSortOrder() throws Exception {
        ...
        assertEquals(3, contacts.size(), "wrong number of results");

        assertEquals(contact2.getSurName(), contacts.get(0).getSurName(), "Contact order wrong");
        assertEquals(contact1.getSurName(), contacts.get(1).getSurName(), "Contact order wrong");
        assertEquals(contact3.getSurName(), contacts.get(2).getSurName(), "Contact order wrong");
