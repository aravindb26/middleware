...
public class GetTest extends ContactTest {
    ...
    public void testGetUser() throws Exception {
        ...
        assertNotNull(loadContact, "contact object is null");
        assertEquals(userId, loadContact.getInternalUserId(), "user id is not equals");
        assertTrue(loadContact.getObjectID() > 0, "object id not set");
