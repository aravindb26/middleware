...
public class Bug55372Test extends AbstractContactTest {
    ...
    public void withoutNamesTest() throws Exception {
        ...
        MatcherAssert.assertThat("Error should have been thrown", response.hasError());
        MatcherAssert.assertThat("No error message!", response.getErrorMessage(), is(not(nullValue())));
        OXException exception = response.getException();
        MatcherAssert.assertThat("Should be a different exception message ", exception, is(not(nullValue())));
        // Should be CON-175 since it get checked first, but CON-164 is right too
        MatcherAssert.assertThat("Wrong exception code!", exception.getErrorCode(), anyOf(equalTo("CON-0164"), equalTo("CON-0175")));
    }
    ...
    public void withoutSurNameTest() throws Exception {
        ...
        OXException exception = response.getException();
        MatcherAssert.assertThat("Should be a different exception message ", exception, is(not(nullValue())));
        MatcherAssert.assertThat("Wrong exception code!", exception.getErrorCode(), is("CON-0175"));
    }
    ...
    public void withoutGivenNameTest() throws Exception {
        ...
        OXException exception = response.getException();
        MatcherAssert.assertThat("Should be a different exception message ", exception, is(not(nullValue())));
        MatcherAssert.assertThat("Wrong exception code!", exception.getErrorCode(), is("CON-0164"));
    }
    ...
    public void withoutDisplayNameTest() throws Exception {
        ...
        OXException exception = response.getException();
        MatcherAssert.assertThat("Should be a different exception message ", exception, is(not(nullValue())));
        MatcherAssert.assertThat("Wrong exception code!", exception.getErrorCode(), is("CON-0166"));
    }
