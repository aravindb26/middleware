...
public class Bug13931Test extends AbstractAJAXSession {
    ...
    public void testBug13931() throws Exception {
        ...
        assertNotNull(jsonArray, "No result");
        assertEquals(4, jsonArray.length(), "Wrong amount of results");
        assertEquals(AAA.getObjectID(), jsonArray.getJSONArray(0).getInt(0), "Wrong order");
        assertEquals(aaa.getObjectID(), jsonArray.getJSONArray(1).getInt(0), "Wrong order");
        assertEquals(BBB.getObjectID(), jsonArray.getJSONArray(2).getInt(0), "Wrong order");
        assertEquals(bbb.getObjectID(), jsonArray.getJSONArray(3).getInt(0), "Wrong order");
    }
