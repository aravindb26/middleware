...
public class Bug15937Test extends AbstractAJAXSession {
    ...
    public void testNumberOfAttachments() throws Throwable {
        ...
        assertTrue(testContact.containsNumberOfAttachments(), "Number of attachments should be send.");
        assertEquals(0, testContact.getNumberOfAttachments(), "Number of attachments must be zero.");
    }
}
