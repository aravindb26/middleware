...
public class ContactHaloProviderTest extends ContactProviderTest {
    ...
    public void testInvestigateByEmail() throws Exception {
        ...
        HaloInvestigationResponse investigationResponse = haloApi.investigateContactHalo("com.openexchange.halo.contacts", "1,20", expecedContact.getEmail1(), null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    private ContactData lookupContactFromAccount() throws Exception {
        ...
        assertTrue(null != allContacts && 0 < allContacts.size(), "no contacts in account for halo investigation found");
    ...
    private void checkInvestigateResponse(HaloInvestigationResponse investigationResponse, ContactData expectedContact) throws Exception {
        ...
        assertNotNull(foundContact, "contact not found");
    }
    ...
    private List<ContactData> getAllContacts(String folderId) throws Exception {
        ContactsResponse contactResponse = addressbooksApi.getAllContactsFromAddressbook(folderId, "1,20", null, null, null);
    ...
    private List<ContactData> loadContacts(List<Pair<String, String>> ids) throws Exception {
        ...
        for (Pair<String, String> id : ids) {
            ContactResponse getResponse = addressbooksApi.getContactFromAddressbook(id.getSecond(), id.getFirst());
