...
public class ManagedSearchTests extends AbstractManagedContactTest {
    ...
    public void testGuiLikeSearch() {
        ...
        for (int i = 0; i < sinographs.size(); i++) {
            ...
            assertEquals(1, results.length, "#" + i + " Should find one contact");
            assertEquals(sinographs.get(i), results[0].getSurName(), "#" + i + " Should find the right contact");
        }
    }
    ...
    public void testSearchPattern() {
        ...
        for (int i = 0; i < sinographs.size(); i++) {
            ...
            assertEquals(sinographs.get(i), name, "#" + i + " Should have the right order");
        }
    }
