...
public class AbstractMailAccountTest extends Abstrac2UserAJAXSession {
    ...
    protected static MailAccountDescription createMailAccountObject() throws OXException {
        ...
        mailAccountDescription.parseMailServerURL("localhost");
        ...
        mailAccountDescription.setPassword(AJAXConfig.getProperty(AJAXConfig.Property.USER_PASSWORD));
        mailAccountDescription.setPrimaryAddress("bob" + System.currentTimeMillis() + "@ox.test");
        ...
        mailAccountDescription.setTransportPassword(AJAXConfig.getProperty(AJAXConfig.Property.USER_PASSWORD));
