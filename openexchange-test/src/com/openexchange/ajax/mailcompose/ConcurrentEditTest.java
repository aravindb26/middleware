...
import static com.openexchange.testing.httpclient.models.MailComposeRequestMessageModel.ContentTypeEnum.TEXT_PLAIN;
...
public class ConcurrentEditTest extends AbstractMailComposeTest {
    ...
    public void testFailWithWrongToken_Patch() throws Exception {
        ...
        MailComposeResponse openResponse = api.postMailCompose("new", Boolean.FALSE, null, clientToken1, Collections.emptyList());
        check(openResponse);

        MailComposeRequestMessageModel patch1 = new MailComposeRequestMessageModel();
        patch1.setContentType(TEXT_PLAIN);
        ...
        assertEquals("MSGCS-0028", patchResponse2.getCode());
    }
    ...
    public void testFailWithWrongToken_PostAttachment() throws Exception {
        ...
        assertEquals("MSGCS-0028", attachmentResponseForWrongToken.getCode());
    }
    ...
    public void testTokenHandover() throws Exception {
        String clientToken1 = RandomStringUtils.randomAlphanumeric(16);
        String clientToken2 = RandomStringUtils.randomAlphanumeric(16);
        MailComposeResponse openResponse = api.postMailCompose("new", Boolean.FALSE, null,null, Collections.emptyList());
        check(openResponse);
        MailComposeRequestMessageModel patch1 = new MailComposeRequestMessageModel();
        ...
        assertEquals("MSGCS-0028", patchResponse4.getCode());
    }
    ...
    public void testNoTokenOverridesAlways() throws Exception {
        ...
        MailComposeResponse getResponse = api.getMailComposeById(openResponse.getData().getId());
        check(getResponse);
        assertEquals(patch2.getContent(), getResponse.getData().getContent(), "Patch without token was not applied");
    }

    @Test
    public void testInvalidTokenSyntax_Open() throws Exception {
        String invalidToken = "123!efg$";
        MailComposeResponse openResponse = api.postMailCompose("new", Boolean.FALSE, null, invalidToken, Collections.emptyList());
