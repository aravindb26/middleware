...
public class UserValues {
    ...
    private static final String QUALIFIED_ACCOUNT_ID = "con://0/";
    ...
    private void initPrivateFolders() throws OXException, IOException, JSONException {
        ...
        privateContactFolder = Integer.parseInt(jsonObject.getString("contacts").replaceFirst(QUALIFIED_ACCOUNT_ID, ""));
