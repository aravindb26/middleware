 ...
 */
public abstract class AbstractAJAXParser<T extends AbstractAJAXResponse> extends Assertions {
    ...
    protected Response getResponse(String body) throws JSONException {
        ...
        if (failOnError && response.hasError()) {
            ...
            if (null != exception) {
                ...
                assertTrue(Category.CATEGORY_WARNING.getType().equals(exception.getCategory().getType()), sb.toString());
            }
        }
        return response;
    }
