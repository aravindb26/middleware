...
public class MultifactorGetProvidersTest extends AbstractMultifactorTest {
    ...
    public void testNoMultifactorDeviceExistsOnInitialSetup () throws Exception {
        ...
        MatcherAssert.assertThat("At least one multifactor provider should be present for the test", providers, is(not(empty())));
        MatcherAssert.assertThat("No multifactor device should be present for the test", getDevices(), is(empty()));
    }
}
