...
public class BackupStringProviderTests extends AbstractMultifactorProviderTest {
    ...
    public void testRegisterBackupDeviceNotPossibleIfNoPrimaryDevicePresent() throws Exception {
        ...
        AssertionError exception = assertThrows(AssertionError.class, this::doStartRegistration);
        assertTrue(exception.getMessage().contains("Primary authentication devices must be set up before backup devices"));
    }
}
