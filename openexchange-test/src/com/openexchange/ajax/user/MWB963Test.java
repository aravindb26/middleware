...
public final class MWB963Test extends AbstractAJAXSession {
    ...
    public void testInvalidTimezoneId() throws Exception {
        ...
        assertTrue(updateResponse.hasError(), "no error in response");
        assertNotNull(updateResponse.getException(), "no error in response");
        assertEquals("USR-0024", updateResponse.getException().getErrorCode(), "unexpected error code");
    }
}
