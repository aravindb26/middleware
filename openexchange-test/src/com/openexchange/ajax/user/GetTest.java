...
public class GetTest extends Abstrac2UserAJAXSession {
    ...
    public void testGet() throws Exception {
        ...
        assertTrue(user.hasAndNotNull("id"), "No ID");
        assertTrue(user.getInt("id") == client2.getValues().getUserId(), "Wrong ID");

        assertTrue(user.hasAndNotNull("aliases"), "No aliases. JSON: " + user);
    }
}
