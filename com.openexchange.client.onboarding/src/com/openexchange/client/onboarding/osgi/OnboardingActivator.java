...
public class OnboardingActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { UserService.class, ConfigViewFactory.class, ConfigurationService.class, MimeTypeMap.class,
            UserAgentParser.class, ContextService.class, TranslatorFactory.class, ServerConfigService.class, CapabilityService.class,
            NotificationMailFactory.class, SessiondService.class };
    }
