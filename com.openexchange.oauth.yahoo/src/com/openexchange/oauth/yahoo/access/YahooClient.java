...
public class YahooClient {
    ...
    public String getGUID() throws OXException {
        ...
        try {
            JSONObject body = JSONServices.parseObject(guidResponse.getBody());
     ...
     * @throws OXException
     */
    private static JSONObject extractJson(final Response response) throws OXException {
        Reader reader = null;
        try {
            reader = new InputStreamReader(response.getStream(), Charsets.UTF_8);
            final JSONValue value = JSONServices.parse(reader);
            if (value.isObject()) {
