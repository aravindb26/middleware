...
public class DataExportConsistencyCLT extends AbstractRmiCLI<Void> {
    ...
    protected Void invoke(Options options, CommandLine cmd, String optRmiHostName) throws Exception {
        ...
        if (repair) {
            return repair(optRmiHostName, adminUser, adminPassword);
        }
    ...
    private Void repair(String optRmiHostName, String adminUser, String adminPassword) throws MalformedURLException, RemoteException, NotBoundException {
        DataExportRMIService rmiService = getRmiStub(optRmiHostName, DataExportRMIService.RMI_NAME);
        int fixedEntries = rmiService.fixOrphanedEntries(filestoreIds, new Credentials(adminUser, adminPassword));
