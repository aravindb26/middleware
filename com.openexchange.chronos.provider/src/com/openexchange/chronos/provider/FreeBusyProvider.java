...
public interface FreeBusyProvider {
    ...
    /** The synthetic identifier for <i>unbound</i> free/busy results that are not associated with a certain calendar account */
    static final Integer NO_ACCOUNT = Integer.valueOf(-1);
     ...
     * @return The free/busy times for each of the attendees, mapped to the corresponding account identifier (or to {@link #NO_ACCOUNT} for <i>unbound</i> results)
     */
