...
public final class SMTPProperties extends AbstractProtocolProperties implements ISMTPProperties {
    ...
    protected void loadProperties0() {
...

        {
            ...
            logBuilder.append("    Allow XCLIENT: {}{}");
            args.add(B(allowXClient));
            args.add(lineSeparator);
        }
...

        {
            ...
            if (CharsetDetector.isValid(smtpAuthEncStr)) {
                ...
                logBuilder.append("    SMTP Auth Encoding: {}{}");
            } else {
                smtpAuthEnc = "UTF-8";
...

        {
            ...
            args.add(Boolean.toString(requireTls));
            args.add(lineSeparator);
        }
