    ...
    private static final class CapabilityAndGreetingCallable implements Callable<Capabilities> {
        ...
        private void applySslProtocols(Properties imapprops) {
            ...
            if (Strings.isNotEmpty(sslProtocols)) {
                ...
                if (sslConfigService != null) {
                    imapprops.put("mail.smtp.ssl.protocols", Strings.toWhitespaceSeparatedList(sslConfigService.getSupportedProtocols()));
                }
            }
        }
        ...
        private void applySslCipherSuites(Properties imapprops) {
            ...
            if (Strings.isNotEmpty(sslCipherSuites)) {
                ...
                SSLConfigurationService sslConfigService = Services.getService(SSLConfigurationService.class);
                if (sslConfigService != null) {
                    imapprops.put("mail.smtp.ssl.ciphersuites", Strings.toWhitespaceSeparatedList(sslConfigService.getSupportedCipherSuites()));
                }
            }
        }

        private void applyRequireTls(Properties smtpProps) {
