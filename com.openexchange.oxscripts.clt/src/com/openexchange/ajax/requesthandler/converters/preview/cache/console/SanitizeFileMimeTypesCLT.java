...
public final class SanitizeFileMimeTypesCLT extends AbstractRmiCLI<Void> {
    ...
    protected Void invoke(Options options, CommandLine cmd, String optRmiHostName) throws Exception {
        ...
        try {
            ...
            if (null == contextId) {
                System.out.println(rmiService.sanitizeMimeTypesInDatabaseFor(-1, invalids, new Credentials(adminUser, adminPassword)));
            } else {
                System.out.println(rmiService.sanitizeMimeTypesInDatabaseFor(contextId.intValue(), invalids, new Credentials(adminUser, adminPassword)));
            }
            error = false;
