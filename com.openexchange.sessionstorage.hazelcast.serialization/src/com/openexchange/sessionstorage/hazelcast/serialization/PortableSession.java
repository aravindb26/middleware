...
public class PortableSession extends StoredSession implements CustomPortable, VersionedPortable {
    ...
    public PortableSession(Session session) {
        ...
        remoteParameterNames.add(PARAM_BRAND);
        remoteParameterNames.add(PARAM_DEVICE_USER_AGENT);
    ...
    public void readPortable(PortableReader reader) throws IOException {
        ...
        }
        {
            ...
            if (null != sRemoteParameters) {
                try {
                    JSONObject jRemoteParameters = JSONServices.parseObject(sRemoteParameters);
