 ...
 * @since v7.10.0
 */
public class DefaultUpdatesResult extends DefaultSequenceResult implements UpdatesResult {
     ...
     */
    public DefaultUpdatesResult(List<Event> newAndModifiedEvents, List<Event> deletedEvents, long timestamp, boolean truncated, long count) {
     ...
     * @param count The total number of events in the underlying folder view (independently of the client supplied timestamp)
     */
    public DefaultUpdatesResult(List<Event> newAndModifiedEvents, List<Event> deletedEvents, long count) {
        this(newAndModifiedEvents, deletedEvents, Math.max(getMaximumTimestamp(newAndModifiedEvents), getMaximumTimestamp(deletedEvents)), false, count);
    }
