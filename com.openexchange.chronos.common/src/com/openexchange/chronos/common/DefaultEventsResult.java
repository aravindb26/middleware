...
public class DefaultEventsResult implements EventsResult {
    ...
    /**
     * Initializes a new {@link DefaultEventsResult} with error.
     * 
     * @param error The error to take over
     */
    ...
    /**
     * Initializes a new {@link DefaultEventsResult} with a list of events.
     * 
     * @param events The events to take over
     */
    ...
    /**
     * Initializes a new {@link DefaultEventsResult} with a list of events and their maximum error.
     * 
     * @param events The events to take over
     * @param timestamp The timestamp to take over
     */
    ...
    /**
     * Initializes a new {@link DefaultEventsResult} with a list of events, the timestamp, and an error.
     * 
     * @param events The events to take over
     * @param timestamp The timestamp to take over
     * @param error The error to take over
     */
    public DefaultEventsResult(List<Event> events, long timestamp, OXException error) {
        super();
        this.events = events;
