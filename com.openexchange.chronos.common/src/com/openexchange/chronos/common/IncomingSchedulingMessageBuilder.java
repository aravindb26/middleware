...
public class IncomingSchedulingMessageBuilder {
    ...
    protected Map<String, Object> additionals;
     ...
     * @return This instance for chaining
     */
    public IncomingSchedulingMessageBuilder setAdditionals(Map<String, Object> additionals) {
    ...
    public IncomingSchedulingMessageBuilder addAdditionals(String key, Object value) {
        if (null == additionals) {
            additionals = new HashMap<String, Object>();
        }
...
class Incoming implements IncomingSchedulingMessage {
    ...
    public String toString() {
        return "IncomingSchedulingMessage [method=" + method + ", targetUser=" + targetUser + ", schedulingObject=" + schedulingObject + "]";
    }
