...
public abstract class LdapBooleanMapping extends LdapMapping<Boolean> {
    ...
    /**
     * Initializes a new {@link LdapBooleanMapping}.
     *
     ...
     */
    protected LdapBooleanMapping(Map<String, String> attributesAndValues, String... flags) {
    ...
    @Override
    protected Boolean get(Attribute attribute) {
        ...
        if ("*".equals(valueToMatch)) {
            return B(attribute.hasValue());
        }
    ...
    public String encodeForFilter(String attributeName, Object value) throws OXException {
        if (Boolean.TRUE.equals(value) || (value instanceof String) && Boolean.parseBoolean((String) value)) {
        ...
        throw new IllegalArgumentException("unable to encode other values than TRUE");
    }
