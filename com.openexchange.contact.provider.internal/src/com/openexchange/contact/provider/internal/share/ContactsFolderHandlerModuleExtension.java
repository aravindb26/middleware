...
import static com.openexchange.contact.provider.internal.Constants.QUALIFIED_ACCOUNT_ID;
import static com.openexchange.contact.provider.internal.share.IDMangling.getRelativeFolderId;
...
/**
 * {@link ContactsFolderHandlerModuleExtension}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 * @since v7.10.6
 */
public class ContactsFolderHandlerModuleExtension implements FolderHandlerModuleExtension {

    private final ServiceLookup services;

    /**
     * Initializes a new {@link ContactsFolderHandlerModuleExtension}.
     *
     * @param services A service lookup reference
     */
    public ContactsFolderHandlerModuleExtension(ServiceLookup services) {
        super();
