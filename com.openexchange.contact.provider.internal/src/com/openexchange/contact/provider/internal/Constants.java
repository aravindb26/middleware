...
public class Constants {
    ...
    static final int ACCOUNT_ID = ContactsAccount.DEFAULT_ACCOUNT.getAccountId();
    ...
    /** The static qualified identifier of the single default account in the internal contacts provider <code>con://0/</code> */
    public static final String QUALIFIED_ACCOUNT_ID = com.openexchange.tools.id.IDMangler.mangle(ContactsAccount.ID_PREFIX, String.valueOf(ACCOUNT_ID), "");
