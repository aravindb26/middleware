...
public class ExtendedFolderPermission extends ExtendedPermission {
    ...
    private static class LoggerHolder {
        static final Logger LOG = org.slf4j.LoggerFactory.getLogger(ExtendedFolderPermission.class);
    }
    ...
    public JSONObject toJSON(AJAXRequestData requestData) throws JSONException, OXException {
        ...
        if (permission.isGroup()) {
            ...
            if (null != permission.getEntityInfo()) {
                ...
                LoggerHolder.LOG.debug("Can't resolve user permission entity {} for folder {}", I(permission.getEntity()), folder);
            } else {
                /*
        ...
        // Set deputy permission flag
        if (Permissions.isDeputyPermission(permission, folder, requestData.getSession())) {
            jsonObject.put("deputyPermission", true);
        }
        return jsonObject;
    }
