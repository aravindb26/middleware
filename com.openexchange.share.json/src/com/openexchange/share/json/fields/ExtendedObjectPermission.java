...
public class ExtendedObjectPermission extends ExtendedPermission {
    ...
    private static class LoggerHolder {
        static final Logger LOG = org.slf4j.LoggerFactory.getLogger(ExtendedObjectPermission.class);
    }
    ...
    public JSONObject toJSON(AJAXRequestData requestData) throws JSONException, OXException {
        ...
        if (0 >= permission.getEntity()) {
            LoggerHolder.LOG.debug("Can't resolve user permission entity {} for file {}", I(permission.getEntity()), file);
            return jsonObject;
        }
        /*
