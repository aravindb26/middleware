...
public class Update {
    ...
    @XmlElement(nillable = true)
    protected AccountDataUpdate accountDataUpdate;
    @XmlElement(nillable = true)
     ...
     *
     */
    public AccountDataUpdate getAccountDataUpdate() {
     ...
     *
     */
    public void setAccountDataUpdate(AccountDataUpdate value) {
        this.accountDataUpdate = value;
    }
