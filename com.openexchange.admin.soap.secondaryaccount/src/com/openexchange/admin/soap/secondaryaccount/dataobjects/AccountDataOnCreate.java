...
@XmlType(name = "AccountDataOnCreate", propOrder = {
    "login",
    "password",
    "name",
    "primaryAddress",
...
public class AccountDataOnCreate {
    ...
    @XmlElement(nillable = true)
    protected String mailEndpointSource;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected String transportEndpointSource;
    @XmlElement(nillable = true)
     ...
     *
     * @return The mail end-point source
     */
    public String getMailEndpointSource() {
        return mailEndpointSource;
    }

    /**
     * Sets the mail end-point source
     *
     * @param mailEndpointSource The mail end-point source to set
     */
    public void setMailEndpointSource(String mailEndpointSource) {
     ...
     *
     * @return The transport end-point source
     */
    public String getTransportEndpointSource() {
        return transportEndpointSource;
    }

    /**
     * Sets the transport end-point source
     *
     * @param transportEndpointSource The transport end-point source to set
     */
    public void setTransportEndpointSource(String transportEndpointSource) {
